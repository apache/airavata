  ...
  return (
    <>
      ...
      <Container maxW='container.sm' p={4} mt={4}>
        ...
        <Text mt={2}>Airavata User Inter1face (UI) was developed to aid scientists in lorem ipsum.  developed to aid scientists in lorem ipsum  developed to aid scientists in lorem ipsum  developed to aid scientists in lorem ipsum developed to aid scientists in lorem ipsum developed to aid scientists in lorem ipsum developed to aid scientists in lorem ipsum developed to aid scientists in lorem ipsum. To continue and access the dashboard, please <Link href='/login' color='blue.500'>login to Airavata UI</Link>.
        </Text>
