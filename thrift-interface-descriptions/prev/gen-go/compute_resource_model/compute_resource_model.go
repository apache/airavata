...
func (p ResourceJobManagerType) String() string {
	switch p {
	case ResourceJobManagerType_FORK:
		return "FORK"
	case ResourceJobManagerType_PBS:
		return "PBS"
	case ResourceJobManagerType_SLURM:
		return "SLURM"
	case ResourceJobManagerType_LSF:
		return "LSF"
	case ResourceJobManagerType_UGE:
		return "UGE"
	case ResourceJobManagerType_CLOUD:
		return "CLOUD"
	case ResourceJobManagerType_AIRAVATA_CUSTOM:
...
func ResourceJobManagerTypeFromString(s string) (ResourceJobManagerType, error) {
	switch s {
	case "FORK":
		return ResourceJobManagerType_FORK, nil
	case "PBS":
		return ResourceJobManagerType_PBS, nil
	case "SLURM":
		return ResourceJobManagerType_SLURM, nil
	case "LSF":
		return ResourceJobManagerType_LSF, nil
	case "UGE":
		return ResourceJobManagerType_UGE, nil
	case "CLOUD":
		return ResourceJobManagerType_CLOUD, nil
	case "AIRAVATA_CUSTOM":
		return ResourceJobManagerType_AIRAVATA_CUSTOM, nil
	}
...
func (p JobManagerCommand) String() string {
	switch p {
	case JobManagerCommand_SUBMISSION:
		return "SUBMISSION"
	case JobManagerCommand_JOB_MONITORING:
		return "JOB_MONITORING"
	case JobManagerCommand_DELETION:
		return "DELETION"
	case JobManagerCommand_CHECK_JOB:
		return "CHECK_JOB"
	case JobManagerCommand_SHOW_QUEUE:
		return "SHOW_QUEUE"
	case JobManagerCommand_SHOW_RESERVATION:
		return "SHOW_RESERVATION"
	case JobManagerCommand_SHOW_START:
		return "SHOW_START"
	}
	return "<UNSET>"
}
...
func JobManagerCommandFromString(s string) (JobManagerCommand, error) {
	switch s {
	case "SUBMISSION":
		return JobManagerCommand_SUBMISSION, nil
	case "JOB_MONITORING":
		return JobManagerCommand_JOB_MONITORING, nil
	case "DELETION":
		return JobManagerCommand_DELETION, nil
	case "CHECK_JOB":
		return JobManagerCommand_CHECK_JOB, nil
	case "SHOW_QUEUE":
		return JobManagerCommand_SHOW_QUEUE, nil
	case "SHOW_RESERVATION":
		return JobManagerCommand_SHOW_RESERVATION, nil
	case "SHOW_START":
		return JobManagerCommand_SHOW_START, nil
	}
...
func (p FileSystems) String() string {
	switch p {
	case FileSystems_HOME:
		return "HOME"
	case FileSystems_WORK:
		return "WORK"
	case FileSystems_LOCALTMP:
		return "LOCALTMP"
	case FileSystems_SCRATCH:
		return "SCRATCH"
	case FileSystems_ARCHIVE:
		return "ARCHIVE"
	}
	return "<UNSET>"
}
...
func FileSystemsFromString(s string) (FileSystems, error) {
	switch s {
	case "HOME":
		return FileSystems_HOME, nil
	case "WORK":
		return FileSystems_WORK, nil
	case "LOCALTMP":
		return FileSystems_LOCALTMP, nil
	case "SCRATCH":
		return FileSystems_SCRATCH, nil
	case "ARCHIVE":
		return FileSystems_ARCHIVE, nil
	}
...
func (p JobSubmissionProtocol) String() string {
	switch p {
	case JobSubmissionProtocol_LOCAL:
		return "LOCAL"
	case JobSubmissionProtocol_SSH:
		return "SSH"
	case JobSubmissionProtocol_GLOBUS:
		return "GLOBUS"
	case JobSubmissionProtocol_UNICORE:
		return "UNICORE"
	case JobSubmissionProtocol_CLOUD:
		return "CLOUD"
	case JobSubmissionProtocol_SSH_FORK:
		return "SSH_FORK"
	case JobSubmissionProtocol_LOCAL_FORK:
		return "LOCAL_FORK"
	}
	return "<UNSET>"
}
...
func JobSubmissionProtocolFromString(s string) (JobSubmissionProtocol, error) {
	switch s {
	case "LOCAL":
		return JobSubmissionProtocol_LOCAL, nil
	case "SSH":
		return JobSubmissionProtocol_SSH, nil
	case "GLOBUS":
		return JobSubmissionProtocol_GLOBUS, nil
	case "UNICORE":
		return JobSubmissionProtocol_UNICORE, nil
	case "CLOUD":
		return JobSubmissionProtocol_CLOUD, nil
	case "SSH_FORK":
		return JobSubmissionProtocol_SSH_FORK, nil
	case "LOCAL_FORK":
		return JobSubmissionProtocol_LOCAL_FORK, nil
	}
...
func (p MonitorMode) String() string {
	switch p {
	case MonitorMode_POLL_JOB_MANAGER:
		return "POLL_JOB_MANAGER"
	case MonitorMode_CLOUD_JOB_MONITOR:
		return "CLOUD_JOB_MONITOR"
	case MonitorMode_JOB_EMAIL_NOTIFICATION_MONITOR:
		return "JOB_EMAIL_NOTIFICATION_MONITOR"
	case MonitorMode_XSEDE_AMQP_SUBSCRIBE:
		return "XSEDE_AMQP_SUBSCRIBE"
	case MonitorMode_FORK:
		return "FORK"
	case MonitorMode_LOCAL:
		return "LOCAL"
	}
	return "<UNSET>"
}
...
func MonitorModeFromString(s string) (MonitorMode, error) {
	switch s {
	case "POLL_JOB_MANAGER":
		return MonitorMode_POLL_JOB_MANAGER, nil
	case "CLOUD_JOB_MONITOR":
		return MonitorMode_CLOUD_JOB_MONITOR, nil
	case "JOB_EMAIL_NOTIFICATION_MONITOR":
		return MonitorMode_JOB_EMAIL_NOTIFICATION_MONITOR, nil
	case "XSEDE_AMQP_SUBSCRIBE":
		return MonitorMode_XSEDE_AMQP_SUBSCRIBE, nil
	case "FORK":
		return MonitorMode_FORK, nil
	case "LOCAL":
		return MonitorMode_LOCAL, nil
	}
...
func (p DMType) String() string {
	switch p {
	case DMType_COMPUTE_RESOURCE:
		return "COMPUTE_RESOURCE"
	case DMType_STORAGE_RESOURCE:
...
func DMTypeFromString(s string) (DMType, error) {
	...
	case "COMPUTE_RESOURCE":
		return DMType_COMPUTE_RESOURCE, nil
	case "STORAGE_RESOURCE":
		return DMType_STORAGE_RESOURCE, nil
	}
...
func (p ProviderName) String() string {
	switch p {
	case ProviderName_EC2:
		return "EC2"
	case ProviderName_AWSEC2:
		return "AWSEC2"
	case ProviderName_RACKSPACE:
		return "RACKSPACE"
	}
	return "<UNSET>"
}
...
func ProviderNameFromString(s string) (ProviderName, error) {
	switch s {
	case "EC2":
		return ProviderName_EC2, nil
	case "AWSEC2":
		return ProviderName_AWSEC2, nil
	case "RACKSPACE":
		return ProviderName_RACKSPACE, nil
	}
