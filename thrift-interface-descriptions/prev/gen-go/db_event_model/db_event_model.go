...
func (p CrudType) String() string {
	switch p {
	case CrudType_CREATE:
		return "CREATE"
	case CrudType_READ:
		return "READ"
	case CrudType_UPDATE:
		return "UPDATE"
	case CrudType_DELETE:
		return "DELETE"
	}
	return "<UNSET>"
}
...
func CrudTypeFromString(s string) (CrudType, error) {
	switch s {
	case "CREATE":
		return CrudType_CREATE, nil
	case "READ":
		return CrudType_READ, nil
	case "UPDATE":
		return CrudType_UPDATE, nil
	case "DELETE":
		return CrudType_DELETE, nil
	}
...
func (p EntityType) String() string {
	switch p {
	case EntityType_USER_PROFILE:
		return "USER_PROFILE"
	case EntityType_TENANT:
		return "TENANT"
	case EntityType_GROUP:
		return "GROUP"
	case EntityType_PROJECT:
		return "PROJECT"
	case EntityType_EXPERIMENT:
		return "EXPERIMENT"
	case EntityType_APPLICATION:
		return "APPLICATION"
	case EntityType_SHARING:
		return "SHARING"
	case EntityType_REGISTRY:
		return "REGISTRY"
	}
	return "<UNSET>"
}
...
func EntityTypeFromString(s string) (EntityType, error) {
	switch s {
	case "USER_PROFILE":
		return EntityType_USER_PROFILE, nil
	case "TENANT":
		return EntityType_TENANT, nil
	case "GROUP":
		return EntityType_GROUP, nil
	case "PROJECT":
		return EntityType_PROJECT, nil
	case "EXPERIMENT":
		return EntityType_EXPERIMENT, nil
	case "APPLICATION":
		return EntityType_APPLICATION, nil
	case "SHARING":
		return EntityType_SHARING, nil
	case "REGISTRY":
		return EntityType_REGISTRY, nil
	}
...
func (p DBEventType) String() string {
	switch p {
	case DBEventType_PUBLISHER:
		return "PUBLISHER"
	case DBEventType_SUBSCRIBER:
		return "SUBSCRIBER"
	}
	return "<UNSET>"
}
...
func DBEventTypeFromString(s string) (DBEventType, error) {
	switch s {
	case "PUBLISHER":
		return DBEventType_PUBLISHER, nil
	case "SUBSCRIBER":
		return DBEventType_SUBSCRIBER, nil
	}
