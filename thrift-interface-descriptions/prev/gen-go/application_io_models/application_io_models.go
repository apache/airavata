...
func (p DataType) String() string {
	...
	case DataType_URI:
		return "URI"
	case DataType_URI_COLLECTION:
		return "URI_COLLECTION"
	case DataType_STDOUT:
		return "STDOUT"
	case DataType_STDERR:
		return "STDERR"
	}
	return "<UNSET>"
}
...
func DataTypeFromString(s string) (DataType, error) {
	...
	case "URI":
		return DataType_URI, nil
	case "URI_COLLECTION":
		return DataType_URI_COLLECTION, nil
	case "STDOUT":
		return DataType_STDOUT, nil
	case "STDERR":
		return DataType_STDERR, nil
	}
