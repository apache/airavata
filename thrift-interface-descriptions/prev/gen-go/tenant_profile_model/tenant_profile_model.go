...
func (p TenantApprovalStatus) String() string {
	switch p {
	case TenantApprovalStatus_REQUESTED:
		return "REQUESTED"
	case TenantApprovalStatus_APPROVED:
		return "APPROVED"
	case TenantApprovalStatus_ACTIVE:
		return "ACTIVE"
	case TenantApprovalStatus_DEACTIVATED:
		return "DEACTIVATED"
	case TenantApprovalStatus_CANCELLED:
		return "CANCELLED"
	case TenantApprovalStatus_DENIED:
		return "DENIED"
	case TenantApprovalStatus_CREATED:
		return "CREATED"
	case TenantApprovalStatus_DEPLOYED:
		return "DEPLOYED"
	}
	return "<UNSET>"
}
...
func TenantApprovalStatusFromString(s string) (TenantApprovalStatus, error) {
	switch s {
	case "REQUESTED":
		return TenantApprovalStatus_REQUESTED, nil
	case "APPROVED":
		return TenantApprovalStatus_APPROVED, nil
	case "ACTIVE":
		return TenantApprovalStatus_ACTIVE, nil
	case "DEACTIVATED":
		return TenantApprovalStatus_DEACTIVATED, nil
	case "CANCELLED":
		return TenantApprovalStatus_CANCELLED, nil
	case "DENIED":
		return TenantApprovalStatus_DENIED, nil
	case "CREATED":
		return TenantApprovalStatus_CREATED, nil
	case "DEPLOYED":
		return TenantApprovalStatus_DEPLOYED, nil
	}
