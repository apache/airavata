...
func (p AiravataErrorType) String() string {
	switch p {
	case AiravataErrorType_UNKNOWN:
		return "UNKNOWN"
	case AiravataErrorType_PERMISSION_DENIED:
		return "PERMISSION_DENIED"
	case AiravataErrorType_INTERNAL_ERROR:
		return "INTERNAL_ERROR"
	case AiravataErrorType_AUTHENTICATION_FAILURE:
		return "AUTHENTICATION_FAILURE"
	case AiravataErrorType_INVALID_AUTHORIZATION:
		return "INVALID_AUTHORIZATION"
	case AiravataErrorType_AUTHORIZATION_EXPIRED:
		return "AUTHORIZATION_EXPIRED"
	case AiravataErrorType_UNKNOWN_GATEWAY_ID:
		return "UNKNOWN_GATEWAY_ID"
	case AiravataErrorType_UNSUPPORTED_OPERATION:
...
func AiravataErrorTypeFromString(s string) (AiravataErrorType, error) {
	switch s {
	case "UNKNOWN":
		return AiravataErrorType_UNKNOWN, nil
	case "PERMISSION_DENIED":
		return AiravataErrorType_PERMISSION_DENIED, nil
	case "INTERNAL_ERROR":
		return AiravataErrorType_INTERNAL_ERROR, nil
	case "AUTHENTICATION_FAILURE":
		return AiravataErrorType_AUTHENTICATION_FAILURE, nil
	case "INVALID_AUTHORIZATION":
		return AiravataErrorType_INVALID_AUTHORIZATION, nil
	case "AUTHORIZATION_EXPIRED":
		return AiravataErrorType_AUTHORIZATION_EXPIRED, nil
	case "UNKNOWN_GATEWAY_ID":
		return AiravataErrorType_UNKNOWN_GATEWAY_ID, nil
	case "UNSUPPORTED_OPERATION":
		return AiravataErrorType_UNSUPPORTED_OPERATION, nil
	}
