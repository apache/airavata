...
func MessageLevelFromString(s string) (MessageLevel, error) {
	switch s {
	case "INFO":
		return MessageLevel_INFO, nil
	case "DEBUG":
		return MessageLevel_DEBUG, nil
	case "ERROR":
		return MessageLevel_ERROR, nil
	case "ACK":
		return MessageLevel_ACK, nil
	}
...
func (p MessageType) String() string {
	switch p {
	case MessageType_EXPERIMENT:
		return "EXPERIMENT"
	case MessageType_EXPERIMENT_CANCEL:
		return "EXPERIMENT_CANCEL"
	case MessageType_TASK:
		return "TASK"
	case MessageType_PROCESS:
		return "PROCESS"
	case MessageType_JOB:
		return "JOB"
	case MessageType_LAUNCHPROCESS:
		return "LAUNCHPROCESS"
	case MessageType_TERMINATEPROCESS:
		return "TERMINATEPROCESS"
	case MessageType_PROCESSOUTPUT:
		return "PROCESSOUTPUT"
	case MessageType_DB_EVENT:
		return "DB_EVENT"
	}
	return "<UNSET>"
}
...
func MessageTypeFromString(s string) (MessageType, error) {
	switch s {
	case "EXPERIMENT":
		return MessageType_EXPERIMENT, nil
	case "EXPERIMENT_CANCEL":
		return MessageType_EXPERIMENT_CANCEL, nil
	case "TASK":
		return MessageType_TASK, nil
	case "PROCESS":
		return MessageType_PROCESS, nil
	case "JOB":
		return MessageType_JOB, nil
	case "LAUNCHPROCESS":
		return MessageType_LAUNCHPROCESS, nil
	case "TERMINATEPROCESS":
		return MessageType_TERMINATEPROCESS, nil
	case "PROCESSOUTPUT":
		return MessageType_PROCESSOUTPUT, nil
	case "DB_EVENT":
		return MessageType_DB_EVENT, nil
	}
