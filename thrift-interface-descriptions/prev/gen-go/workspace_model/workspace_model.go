...
func (p GatewayApprovalStatus) String() string {
	switch p {
	case GatewayApprovalStatus_REQUESTED:
		return "REQUESTED"
	case GatewayApprovalStatus_APPROVED:
		return "APPROVED"
	case GatewayApprovalStatus_ACTIVE:
		return "ACTIVE"
	case GatewayApprovalStatus_DEACTIVATED:
		return "DEACTIVATED"
	case GatewayApprovalStatus_CANCELLED:
		return "CANCELLED"
	case GatewayApprovalStatus_DENIED:
		return "DENIED"
	case GatewayApprovalStatus_CREATED:
		return "CREATED"
	case GatewayApprovalStatus_DEPLOYED:
		return "DEPLOYED"
	}
	return "<UNSET>"
}
...
func GatewayApprovalStatusFromString(s string) (GatewayApprovalStatus, error) {
	switch s {
	case "REQUESTED":
		return GatewayApprovalStatus_REQUESTED, nil
	case "APPROVED":
		return GatewayApprovalStatus_APPROVED, nil
	case "ACTIVE":
		return GatewayApprovalStatus_ACTIVE, nil
	case "DEACTIVATED":
		return GatewayApprovalStatus_DEACTIVATED, nil
	case "CANCELLED":
		return GatewayApprovalStatus_CANCELLED, nil
	case "DENIED":
		return GatewayApprovalStatus_DENIED, nil
	case "CREATED":
		return GatewayApprovalStatus_CREATED, nil
	case "DEPLOYED":
		return GatewayApprovalStatus_DEPLOYED, nil
	}
...
func NotificationPriorityFromString(s string) (NotificationPriority, error) {
	switch s {
	case "LOW":
		return NotificationPriority_LOW, nil
	case "NORMAL":
		return NotificationPriority_NORMAL, nil
	case "HIGH":
		return NotificationPriority_HIGH, nil
	}
