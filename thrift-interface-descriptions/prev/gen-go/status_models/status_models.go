...
func (p ExperimentState) String() string {
	switch p {
	case ExperimentState_CREATED:
		return "CREATED"
	case ExperimentState_VALIDATED:
		return "VALIDATED"
	case ExperimentState_SCHEDULED:
		return "SCHEDULED"
	case ExperimentState_LAUNCHED:
		return "LAUNCHED"
	case ExperimentState_EXECUTING:
		return "EXECUTING"
	case ExperimentState_CANCELING:
		return "CANCELING"
	case ExperimentState_CANCELED:
		return "CANCELED"
	case ExperimentState_COMPLETED:
		return "COMPLETED"
	case ExperimentState_FAILED:
		return "FAILED"
	}
	return "<UNSET>"
}
...
func ExperimentStateFromString(s string) (ExperimentState, error) {
	switch s {
	case "CREATED":
		return ExperimentState_CREATED, nil
	case "VALIDATED":
		return ExperimentState_VALIDATED, nil
	case "SCHEDULED":
		return ExperimentState_SCHEDULED, nil
	case "LAUNCHED":
		return ExperimentState_LAUNCHED, nil
	case "EXECUTING":
		return ExperimentState_EXECUTING, nil
	case "CANCELING":
		return ExperimentState_CANCELING, nil
	case "CANCELED":
		return ExperimentState_CANCELED, nil
	case "COMPLETED":
		return ExperimentState_COMPLETED, nil
	case "FAILED":
		return ExperimentState_FAILED, nil
	}
...
func TaskStateFromString(s string) (TaskState, error) {
	switch s {
	case "CREATED":
		return TaskState_CREATED, nil
	case "EXECUTING":
		return TaskState_EXECUTING, nil
	case "COMPLETED":
		return TaskState_COMPLETED, nil
	case "FAILED":
		return TaskState_FAILED, nil
	case "CANCELED":
		return TaskState_CANCELED, nil
	}
...
func (p ProcessState) String() string {
	...
	case ProcessState_CREATED:
		return "CREATED"
	case ProcessState_VALIDATED:
		return "VALIDATED"
	case ProcessState_STARTED:
		return "STARTED"
	case ProcessState_PRE_PROCESSING:
		return "PRE_PROCESSING"
	case ProcessState_CONFIGURING_WORKSPACE:
		return "CONFIGURING_WORKSPACE"
	case ProcessState_INPUT_DATA_STAGING:
		return "INPUT_DATA_STAGING"
	case ProcessState_EXECUTING:
		return "EXECUTING"
	case ProcessState_MONITORING:
		return "MONITORING"
	case ProcessState_OUTPUT_DATA_STAGING:
		return "OUTPUT_DATA_STAGING"
	case ProcessState_POST_PROCESSING:
		return "POST_PROCESSING"
	case ProcessState_COMPLETED:
		return "COMPLETED"
	case ProcessState_FAILED:
		return "FAILED"
	case ProcessState_CANCELLING:
		return "CANCELLING"
	case ProcessState_CANCELED:
		return "CANCELED"
	}
	return "<UNSET>"
}
...
func ProcessStateFromString(s string) (ProcessState, error) {
	switch s {
	case "CREATED":
		return ProcessState_CREATED, nil
	case "VALIDATED":
		return ProcessState_VALIDATED, nil
	case "STARTED":
		return ProcessState_STARTED, nil
	case "PRE_PROCESSING":
		return ProcessState_PRE_PROCESSING, nil
	case "CONFIGURING_WORKSPACE":
		return ProcessState_CONFIGURING_WORKSPACE, nil
	case "INPUT_DATA_STAGING":
		return ProcessState_INPUT_DATA_STAGING, nil
	case "EXECUTING":
		return ProcessState_EXECUTING, nil
	case "MONITORING":
		return ProcessState_MONITORING, nil
	case "OUTPUT_DATA_STAGING":
		return ProcessState_OUTPUT_DATA_STAGING, nil
	case "POST_PROCESSING":
		return ProcessState_POST_PROCESSING, nil
	case "COMPLETED":
		return ProcessState_COMPLETED, nil
	case "FAILED":
		return ProcessState_FAILED, nil
	case "CANCELLING":
		return ProcessState_CANCELLING, nil
	case "CANCELED":
		return ProcessState_CANCELED, nil
	}
...
func (p JobState) String() string {
	switch p {
	case JobState_SUBMITTED:
		return "SUBMITTED"
	case JobState_QUEUED:
		return "QUEUED"
	case JobState_ACTIVE:
		return "ACTIVE"
...
func JobStateFromString(s string) (JobState, error) {
	switch s {
	case "SUBMITTED":
		return JobState_SUBMITTED, nil
	case "QUEUED":
		return JobState_QUEUED, nil
	case "ACTIVE":
		return JobState_ACTIVE, nil
	case "COMPLETE":
		return JobState_COMPLETE, nil
	case "CANCELED":
		return JobState_CANCELED, nil
	case "FAILED":
		return JobState_FAILED, nil
	case "SUSPENDED":
		return JobState_SUSPENDED, nil
	case "UNKNOWN":
		return JobState_UNKNOWN, nil
	}
