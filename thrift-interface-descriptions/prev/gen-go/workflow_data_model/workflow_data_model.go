...
func (p WorkflowState) String() string {
	switch p {
	case WorkflowState_CREATED:
		return "CREATED"
	case WorkflowState_STARTED:
		return "STARTED"
	case WorkflowState_EXECUTING:
		return "EXECUTING"
	case WorkflowState_COMPLETED:
		return "COMPLETED"
	case WorkflowState_FAILED:
		return "FAILED"
	case WorkflowState_CANCELLING:
		return "CANCELLING"
	case WorkflowState_CANCELED:
		return "CANCELED"
	}
	return "<UNSET>"
}
...
func WorkflowStateFromString(s string) (WorkflowState, error) {
	switch s {
	case "CREATED":
		return WorkflowState_CREATED, nil
	case "STARTED":
		return WorkflowState_STARTED, nil
	case "EXECUTING":
		return WorkflowState_EXECUTING, nil
	case "COMPLETED":
		return WorkflowState_COMPLETED, nil
	case "FAILED":
		return WorkflowState_FAILED, nil
	case "CANCELLING":
		return WorkflowState_CANCELLING, nil
	case "CANCELED":
		return WorkflowState_CANCELED, nil
	}
...
func (p ComponentState) String() string {
	switch p {
	case ComponentState_CREATED:
		return "CREATED"
	case ComponentState_WAITING:
		return "WAITING"
	case ComponentState_READY:
		return "READY"
	case ComponentState_RUNNING:
		return "RUNNING"
	case ComponentState_COMPLETED:
		return "COMPLETED"
	case ComponentState_FAILED:
		return "FAILED"
	case ComponentState_CANCELED:
		return "CANCELED"
	}
	return "<UNSET>"
}
...
func ComponentStateFromString(s string) (ComponentState, error) {
	switch s {
	case "CREATED":
		return ComponentState_CREATED, nil
	case "WAITING":
		return ComponentState_WAITING, nil
	case "READY":
		return ComponentState_READY, nil
	case "RUNNING":
		return ComponentState_RUNNING, nil
	case "COMPLETED":
		return ComponentState_COMPLETED, nil
	case "FAILED":
		return ComponentState_FAILED, nil
	case "CANCELED":
		return ComponentState_CANCELED, nil
	}
