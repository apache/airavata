...
func (p SecurityProtocol) String() string {
	switch p {
	case SecurityProtocol_USERNAME_PASSWORD:
		return "USERNAME_PASSWORD"
	case SecurityProtocol_SSH_KEYS:
		return "SSH_KEYS"
	case SecurityProtocol_GSI:
		return "GSI"
	case SecurityProtocol_KERBEROS:
		return "KERBEROS"
	case SecurityProtocol_OAUTH:
		return "OAUTH"
	case SecurityProtocol_LOCAL:
		return "LOCAL"
	}
	return "<UNSET>"
}
...
func SecurityProtocolFromString(s string) (SecurityProtocol, error) {
	...
	case "USERNAME_PASSWORD":
		return SecurityProtocol_USERNAME_PASSWORD, nil
	case "SSH_KEYS":
		return SecurityProtocol_SSH_KEYS, nil
	case "GSI":
		return SecurityProtocol_GSI, nil
	case "KERBEROS":
		return SecurityProtocol_KERBEROS, nil
	case "OAUTH":
		return SecurityProtocol_OAUTH, nil
	case "LOCAL":
		return SecurityProtocol_LOCAL, nil
	}
...
func (p DataMovementProtocol) String() string {
	switch p {
	case DataMovementProtocol_LOCAL:
		return "LOCAL"
	case DataMovementProtocol_SCP:
		return "SCP"
	case DataMovementProtocol_SFTP:
		return "SFTP"
	case DataMovementProtocol_GridFTP:
		return "GridFTP"
	case DataMovementProtocol_UNICORE_STORAGE_SERVICE:
...
func DataMovementProtocolFromString(s string) (DataMovementProtocol, error) {
	switch s {
	case "LOCAL":
		return DataMovementProtocol_LOCAL, nil
	case "SCP":
		return DataMovementProtocol_SCP, nil
	case "SFTP":
		return DataMovementProtocol_SFTP, nil
	case "GridFTP":
		return DataMovementProtocol_GridFTP, nil
	case "UNICORE_STORAGE_SERVICE":
		return DataMovementProtocol_UNICORE_STORAGE_SERVICE, nil
	}
