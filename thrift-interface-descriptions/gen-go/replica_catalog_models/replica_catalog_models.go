...
func (p ReplicaLocationCategory) String() string {
	switch p {
	case ReplicaLocationCategory_GATEWAY_DATA_STORE:
		return "GATEWAY_DATA_STORE"
	case ReplicaLocationCategory_COMPUTE_RESOURCE:
		return "COMPUTE_RESOURCE"
	case ReplicaLocationCategory_LONG_TERM_STORAGE_RESOURCE:
		return "LONG_TERM_STORAGE_RESOURCE"
	case ReplicaLocationCategory_OTHER:
		return "OTHER"
	}
	return "<UNSET>"
}
...
func ReplicaLocationCategoryFromString(s string) (ReplicaLocationCategory, error) {
	switch s {
	case "GATEWAY_DATA_STORE":
		return ReplicaLocationCategory_GATEWAY_DATA_STORE, nil
	case "COMPUTE_RESOURCE":
		return ReplicaLocationCategory_COMPUTE_RESOURCE, nil
	case "LONG_TERM_STORAGE_RESOURCE":
		return ReplicaLocationCategory_LONG_TERM_STORAGE_RESOURCE, nil
	case "OTHER":
		return ReplicaLocationCategory_OTHER, nil
	}
...
func (p ReplicaPersistentType) String() string {
	switch p {
	case ReplicaPersistentType_TRANSIENT:
		return "TRANSIENT"
	case ReplicaPersistentType_PERSISTENT:
		return "PERSISTENT"
	}
	return "<UNSET>"
}
...
func ReplicaPersistentTypeFromString(s string) (ReplicaPersistentType, error) {
	switch s {
	case "TRANSIENT":
		return ReplicaPersistentType_TRANSIENT, nil
	case "PERSISTENT":
		return ReplicaPersistentType_PERSISTENT, nil
	}
...
func (p DataProductType) String() string {
	switch p {
	case DataProductType_FILE:
		return "FILE"
	case DataProductType_COLLECTION:
		return "COLLECTION"
	}
	return "<UNSET>"
}
...
func DataProductTypeFromString(s string) (DataProductType, error) {
	switch s {
	case "FILE":
		return DataProductType_FILE, nil
	case "COLLECTION":
		return DataProductType_COLLECTION, nil
	}
