...
func (p CredentialOwnerType) String() string {
	switch p {
	case CredentialOwnerType_GATEWAY:
		return "GATEWAY"
	case CredentialOwnerType_USER:
		return "USER"
	}
	return "<UNSET>"
}
...
func CredentialOwnerTypeFromString(s string) (CredentialOwnerType, error) {
	switch s {
	case "GATEWAY":
		return CredentialOwnerType_GATEWAY, nil
	case "USER":
		return CredentialOwnerType_USER, nil
	}
...
func (p SummaryType) String() string {
	switch p {
	case SummaryType_SSH:
		return "SSH"
	case SummaryType_PASSWD:
		return "PASSWD"
	case SummaryType_CERT:
		return "CERT"
	}
	return "<UNSET>"
}
...
func SummaryTypeFromString(s string) (SummaryType, error) {
	switch s {
	case "SSH":
		return SummaryType_SSH, nil
	case "PASSWD":
		return SummaryType_PASSWD, nil
	case "CERT":
		return SummaryType_CERT, nil
	}
