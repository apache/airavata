...
func (p TaskTypes) String() string {
	switch p {
	case TaskTypes_ENV_SETUP:
		return "ENV_SETUP"
	case TaskTypes_DATA_STAGING:
		return "DATA_STAGING"
	case TaskTypes_JOB_SUBMISSION:
		return "JOB_SUBMISSION"
	case TaskTypes_ENV_CLEANUP:
		return "ENV_CLEANUP"
	case TaskTypes_MONITORING:
		return "MONITORING"
	case TaskTypes_OUTPUT_FETCHING:
...
func TaskTypesFromString(s string) (TaskTypes, error) {
	switch s {
	case "ENV_SETUP":
		return TaskTypes_ENV_SETUP, nil
	case "DATA_STAGING":
		return TaskTypes_DATA_STAGING, nil
	case "JOB_SUBMISSION":
		return TaskTypes_JOB_SUBMISSION, nil
	case "ENV_CLEANUP":
		return TaskTypes_ENV_CLEANUP, nil
	case "MONITORING":
		return TaskTypes_MONITORING, nil
	case "OUTPUT_FETCHING":
		return TaskTypes_OUTPUT_FETCHING, nil
	}
...
func (p DataStageType) String() string {
	switch p {
	case DataStageType_INPUT:
		return "INPUT"
	case DataStageType_OUPUT:
		return "OUPUT"
	case DataStageType_ARCHIVE_OUTPUT:
...
func DataStageTypeFromString(s string) (DataStageType, error) {
	switch s {
	case "INPUT":
		return DataStageType_INPUT, nil
	case "OUPUT":
		return DataStageType_OUPUT, nil
	case "ARCHIVE_OUTPUT":
		return DataStageType_ARCHIVE_OUTPUT, nil
	}
