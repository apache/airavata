...
func (p ResourceType) String() string {
	...
	case ResourceType_PROJECT:
		return "PROJECT"
	case ResourceType_EXPERIMENT:
		return "EXPERIMENT"
	case ResourceType_DATA:
		return "DATA"
...
func ResourceTypeFromString(s string) (ResourceType, error) {
	...
	case "EXPERIMENT":
		return ResourceType_EXPERIMENT, nil
	case "DATA":
		return ResourceType_DATA, nil
	case "OTHER":
		return ResourceType_OTHER, nil
	}
...
func (p ResourcePermissionType) String() string {
	switch p {
	case ResourcePermissionType_WRITE:
		return "WRITE"
	case ResourcePermissionType_READ:
		return "READ"
	case ResourcePermissionType_OWNER:
		return "OWNER"
	}
	return "<UNSET>"
}
...
func ResourcePermissionTypeFromString(s string) (ResourcePermissionType, error) {
	switch s {
	case "WRITE":
		return ResourcePermissionType_WRITE, nil
	case "READ":
		return ResourcePermissionType_READ, nil
	case "OWNER":
		return ResourcePermissionType_OWNER, nil
	}
