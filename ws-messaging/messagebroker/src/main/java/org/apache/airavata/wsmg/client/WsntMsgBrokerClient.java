...
public class WsntMsgBrokerClient implements MessageBrokerClient {
    ...
    public void publish(String topic, OMElement message) throws MsgBrokerClientException {
        ...
        String producerURl = WsmgUtil.formatURLString(WsmgUtil.getHostIP());
        EndpointReference producerReference = new EndpointReference(producerURl);

        try {

            OMElement messageToNotify = WSNTProtocolSupport.Client
                    .encodeNotification(topic, message, producerReference);
    ...
    public String subscribe(EndpointReference eventSinkLocation, String topicExpression, String xpathExpression,
        ...
        try {
            ...
            OMElement message = WSNTProtocolSupport.Client.createSubscriptionMsg(eventSinkLocation, topicExpression,
                    xpathExpression);
            ...
            subscriptionId = WSNTProtocolSupport.Client.decodeSubscriptionResponse(sr);
    ...
    public boolean unSubscribe(String subscriptionId) throws MsgBrokerClientException {
        ...
        OMFactory factory = OMAbstractFactory.getOMFactory();
        OMElement message = WSNTProtocolSupport.Client.createUnsubscribeMsg();
