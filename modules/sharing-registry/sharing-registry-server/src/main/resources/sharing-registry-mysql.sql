...
CREATE TABLE IF NOT EXISTS USER_ALLOCATION_DETAILS (
    ...
    PRINCIPAL_INVISTIGATOR_NAME VARCHAR (255) NOT NULL,
    PRINCIPAL_INVISTIGATOR_EMAIL VARCHAR (255) NOT NULL,
    ...
    EXTERNAL_ALLOCATION_ORGANIZATION_NAME TEXT,
    EXTERNAL_ALLOCATION_RESOURCE_NAME TEXT,
    EXTERNAL_ALLOCATION_PROJECT_ID VARCHAR (255),
    EXTERNAL_ALLOCATION_ACCOUNT_USERNAME TEXT,
    EXTERNAL_ALLOCATION_ACCOUNT_PASSWORD TEXT,
    EXTERNAL_ALLOCATION_ACCESS_MECHANISMS TEXT
);
