...
public class UserAllocationDetailsRepository extends AbstractRepository<UserAllocationDetails, UserAllocationDetailsEntity, String> {
    ...
    public void createAllocation(UserAllocationDetails reqDetails) throws SharingRegistryException {
        ...
        reqDetails.externalAllocationResourceName + "," + reqDetails.fieldOfScience+","+
        reqDetails.keywords + "," + reqDetails.maxMemoryPerCpu + "," +
        ...
        reqDetails.specificResourceSelection + "," + reqDetails.title + "," + 
