...
service AllocationRegistryService{
    ...
    */
    ...
    /**
     <p>API method to update existing allocation request</p>
    */
    bool updateAllocationRequest(1: required allocation_manager_models.UserAllocationDetails allocDetails)
    /**
