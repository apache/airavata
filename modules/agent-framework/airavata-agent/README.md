...
```
POST http://localhost:8080/api/v1/agent/execute/shell
...
```
GET http://localhost:8080/api/v1/agent/execute/shell/78fe66aa-4895-4768-8701-5ef50367732e
```

Execute Jupyter Code
```
http://localhost:8080/api/v1/agent/execute/jupyter
...
```
```
http://localhost:8080/api/v1/agent/execute/jupyter/22f02087-87cc-4e90-bc3b-3b969179c31b
...
Set Up a tcp Tunnel
```
POST http://localhost:8080/api/v1/agent/setup/tunnel
...
```
GET http://localhost:8080/api/v1/agent/setup/tunnel/<execution_id>
...
```
POST http://localhost:8080/api/v1/agent/terminate/tunnel
