...
public class JobBatchHandler {
    ...
    public JobBatchHandler(
            JobBatchWorker jobBatchWorker,
            JobBatchRepo jobBatchRepo,
            AgentBatchAssignmentRepo agentJobAssignmentRepo,
        ...
        if (spec != null) {
            if (spec.getApplicationCommand() == null
                ...
                throw new IllegalArgumentException(
                        "application_command is required for experiment with id: " + experimentId);
            }
            ...
            if (spec.getParameterGrid() == null || spec.getParameterGrid().isEmpty()) {
                ...
                throw new IllegalArgumentException(
                        "parameter_grid is required for experiment with id: " + experimentId);
            }
            ...
            jobBatchWorker.expandAndPersistUnitsAsync(
                    experimentId, batchId, spec.getApplicationCommand(), spec.getParameterGrid());
        }
        return batchId;
    }
}
