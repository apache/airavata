...
@Repository
public interface ExperimentStorageCacheRepository extends JpaRepository<ExperimentStorageCacheEntity, String> {

    @Query("SELECT e FROM ExperimentStorageCacheEntity e WHERE e.cacheKey = :cacheKey AND e.cachedAt > :minTimestamp")
    Optional<ExperimentStorageCacheEntity> findFreshEntry(
