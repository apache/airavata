...
* under the License.
*/
package org.apache.airavata.agent.controller;
...
@RestController("agentExperimentController")
@RequestMapping("/api/v1/agent/experiments")
public class ExperimentController {

    private final AgentManagementService agentManagementHandler;

    public ExperimentController(AgentManagementService agentManagementHandler) {
