...
* under the License.
*/
package org.apache.airavata.file.server.config;
...
public class FileServerConfiguration implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    public FileServerConfiguration(@Lazy @Qualifier("adapterSupportImpl") AdapterSupport adapterSupport) {
    ...
    // AdapterSupport is already a @Component bean (DefaultAdapterSupport), no need to create it here
