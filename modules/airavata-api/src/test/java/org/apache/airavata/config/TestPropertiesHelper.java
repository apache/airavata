 ...
 *
 * <p>Note: Since ServerProperties is an immutable record, properties cannot be
...
public class TestPropertiesHelper {
     ...
     * Since ServerProperties is immutable, this only reads values.
     *
     * @param properties ServerProperties to log
     */
    public static void logProperties(ServerProperties properties) {
        if (properties == null) {
            logger.debug("ServerProperties is null");
            return;
        }
