...
/**
 * Test to verify AiravataApplication startup with core services enabled.
 *
 * In this mode:
 * - REST API should be configured
 * - Core services (Registry, CredentialStore) should be available
 */
@SpringBootTest(
        classes = {JpaConfiguration.class, TestcontainersConfig.class, CoreServicesStartupTest.TestConfiguration.class},
        properties = {
...
public class CoreServicesStartupTest {
    ...
    public void testCoreServicesAreAvailable() {
        ...
        assertTrue(
                applicationContext
                                .getBeansOfType(org.apache.airavata.iam.service.CredentialStoreService.class)
                                .size()
                        > 0,
                "CredentialStoreService should be available");
    }
