...
import org.apache.airavata.task.submission.JobSubmissionTask;
...
public class AWSJobSubmissionTask extends JobSubmissionTask {
    ...
    private TaskResult handleJobSubmissionFailure(GroovyMapData mapData, String reason) throws RegistryException {
        LOGGER.error(reason);
