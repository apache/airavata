...
import org.apache.airavata.helix.task.cancel.CancelCompletingTask;
import org.apache.airavata.helix.task.cancel.RemoteJobCancellationTask;
import org.apache.airavata.helix.task.cancel.WorkflowCancellationTask;
...
import org.apache.airavata.messaging.rabbitmq.RabbitMQSubscriber;
...
public class PreWorkflowManager extends WorkflowManager {
    ...
    private String createAndLaunchPreWorkflow(String processId, boolean forceRun) throws Exception {
        ...
        String workflowName = getWorkflowOperator()
                .launchWorkflow(
                        processId + "-PRE-" + UUID.randomUUID().toString(),
                        new ArrayList<AbstractTask>(allTasks),
                        true,
                        false);
