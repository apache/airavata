...
/**
 * Core exceptions and error type for Airavata.
 */
public final class CoreExceptions {
    ...
    public enum AiravataErrorType {
        ...
        public static AiravataErrorType findByValue(int value) {
            return switch (value) {
                ...
                case 3 -> AUTHENTICATION_FAILURE;
                case 4 -> INVALID_AUTHORIZATION;
                case 5 -> AUTHORIZATION_EXPIRED;
                case 6 -> UNKNOWN_GATEWAY_ID;
                case 7 -> UNSUPPORTED_OPERATION;
                default -> null;
            };
        }
    }
    ...
    public static class AiravataClientException extends Exception {
        ...
        public AiravataClientException() { super(); }

        public AiravataClientException(String message) { super(message); }

        public AiravataClientException(String message, Throwable cause) { super(message, cause); }
        ...
        public AiravataErrorType getAiravataErrorType() { return airavataErrorType; }
        public void setAiravataErrorType(AiravataErrorType airavataErrorType) { this.airavataErrorType = airavataErrorType; }
    ...
    public static class AiravataSystemException extends Exception {
        ...
        public AiravataSystemException() { super(); }

        public AiravataSystemException(String message) { super(message); }

        public AiravataSystemException(String message, Throwable cause) { super(message, cause); }
    ...
    public static class AiravataStartupException extends Exception {
        ...
        public AiravataStartupException() { super(); }

        public AiravataStartupException(String message) { super(message); }

        public AiravataStartupException(String message, Throwable cause) { super(message, cause); }

        public AiravataStartupException(Throwable cause) { super(cause); }
    ...
    public static class ApplicationSettingsException extends AiravataException {
        ...
        public ApplicationSettingsException(String message) { super(message); }

        public ApplicationSettingsException(String message, Throwable e) { super(message, e); }
    }

    public static class TimedOutException extends Exception {
        private static final long serialVersionUID = 1L;

        public TimedOutException() { super(); }
