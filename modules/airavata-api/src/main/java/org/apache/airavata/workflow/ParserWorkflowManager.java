...
import org.apache.airavata.dapr.messaging.DaprParsingHandler;
...
public class ParserWorkflowManager extends WorkflowManager implements DaprParsingHandler {
    ...
    public ParserWorkflowManager(
        ...
        super("parser-workflow-manager", false, registryService, messagingFactory);
    ...
    protected void doStart() throws Exception {
        init();
        logger.info(
                "ParserWorkflowManager started; Dapr delivers {} to /api/v1/dapr/pubsub/{}",
                org.apache.airavata.dapr.messaging.DaprTopics.PARSING,
                org.apache.airavata.dapr.messaging.DaprTopics.PARSING);
    }
