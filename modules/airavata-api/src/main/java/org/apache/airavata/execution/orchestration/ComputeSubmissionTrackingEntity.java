...
class ComputeSubmissionTrackingEntity implements Serializable {
    ...
    ComputeSubmissionTrackingEntity() {}

    String getComputeResourceId() {
        return computeResourceId;
    }

    void setComputeResourceId(String computeResourceId) {
        this.computeResourceId = computeResourceId;
    }

    long getLastSubmissionTime() {
        return lastSubmissionTime;
    }

    void setLastSubmissionTime(long lastSubmissionTime) {
