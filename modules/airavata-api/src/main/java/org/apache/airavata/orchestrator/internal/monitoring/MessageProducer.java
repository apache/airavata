...
public class MessageProducer {
    ...
    /** Dapr topic for external broker format (jobName, status, task) consumed by RealtimeMonitorHandler. */
    public static final String MONITORING_TOPIC = DaprTopics.MONITORING;
    /** Dapr topic for JobStatusResult (MessageProducer publish, PostWorkflowManager consume). */
    public static final String MONITORING_JOB_STATUS_TOPIC = DaprTopics.MONITORING_JOB_STATUS;
