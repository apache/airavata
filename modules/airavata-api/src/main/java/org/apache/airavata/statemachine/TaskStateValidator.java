...
/**
 * Validates TaskState transitions. Simple linear flow through task lifecycle.
 *
 * <p>Valid transitions:
 * <ul>
 *   <li>CREATED → EXECUTING</li>
 *   <li>EXECUTING → COMPLETED, FAILED, CANCELED</li>
 * </ul>
 *
 * <p>Terminal states: COMPLETED, FAILED, CANCELED (no transitions out).
 */
