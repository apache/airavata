...
public class ExperimentModel {
    ...
    /**
     * Compatibility alias: returns epoch milliseconds from {@link #createdAt}.
     * Callers that previously used {@code getCreationTime()} can migrate incrementally.
     */
    ...
    /**
     * Compatibility alias: sets {@link #createdAt} from epoch milliseconds.
     * Callers that previously used {@code setCreationTime(long)} can migrate incrementally.
     */
    public void setCreationTime(long millis) {
        this.createdAt = millis > 0 ? Instant.ofEpochMilli(millis) : null;
    }
