 ...
 * Manage AWS context
 */
public class AwsProcessContext {

    private static final Logger LOGGER = LoggerFactory.getLogger(AwsProcessContext.class);
    ...
    public AwsProcessContext(ProcessService processService, TaskContext taskContext) {
        this.processService = processService;
        this.taskContext = taskContext;
        this.processId = taskContext.getProcessId();
        LOGGER.info("Initialized AWSProcessContext for process {}", processId);
    }
    ...
    public void saveInstanceId(String instanceId) throws RegistryException, IOException {
    ...
    public void saveSecurityGroupId(String securityGroupId) throws RegistryException, IOException {
    ...
    public void saveKeyPairName(String keyPairName) throws RegistryException, IOException {
    ...
    public void saveSSHCredentialToken(String credentialToken) throws RegistryException, IOException {
    ...
    public void savePublicIp(String publicIp) throws RegistryException, IOException {
    ...
    public void saveJobId(String jobId) throws RegistryException, IOException {
        updateContext(AWS_JOB_ID, jobId);
    }

    /**
     * Returns AWS-specific compute resource preferences.
     * Legacy stub - returns null until tasks are migrated to the new domain model.
     */
    public AwsComputeResourcePreference getAwsComputeResourcePreference() {
        return null;
    }

    public void cleanup() throws RegistryException, IOException {
    ...
    private Map<String, String> getContextMap() throws IOException {
        String jsonContext = taskContext.getProcessModel().getProviderContext();
    ...
    private void updateContext(String key, String value) throws RegistryException, IOException {
        Map<String, String> contextMap = getContextMap();
        contextMap.put(key, value);
        ProcessModel processModel = taskContext.getProcessModel();
        processModel.setProviderContext(MAPPER.writeValueAsString(contextMap));
