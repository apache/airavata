...
public class JobStatusEventToResultConverter {
    ...
    public JobStatusResult convert(JobStatusUpdateEvent event, RegistryService registryService) {
        ...
        try {
            String jobId = getJobIdByJobNameWithRetry(jobName, taskId, registryService);
            if (jobId == null) {
    ...
    private static String getJobIdByJobNameWithRetry(String jobName, String taskId, RegistryService registryService)
