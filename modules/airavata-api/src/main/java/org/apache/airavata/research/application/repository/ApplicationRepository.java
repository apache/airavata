 ...
 *
 * <p>Provides query methods for science applications registered in the Airavata registry,
 * scoped to a gateway. All finder methods use Spring Data JPA method naming conventions
 * for automatic query derivation.
 */
@Repository
public interface ApplicationRepository extends JpaRepository<ApplicationEntity, String> {

    /**
     * Find all applications registered in a specific gateway.
     *
