...
public class JobModel {
    ...
    public String toString() {
        return "JobModel{" + "jobId=" + jobId + ", taskId=" + taskId + ", processId=" + processId + ", jobDescription="
                + jobDescription + ", creationTime=" + creationTime + ", jobStatuses=" + jobStatuses
