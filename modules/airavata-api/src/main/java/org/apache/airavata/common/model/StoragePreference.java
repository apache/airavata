...
/**
 * Domain model: StoragePreference
 */
public class StoragePreference {
    ...
    public boolean equals(Object o) {
        ...
        StoragePreference that = (StoragePreference) o;
    ...
    public String toString() {
        return "StoragePreference{" + "storageResourceId=" + storageResourceId + ", loginUserName=" + loginUserName
