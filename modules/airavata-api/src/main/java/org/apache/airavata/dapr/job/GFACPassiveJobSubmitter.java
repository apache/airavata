...
* under the License.
*/
package org.apache.airavata.dapr.job;
 ...
 */
public class GFACPassiveJobSubmitter implements JobSubmitter {
        ...
        if (orchestratorContext.getPublisher() != null) {
            ...
            try {
                ...
                throw new OrchestratorException("Cannot initialize " + GFACPassiveJobSubmitter.class
                        + " - Dapr messaging factory is not available");
            }
        }
    ...
    public void setMessagingFactory(DaprMessagingFactory messagingFactory) {
