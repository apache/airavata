...
@Entity(name = "ResearchArtifactEntity")
@Table(name = "research_artifact")
@Inheritance(strategy = InheritanceType.JOINED)
@EntityListeners(AuditingEntityListener.class)
public abstract class ResearchArtifactEntity {
    ...
    @CollectionTable(name = "research_artifact_authors", joinColumns = @JoinColumn(name = "artifact_id"))
    @Column(name = "author_id")
    private Set<String> authors = new HashSet<>();

    @ManyToMany(cascade = CascadeType.MERGE, fetch = FetchType.EAGER)
    @JoinTable(
            name = "research_artifact_tags",
