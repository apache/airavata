...
public class ResearchSessionService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ResearchSessionService.class);
    ...
    public ResearchSessionService(SessionRepository sessionRepository, ResearchProjectService projectService) {
