...
public class TaskModel {
    ...
    private List<StatusModel<TaskState>> taskStatuses;
    ...
    public List<StatusModel<TaskState>> getTaskStatuses() {
        return taskStatuses;
    }

    public void setTaskStatuses(List<StatusModel<TaskState>> taskStatuses) {
    ...
    public String toString() {
        return "TaskModel{" + "taskId=" + taskId + ", taskType=" + taskType + ", parentProcessId=" + parentProcessId
                ...
                + taskStatuses + ", subTaskModel=" + subTaskModel + ", taskErrors="
