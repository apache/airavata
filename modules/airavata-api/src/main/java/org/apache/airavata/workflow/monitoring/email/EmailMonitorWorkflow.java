...
* under the License.
*/
package org.apache.airavata.workflow.monitoring.email;
...
public class EmailMonitorWorkflow extends ServerLifecycle {
    ...
    public EmailMonitorWorkflow(
        ...
        JobStatusHandler handler = null;
        try {
            handler = applicationContext.getBean(JobStatusHandler.class);
