...
import org.apache.airavata.registry.entities.expcatalog.TaskStatusPK;
...
public interface TaskStatusRepository extends JpaRepository<TaskStatusEntity, TaskStatusPK> {
    ...
    @Query(
            "SELECT t FROM TaskStatusEntity t WHERE t.taskId = :taskId ORDER BY t.timeOfStateChange DESC, t.statusId DESC")
