...
public interface GroupMembershipRepository extends JpaRepository<GroupMembershipEntity, String> {
    ...
    List<GroupMembershipEntity> findByDomainIdAndGroupId(String domainId, String groupId);

    List<GroupMembershipEntity> findByDomainIdAndUserId(String domainId, String userId);

    Optional<GroupMembershipEntity> findByDomainIdAndGroupIdAndUserId(String domainId, String groupId, String userId);
