...
public interface ComputeResourceRepository extends JpaRepository<ComputeResourceEntity, String> {
    ...
    @Query("SELECT DISTINCT cr FROM ComputeResourceEntity cr WHERE cr.hostName LIKE :hostName")
    List<ComputeResourceEntity> findByHostName(@Param("hostName") String hostName);
}
