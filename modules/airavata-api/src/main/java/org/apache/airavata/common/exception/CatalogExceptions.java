...
/**
 * Catalog/entity-not-found and duplicate-entry exceptions.
 */
public final class CatalogExceptions {
    ...
    public static class ExperimentNotFoundException extends Exception {
        ...
        public ExperimentNotFoundException() { super(); }

        public ExperimentNotFoundException(String message) { super(message); }
