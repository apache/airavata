...
/**
 * Validates JobState transitions. Makes allowed transitions explicit and traceable.
 *
 * <p>Valid transitions:
 * <ul>
 *   <li>SUBMITTED → QUEUED, ACTIVE, COMPLETE, CANCELED, FAILED, SUSPENDED, UNKNOWN, NON_CRITICAL_FAIL</li>
 *   <li>QUEUED → ACTIVE, COMPLETE, CANCELED, FAILED, SUSPENDED, UNKNOWN, NON_CRITICAL_FAIL</li>
 *   <li>ACTIVE → COMPLETE, CANCELED, FAILED, SUSPENDED, UNKNOWN, NON_CRITICAL_FAIL</li>
 *   <li>NON_CRITICAL_FAIL → QUEUED, ACTIVE, COMPLETE, CANCELED, FAILED, SUSPENDED, UNKNOWN</li>
 * </ul>
 *
 * <p>Terminal states (no transitions out): COMPLETE, CANCELED, FAILED, SUSPENDED, UNKNOWN
 */
public enum JobStateValidator implements StateValidator<JobState> {
    ...
    private static final Set<StateTransition<JobState>> VALID_TRANSITIONS = Set.of(
            ...
            // From NON_CRITICAL_FAIL (recoverable - can requeue)
