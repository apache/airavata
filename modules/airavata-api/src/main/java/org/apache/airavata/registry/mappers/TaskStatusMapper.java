...
/**
 * MapStruct mapper for converting between TaskStatusEntity and TaskStatus.
 */
...
public interface TaskStatusMapper {
    ...
    TaskStatus toModel(TaskStatusEntity entity);
    ...
    TaskStatusEntity toEntity(TaskStatus model);

    List<TaskStatus> toModelList(List<TaskStatusEntity> entities);

    List<TaskStatusEntity> toEntityList(List<TaskStatus> models);
}
