...
public class GromacsStampede extends UserLogin {
  ...
  public void testGromacsStampede() throws Exception {
    ...
    driver.findElement(By.name("continue")).click();
      waitTime (200);
    driver.findElement(By.id("Portable-Input-Binary-File")).sendKeys(ExpFileReadUtils.GROMACS_INPUT1);
      waitTime (200);
    driver.findElement(By.id("GROMOS-Coordinate-file")).sendKeys(ExpFileReadUtils.GROMACS_INPUT2);
      waitTime (200);
