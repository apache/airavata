...
public class TrinityStampede extends UserLogin {
  ...
  public void testTrinityStampede() throws Exception {
    ...
    driver.findElement(By.id("RNA-Seq-Right-Input")).sendKeys(ExpFileReadUtils.TRINITY_INPUT2);
      waitTime (200);
    driver.findElement(By.id("SS-Lib-Type")).clear();
    driver.findElement(By.id("SS-Lib-Type")).sendKeys("RF");
      waitTime (200);
    driver.findElement(By.id("CPU")).clear();
    driver.findElement(By.id("CPU")).sendKeys("4");
      waitTime (200);
    driver.findElement(By.id("Max-HeapSpace")).clear();
    driver.findElement(By.id("Max-HeapSpace")).sendKeys("2G");
      waitTime (200);
