...
public class UserSpecificResourceDetail implements org.apache.thrift.TBase<UserSpecificResourceDetail, UserSpecificResourceDetail._Fields>, java.io.Serializable, Cloneable, Comparable<UserSpecificResourceDetail> {
  ...
  private static final org.apache.thrift.protocol.TField USED_SERVICE_UNITS_FIELD_DESC = new org.apache.thrift.protocol.TField("usedServiceUnits", org.apache.thrift.protocol.TType.I64, (short)12);
  ...
  public long usedServiceUnits; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    USED_SERVICE_UNITS((short)12, "usedServiceUnits");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 11: // SUB_STATUS
          return SUB_STATUS;
        case 12: // USED_SERVICE_UNITS
          return USED_SERVICE_UNITS;
        default:
          return null;
      }
    }
  ...
  private static final int __USEDSERVICEUNITS_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.ID,_Fields.ALLOCATED_SERVICE_UNITS,_Fields.APPLICATIONS_TO_BE_USED,_Fields.END_DATE,_Fields.PROJECT_ID,_Fields.REJECTION_REASON,_Fields.REQUESTED_SERVICE_UNITS,_Fields.RESOURCE_TYPE,_Fields.SPECIFIC_RESOURCE,_Fields.START_DATE,_Fields.SUB_STATUS,_Fields.USED_SERVICE_UNITS};
  ...
  static {
    ...
    tmpMap.put(_Fields.SUB_STATUS, new org.apache.thrift.meta_data.FieldMetaData("subStatus", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.USED_SERVICE_UNITS, new org.apache.thrift.meta_data.FieldMetaData("usedServiceUnits", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
  ...
  public UserSpecificResourceDetail(UserSpecificResourceDetail other) {
    ...
    this.usedServiceUnits = other.usedServiceUnits;
  }
  ...
  public void clear() {
    ...
    this.startDate = 0;
    this.subStatus = null;
    setUsedServiceUnitsIsSet(false);
    this.usedServiceUnits = 0;
  }
  ...
  public long getUsedServiceUnits() {
    return this.usedServiceUnits;
  }

  public UserSpecificResourceDetail setUsedServiceUnits(long usedServiceUnits) {
    this.usedServiceUnits = usedServiceUnits;
    setUsedServiceUnitsIsSet(true);
    return this;
  }

  public void unsetUsedServiceUnits() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __USEDSERVICEUNITS_ISSET_ID);
  }

  /** Returns true if field usedServiceUnits is set (has been assigned a value) and false otherwise */
  public boolean isSetUsedServiceUnits() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __USEDSERVICEUNITS_ISSET_ID);
  }

  public void setUsedServiceUnitsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __USEDSERVICEUNITS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case USED_SERVICE_UNITS:
      if (value == null) {
        unsetUsedServiceUnits();
      } else {
        setUsedServiceUnits((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(UserSpecificResourceDetail that) {
    ...
    boolean this_present_usedServiceUnits = true && this.isSetUsedServiceUnits();
    boolean that_present_usedServiceUnits = true && that.isSetUsedServiceUnits();
    if (this_present_usedServiceUnits || that_present_usedServiceUnits) {
      if (!(this_present_usedServiceUnits && that_present_usedServiceUnits))
        return false;
      if (this.usedServiceUnits != that.usedServiceUnits)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetUsedServiceUnits()) ? 131071 : 524287);
    if (isSetUsedServiceUnits())
      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(usedServiceUnits);
  ...
  public int compareTo(UserSpecificResourceDetail other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUsedServiceUnits()).compareTo(other.isSetUsedServiceUnits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUsedServiceUnits()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.usedServiceUnits, other.usedServiceUnits);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetUsedServiceUnits()) {
      ...
      sb.append(this.usedServiceUnits);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class UserSpecificResourceDetailStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserSpecificResourceDetail> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserSpecificResourceDetail struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 12: // USED_SERVICE_UNITS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.usedServiceUnits = iprot.readI64();
              struct.setUsedServiceUnitsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserSpecificResourceDetail struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUsedServiceUnits()) {
        oprot.writeFieldBegin(USED_SERVICE_UNITS_FIELD_DESC);
        oprot.writeI64(struct.usedServiceUnits);
        oprot.writeFieldEnd();
      }
