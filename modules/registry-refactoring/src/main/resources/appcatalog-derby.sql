...
(
        ...
        FOREIGN KEY (PARSER_INFO_ID) REFERENCES PARSER_INFO (PARSER_INFO_ID) ON DELETE CASCADE
);
...
(
        ...
        FOREIGN KEY (PARENT_PARSER_INFO_ID) REFERENCES PARSER_INFO (PARSER_INFO_ID) ON DELETE CASCADE,
        FOREIGN KEY (CHILD_PARSER_INFO_ID) REFERENCES PARSER_INFO (PARSER_INFO_ID) ON DELETE CASCADE,
        FOREIGN KEY (PARSING_TEMPLATE_ID) REFERENCES PARSING_TEMPLATE (PARSING_TEMPLATE_ID) ON DELETE CASCADE
);
...
(
        ...
        FOREIGN KEY (PARSER_INPUT_ID) REFERENCES PARSER_INPUT (PARSER_INPUT_ID) ON DELETE CASCADE,
        FOREIGN KEY (PARSER_OUTPUT_ID) REFERENCES PARSER_INPUT (PARSER_INPUT_ID) ON DELETE CASCADE,
        FOREIGN KEY (PARSER_DAG_ELEMENT_ID) REFERENCES PARSER_DAG_ELEMENT (PARSER_DAG_ELEMENT_ID) ON DELETE CASCADE
);
