...
CREATE TABLE BATCH_QUEUE_RESOURCE_POLICY (
  ...
  GROUP_RESOURCE_PROFILE_ID varchar(255) NOT NULL,
  QUEUE_NAME varchar(255) NOT NULL,
  MAX_ALLOWED_NODES varchar(255) DEFAULT NULL,
  MAX_ALLOWED_CORES varchar(255) DEFAULT NULL,
  MAX_ALLOWED_WALLTIME varchar(255) DEFAULT NULL,
  PRIMARY KEY (RESOURCE_POLICY_ID,COMPUTE_RESOURCE_ID,GROUP_RESOURCE_PROFILE_ID,QUEUE_NAME),
  FOREIGN KEY (COMPUTE_RESOURCE_ID) REFERENCES COMPUTE_RESOURCE(RESOURCE_ID) ON DELETE CASCADE,
  FOREIGN KEY (QUEUE_NAME) REFERENCES COMPUTE_RESOURCE_POLICY(QUEUE_NAME) ON DELETE CASCADE,
