...
public interface SCPDataMovementMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.SCPDataMovement toThrift(SCPDataMovement domain);

    /**
     * Convert thrift model to domain model.
     */
    SCPDataMovement toDomain(org.apache.airavata.thriftapi.model.SCPDataMovement thrift);
}
