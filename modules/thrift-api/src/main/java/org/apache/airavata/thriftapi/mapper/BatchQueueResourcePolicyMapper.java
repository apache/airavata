...
public interface BatchQueueResourcePolicyMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.BatchQueueResourcePolicy toThrift(BatchQueueResourcePolicy domain);

    /**
     * Convert thrift model to domain model.
     */
    BatchQueueResourcePolicy toDomain(org.apache.airavata.thriftapi.model.BatchQueueResourcePolicy thrift);
}
