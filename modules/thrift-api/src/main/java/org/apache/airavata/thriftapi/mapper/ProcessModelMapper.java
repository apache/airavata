...
public interface ProcessModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ProcessModel toThrift(ProcessModel domain);

    /**
     * Convert thrift model to domain model.
     */
    ProcessModel toDomain(org.apache.airavata.thriftapi.model.ProcessModel thrift);
}
