...
import org.apache.airavata.thriftapi.model.HandlerStatus;
...
public interface HandlerStatusMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.HandlerStatus toThrift(HandlerStatus domain);

    /**
     * Convert thrift model to domain model.
     */
    HandlerStatus toDomain(org.apache.airavata.thriftapi.model.HandlerStatus thrift);
}
