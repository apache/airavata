...
public interface InputDataObjectTypeMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.InputDataObjectType toThrift(InputDataObjectType domain);

    /**
     * Convert thrift model to domain model.
     */
    InputDataObjectType toDomain(org.apache.airavata.thriftapi.model.InputDataObjectType thrift);
}
