...
import org.apache.airavata.common.model.User;
import org.apache.airavata.thriftapi.model.User;
...
public interface UserMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.User toThrift(User domain);

    /**
     * Convert thrift model to domain model.
     */
    User toDomain(org.apache.airavata.thriftapi.model.User thrift);
}
