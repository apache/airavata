...
public interface CommunityUserMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.credential.model.CommunityUser toThrift(CommunityUser domain);

    /**
     * Convert thrift model to domain model.
     */
    CommunityUser toDomain(org.apache.airavata.thriftapi.credential.model.CommunityUser thrift);
}
