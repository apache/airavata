...
public interface DataReplicaLocationModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.DataReplicaLocationModel toThrift(DataReplicaLocationModel domain);

    /**
     * Convert thrift model to domain model.
     */
    DataReplicaLocationModel toDomain(org.apache.airavata.thriftapi.model.DataReplicaLocationModel thrift);
}
