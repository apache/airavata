...
public interface ApplicationModuleMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ApplicationModule toThrift(ApplicationModule domain);

    /**
     * Convert thrift model to domain model.
     */
    ApplicationModule toDomain(org.apache.airavata.thriftapi.model.ApplicationModule thrift);
}
