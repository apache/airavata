...
import org.apache.airavata.thriftapi.model.DBEventSubscriber;
...
public interface DBEventSubscriberMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.DBEventSubscriber toThrift(DBEventSubscriber domain);

    /**
     * Convert thrift model to domain model.
     */
    DBEventSubscriber toDomain(org.apache.airavata.thriftapi.model.DBEventSubscriber thrift);
}
