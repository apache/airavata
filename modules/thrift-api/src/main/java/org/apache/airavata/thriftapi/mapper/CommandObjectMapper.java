...
import org.apache.airavata.thriftapi.model.CommandObject;
...
public interface CommandObjectMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.CommandObject toThrift(CommandObject domain);

    /**
     * Convert thrift model to domain model.
     */
    CommandObject toDomain(org.apache.airavata.thriftapi.model.CommandObject thrift);
}
