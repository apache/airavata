...
public interface OutputDataObjectTypeMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.OutputDataObjectType toThrift(OutputDataObjectType domain);

    /**
     * Convert thrift model to domain model.
     */
    OutputDataObjectType toDomain(org.apache.airavata.thriftapi.model.OutputDataObjectType thrift);
}
