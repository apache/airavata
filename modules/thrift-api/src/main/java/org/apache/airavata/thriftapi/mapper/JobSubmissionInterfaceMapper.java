...
import org.apache.airavata.thriftapi.model.JobSubmissionInterface;
...
public interface JobSubmissionInterfaceMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.JobSubmissionInterface toThrift(JobSubmissionInterface domain);

    /**
     * Convert thrift model to domain model.
     */
    JobSubmissionInterface toDomain(org.apache.airavata.thriftapi.model.JobSubmissionInterface thrift);
}
