...
public interface CredentialSummaryMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.credential.model.CredentialSummary toThrift(CredentialSummary domain);

    /**
     * Convert thrift model to domain model.
     */
    CredentialSummary toDomain(org.apache.airavata.thriftapi.credential.model.CredentialSummary thrift);
}
