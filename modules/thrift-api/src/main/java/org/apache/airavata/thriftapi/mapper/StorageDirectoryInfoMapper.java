...
public interface StorageDirectoryInfoMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.StorageDirectoryInfo toThrift(StorageDirectoryInfo domain);

    /**
     * Convert thrift model to domain model.
     */
    StorageDirectoryInfo toDomain(org.apache.airavata.thriftapi.model.StorageDirectoryInfo thrift);
}
