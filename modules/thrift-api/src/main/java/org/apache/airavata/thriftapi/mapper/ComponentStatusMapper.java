...
public interface ComponentStatusMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ComponentStatus toThrift(ComponentStatus domain);

    /**
     * Convert thrift model to domain model.
     */
    ComponentStatus toDomain(org.apache.airavata.thriftapi.model.ComponentStatus thrift);
}
