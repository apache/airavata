...
public interface CredentialStoreExceptionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.credential.exception.CredentialStoreException toThrift(
            CredentialStoreException domain);

    /**
     * Convert thrift exception to domain exception.
     */
    CredentialStoreException toDomain(
            org.apache.airavata.thriftapi.credential.exception.CredentialStoreException thrift);
}
