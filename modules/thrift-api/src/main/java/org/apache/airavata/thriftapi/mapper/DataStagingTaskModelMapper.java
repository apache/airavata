...
import org.apache.airavata.thriftapi.model.DataStagingTaskModel;
...
public interface DataStagingTaskModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.DataStagingTaskModel toThrift(DataStagingTaskModel domain);

    /**
     * Convert thrift model to domain model.
     */
    DataStagingTaskModel toDomain(org.apache.airavata.thriftapi.model.DataStagingTaskModel thrift);
}
