...
import org.apache.airavata.thriftapi.model.ExperimentStatusChangeEvent;
...
public interface ExperimentStatusChangeEventMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ExperimentStatusChangeEvent toThrift(ExperimentStatusChangeEvent domain);

    /**
     * Convert thrift model to domain model.
     */
    ExperimentStatusChangeEvent toDomain(org.apache.airavata.thriftapi.model.ExperimentStatusChangeEvent thrift);
}
