...
import org.apache.airavata.thriftapi.model.ApplicationStatus;
...
public interface ApplicationStatusMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ApplicationStatus toThrift(ApplicationStatus domain);

    /**
     * Convert thrift model to domain model.
     */
    ApplicationStatus toDomain(org.apache.airavata.thriftapi.model.ApplicationStatus thrift);
}
