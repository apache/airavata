...
public interface CloudJobSubmissionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.CloudJobSubmission toThrift(CloudJobSubmission domain);

    /**
     * Convert thrift model to domain model.
     */
    CloudJobSubmission toDomain(org.apache.airavata.thriftapi.model.CloudJobSubmission thrift);
}
