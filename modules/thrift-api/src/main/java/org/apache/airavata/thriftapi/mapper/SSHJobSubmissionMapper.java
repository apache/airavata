...
public interface SSHJobSubmissionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.SSHJobSubmission toThrift(SSHJobSubmission domain);

    /**
     * Convert thrift model to domain model.
     */
    SSHJobSubmission toDomain(org.apache.airavata.thriftapi.model.SSHJobSubmission thrift);
}
