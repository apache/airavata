...
import org.apache.airavata.thriftapi.model.ParserConnector;
...
public interface ParserConnectorMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ParserConnector toThrift(ParserConnector domain);

    /**
     * Convert thrift model to domain model.
     */
    ParserConnector toDomain(org.apache.airavata.thriftapi.model.ParserConnector thrift);
}
