...
import org.apache.airavata.common.model.NodeModel;
import org.apache.airavata.thriftapi.model.NodeModel;
...
public interface NodeModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.NodeModel toThrift(NodeModel domain);

    /**
     * Convert thrift model to domain model.
     */
    NodeModel toDomain(org.apache.airavata.thriftapi.model.NodeModel thrift);
}
