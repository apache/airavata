...
public interface StorageResourceDescriptionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.StorageResourceDescription toThrift(StorageResourceDescription domain);

    /**
     * Convert thrift model to domain model.
     */
    StorageResourceDescription toDomain(org.apache.airavata.thriftapi.model.StorageResourceDescription thrift);
}
