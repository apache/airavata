...
public interface GatewayGroupsMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.GatewayGroups toThrift(GatewayGroups domain);

    /**
     * Convert thrift model to domain model.
     */
    GatewayGroups toDomain(org.apache.airavata.thriftapi.model.GatewayGroups thrift);
}
