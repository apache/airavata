...
public interface ComputeResourceDescriptionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ComputeResourceDescription toThrift(ComputeResourceDescription domain);

    /**
     * Convert thrift model to domain model.
     */
    ComputeResourceDescription toDomain(org.apache.airavata.thriftapi.model.ComputeResourceDescription thrift);
}
