...
public interface GridFTPDataMovementMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.GridFTPDataMovement toThrift(GridFTPDataMovement domain);

    /**
     * Convert thrift model to domain model.
     */
    GridFTPDataMovement toDomain(org.apache.airavata.thriftapi.model.GridFTPDataMovement thrift);
}
