...
public interface StorageVolumeInfoMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.StorageVolumeInfo toThrift(StorageVolumeInfo domain);

    /**
     * Convert thrift model to domain model.
     */
    StorageVolumeInfo toDomain(org.apache.airavata.thriftapi.model.StorageVolumeInfo thrift);
}
