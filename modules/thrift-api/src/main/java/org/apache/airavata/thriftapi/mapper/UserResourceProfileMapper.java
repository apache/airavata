...
public interface UserResourceProfileMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.UserResourceProfile toThrift(UserResourceProfile domain);

    /**
     * Convert thrift model to domain model.
     */
    UserResourceProfile toDomain(org.apache.airavata.thriftapi.model.UserResourceProfile thrift);
}
