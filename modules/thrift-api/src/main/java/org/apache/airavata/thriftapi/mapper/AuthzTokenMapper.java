...
public interface AuthzTokenMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.security.model.AuthzToken toThrift(AuthzToken domain);

    /**
     * Convert thrift model to domain model.
     */
    AuthzToken toDomain(org.apache.airavata.thriftapi.security.model.AuthzToken thrift);
}
