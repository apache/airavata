...
import org.apache.airavata.thriftapi.model.DataBlock;
...
public interface DataBlockMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.DataBlock toThrift(DataBlock domain);

    /**
     * Convert thrift model to domain model.
     */
    DataBlock toDomain(org.apache.airavata.thriftapi.model.DataBlock thrift);
}
