...
public interface StoragePreferenceMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.StoragePreference toThrift(StoragePreference domain);

    /**
     * Convert thrift model to domain model.
     */
    StoragePreference toDomain(org.apache.airavata.thriftapi.model.StoragePreference thrift);
}
