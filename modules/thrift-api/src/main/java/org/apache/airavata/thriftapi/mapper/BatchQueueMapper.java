...
import org.apache.airavata.thriftapi.model.BatchQueue;
...
public interface BatchQueueMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.BatchQueue toThrift(BatchQueue domain);

    /**
     * Convert thrift model to domain model.
     */
    BatchQueue toDomain(org.apache.airavata.thriftapi.model.BatchQueue thrift);
}
