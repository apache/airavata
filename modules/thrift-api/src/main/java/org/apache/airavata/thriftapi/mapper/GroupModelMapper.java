...
import org.apache.airavata.thriftapi.model.GroupModel;
...
public interface GroupModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.GroupModel toThrift(GroupModel domain);

    /**
     * Convert thrift model to domain model.
     */
    GroupModel toDomain(org.apache.airavata.thriftapi.model.GroupModel thrift);
}
