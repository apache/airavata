...
public interface GatewayResourceProfileMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.GatewayResourceProfile toThrift(GatewayResourceProfile domain);

    /**
     * Convert thrift model to domain model.
     */
    GatewayResourceProfile toDomain(org.apache.airavata.thriftapi.model.GatewayResourceProfile thrift);
}
