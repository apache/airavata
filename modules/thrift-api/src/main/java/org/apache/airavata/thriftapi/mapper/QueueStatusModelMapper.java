...
public interface QueueStatusModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.QueueStatusModel toThrift(QueueStatusModel domain);

    /**
     * Convert thrift model to domain model.
     */
    QueueStatusModel toDomain(org.apache.airavata.thriftapi.model.QueueStatusModel thrift);
}
