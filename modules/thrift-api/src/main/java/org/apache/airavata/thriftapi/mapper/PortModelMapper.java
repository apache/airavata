...
import org.apache.airavata.common.model.PortModel;
import org.apache.airavata.thriftapi.model.PortModel;
...
public interface PortModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.PortModel toThrift(PortModel domain);

    /**
     * Convert thrift model to domain model.
     */
    PortModel toDomain(org.apache.airavata.thriftapi.model.PortModel thrift);
}
