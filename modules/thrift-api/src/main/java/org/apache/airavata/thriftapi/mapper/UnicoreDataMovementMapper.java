...
public interface UnicoreDataMovementMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.UnicoreDataMovement toThrift(UnicoreDataMovement domain);

    /**
     * Convert thrift model to domain model.
     */
    UnicoreDataMovement toDomain(org.apache.airavata.thriftapi.model.UnicoreDataMovement thrift);
}
