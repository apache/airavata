...
import org.apache.airavata.thriftapi.model.SetEnvPaths;
...
public interface SetEnvPathsMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.SetEnvPaths toThrift(SetEnvPaths domain);

    /**
     * Convert thrift model to domain model.
     */
    SetEnvPaths toDomain(org.apache.airavata.thriftapi.model.SetEnvPaths thrift);
}
