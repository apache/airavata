...
import org.apache.airavata.thriftapi.model.JobStatusChangeEvent;
...
public interface JobStatusChangeEventMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.JobStatusChangeEvent toThrift(JobStatusChangeEvent domain);

    /**
     * Convert thrift model to domain model.
     */
    JobStatusChangeEvent toDomain(org.apache.airavata.thriftapi.model.JobStatusChangeEvent thrift);
}
