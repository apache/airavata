...
import org.apache.airavata.thriftapi.model.ProcessSubmitEvent;
...
public interface ProcessSubmitEventMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ProcessSubmitEvent toThrift(ProcessSubmitEvent domain);

    /**
     * Convert thrift model to domain model.
     */
    ProcessSubmitEvent toDomain(org.apache.airavata.thriftapi.model.ProcessSubmitEvent thrift);
}
