...
public interface ExperimentSummaryModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ExperimentSummaryModel toThrift(ExperimentSummaryModel domain);

    /**
     * Convert thrift model to domain model.
     */
    ExperimentSummaryModel toDomain(org.apache.airavata.thriftapi.model.ExperimentSummaryModel thrift);
}
