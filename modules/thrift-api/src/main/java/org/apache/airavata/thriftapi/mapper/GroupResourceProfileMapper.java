...
public interface GroupResourceProfileMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.GroupResourceProfile toThrift(GroupResourceProfile domain);

    /**
     * Convert thrift model to domain model.
     */
    GroupResourceProfile toDomain(org.apache.airavata.thriftapi.model.GroupResourceProfile thrift);
}
