...
import org.apache.airavata.common.model.TaskStatusChangeRequestEvent;
import org.apache.airavata.thriftapi.model.TaskStatusChangeRequestEvent;
...
public interface TaskStatusChangeRequestEventMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.TaskStatusChangeRequestEvent toThrift(TaskStatusChangeRequestEvent domain);

    /**
     * Convert thrift model to domain model.
     */
    TaskStatusChangeRequestEvent toDomain(org.apache.airavata.thriftapi.model.TaskStatusChangeRequestEvent thrift);
}
