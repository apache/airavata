...
import org.apache.airavata.thriftapi.model.WorkflowStatus;
...
public interface WorkflowStatusMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.WorkflowStatus toThrift(WorkflowStatus domain);

    /**
     * Convert thrift model to domain model.
     */
    WorkflowStatus toDomain(org.apache.airavata.thriftapi.model.WorkflowStatus thrift);
}
