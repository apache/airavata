...
public interface LOCALDataMovementMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.LOCALDataMovement toThrift(LOCALDataMovement domain);

    /**
     * Convert thrift model to domain model.
     */
    LOCALDataMovement toDomain(org.apache.airavata.thriftapi.model.LOCALDataMovement thrift);
}
