...
public interface ResourceJobManagerMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ResourceJobManager toThrift(ResourceJobManager domain);

    /**
     * Convert thrift model to domain model.
     */
    ResourceJobManager toDomain(org.apache.airavata.thriftapi.model.ResourceJobManager thrift);
}
