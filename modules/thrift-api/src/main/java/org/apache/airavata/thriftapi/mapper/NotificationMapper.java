...
public interface NotificationMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.Notification toThrift(Notification domain);

    /**
     * Convert thrift model to domain model.
     */
    Notification toDomain(org.apache.airavata.thriftapi.model.Notification thrift);
}
