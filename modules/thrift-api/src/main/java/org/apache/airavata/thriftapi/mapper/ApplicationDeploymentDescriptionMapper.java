...
public interface ApplicationDeploymentDescriptionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ApplicationDeploymentDescription toThrift(
            ApplicationDeploymentDescription domain);

    /**
     * Convert thrift model to domain model.
     */
    ApplicationDeploymentDescription toDomain(
            org.apache.airavata.thriftapi.model.ApplicationDeploymentDescription thrift);
}
