...
import org.apache.airavata.thriftapi.model.GroupAccountSSHProvisionerConfig;
...
public interface GroupAccountSSHProvisionerConfigMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.GroupAccountSSHProvisionerConfig toThrift(
            GroupAccountSSHProvisionerConfig domain);

    /**
     * Convert thrift model to domain model.
     */
    GroupAccountSSHProvisionerConfig toDomain(
            org.apache.airavata.thriftapi.model.GroupAccountSSHProvisionerConfig thrift);
}
