...
import org.apache.airavata.common.model.EdgeModel;
import org.apache.airavata.thriftapi.model.EdgeModel;
...
public interface EdgeModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.EdgeModel toThrift(EdgeModel domain);

    /**
     * Convert thrift model to domain model.
     */
    EdgeModel toDomain(org.apache.airavata.thriftapi.model.EdgeModel thrift);
}
