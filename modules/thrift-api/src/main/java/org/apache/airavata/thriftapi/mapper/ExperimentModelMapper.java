...
public interface ExperimentModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ExperimentModel toThrift(ExperimentModel domain);

    /**
     * Convert thrift model to domain model.
     */
    ExperimentModel toDomain(org.apache.airavata.thriftapi.model.ExperimentModel thrift);
}
