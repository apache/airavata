...
public interface ParsingTemplateMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ParsingTemplate toThrift(ParsingTemplate domain);

    /**
     * Convert thrift model to domain model.
     */
    ParsingTemplate toDomain(org.apache.airavata.thriftapi.model.ParsingTemplate thrift);
}
