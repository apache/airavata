...
import org.apache.airavata.common.model.TenantConfig;
import org.apache.airavata.thriftapi.model.TenantConfig;
...
public interface TenantConfigMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.TenantConfig toThrift(TenantConfig domain);

    /**
     * Convert thrift model to domain model.
     */
    TenantConfig toDomain(org.apache.airavata.thriftapi.model.TenantConfig thrift);
}
