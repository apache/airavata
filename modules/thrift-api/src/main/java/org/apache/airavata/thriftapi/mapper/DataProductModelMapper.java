...
public interface DataProductModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.DataProductModel toThrift(DataProductModel domain);

    /**
     * Convert thrift model to domain model.
     */
    DataProductModel toDomain(org.apache.airavata.thriftapi.model.DataProductModel thrift);
}
