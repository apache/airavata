...
public interface ComputationalResourceSchedulingModelMapper extends ModelMapper {
    ...
    ComputationalResourceSchedulingModelMapper INSTANCE =
            Mappers.getMapper(ComputationalResourceSchedulingModelMapper.class);

    /**
     * Convert domain model to thrift model.
     */
    org.apache.airavata.thriftapi.model.ComputationalResourceSchedulingModel toThrift(
            ComputationalResourceSchedulingModel domain);

    /**
     * Convert thrift model to domain model.
     */
    ComputationalResourceSchedulingModel toDomain(
            org.apache.airavata.thriftapi.model.ComputationalResourceSchedulingModel thrift);
}
