...
public interface ComputeResourcePolicyMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ComputeResourcePolicy toThrift(ComputeResourcePolicy domain);

    /**
     * Convert thrift model to domain model.
     */
    ComputeResourcePolicy toDomain(org.apache.airavata.thriftapi.model.ComputeResourcePolicy thrift);
}
