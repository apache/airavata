...
import org.apache.airavata.thriftapi.model.ExperimentIntermediateOutputsEvent;
...
public interface ExperimentIntermediateOutputsEventMapper extends ModelMapper {
    ...
    ExperimentIntermediateOutputsEventMapper INSTANCE =
            Mappers.getMapper(ExperimentIntermediateOutputsEventMapper.class);

    /**
     * Convert domain model to thrift model.
     */
    org.apache.airavata.thriftapi.model.ExperimentIntermediateOutputsEvent toThrift(
            ExperimentIntermediateOutputsEvent domain);

    /**
     * Convert thrift model to domain model.
     */
    ExperimentIntermediateOutputsEvent toDomain(
            org.apache.airavata.thriftapi.model.ExperimentIntermediateOutputsEvent thrift);
}
