...
public interface MonitorTaskModelMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.MonitorTaskModel toThrift(MonitorTaskModel domain);

    /**
     * Convert thrift model to domain model.
     */
    MonitorTaskModel toDomain(org.apache.airavata.thriftapi.model.MonitorTaskModel thrift);
}
