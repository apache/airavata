...
import org.apache.airavata.common.model.SSHAccountProvisionerDescription;
...
public interface SSHAccountProvisionerDescriptionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.SSHAccountProvisionerDescription toThrift(
            SSHAccountProvisionerDescription domain);

    /**
     * Convert thrift model to domain model.
     */
    SSHAccountProvisionerDescription toDomain(
            org.apache.airavata.thriftapi.model.SSHAccountProvisionerDescription thrift);
}
