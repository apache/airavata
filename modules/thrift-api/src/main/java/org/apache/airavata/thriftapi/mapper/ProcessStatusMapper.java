...
public interface ProcessStatusMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.ProcessStatus toThrift(ProcessStatus domain);

    /**
     * Convert thrift model to domain model.
     */
    ProcessStatus toDomain(org.apache.airavata.thriftapi.model.ProcessStatus thrift);
}
