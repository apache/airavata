...
public interface LOCALSubmissionMapper extends ModelMapper {
     ...
     */
    org.apache.airavata.thriftapi.model.LOCALSubmission toThrift(LOCALSubmission domain);

    /**
     * Convert thrift model to domain model.
     */
    LOCALSubmission toDomain(org.apache.airavata.thriftapi.model.LOCALSubmission thrift);
}
