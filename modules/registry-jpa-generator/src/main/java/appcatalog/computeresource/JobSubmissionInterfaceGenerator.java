...
public class JobSubmissionInterfaceGenerator {
    private static final Logger logger = LoggerFactory.getLogger(JobSubmissionInterfaceGenerator.class);
    ...
    private static SQLData createSQLData() {
        ...
        data.getFieldData()
                .put("JOB_SUBMISSION_INTERFACE_ID", Arrays.asList(new String[] {"VARCHAR", "(255)", "NOT", "NULL"}));
        data.getFieldData()
                .put("JOB_SUBMISSION_PROTOCOL", Arrays.asList(new String[] {"VARCHAR", "(255)", "NOT", "NULL"}));
        ...
        data.getForiegnKeys()
                .put(
                        ...
                        new SQLData.ForiegnKeyData(
                                "COMPUTE_RESOURCE(RESOURCE_ID)", "ComputeResource", "ComputeHostResource"));
        return data;
    }
