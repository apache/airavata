...
public class DataMovementInterfaceGenerator {
    private static final Logger logger = LoggerFactory.getLogger(DataMovementInterfaceGenerator.class);
    ...
    private static SQLData createSQLData() {
        ...
        data.getFieldData()
                .put("DATA_MOVEMENT_PROTOCOL", Arrays.asList(new String[] {"VARCHAR", "(255)", "NOT", "NULL"}));
