...
public class EndDoWhileNode extends SystemNode {
     ...
     * @param graph
     */
    public EndDoWhileNode(Graph graph) {
        super(graph);
    }
     ...
     */
    public EndDoWhileNode(XmlElement nodeElement) throws GraphException {
        super(nodeElement);
    }
     ...
     */
    @Override
    public EndDoWhileComponent getComponent() {
    	EndDoWhileComponent component = (EndDoWhileComponent) super.getComponent();
        if (component == null) {
            // The component is null when read from the graph XML.
            component = new EndDoWhileComponent();
