...
public class NodeExecutionDataImpl implements NodeExecutionData{
     ...
     */
    public NodeExecutionDataImpl(WorkflowInstanceNode workflowInstanceNode) {
    ...
    public NodeExecutionDataImpl(String experimentId, String workflowExecutionId, String nodeId) {
