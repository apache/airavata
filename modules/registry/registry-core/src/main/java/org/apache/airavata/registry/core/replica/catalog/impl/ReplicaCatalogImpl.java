...
public class ReplicaCatalogImpl implements ReplicaCatalog {
    ...
    @Override
    public String publishResource(DataResourceModel resourceModel) throws ReplicaCatalogException {
    ...
    @Override
    public boolean updateResource(DataResourceModel resourceModel) throws ReplicaCatalogException {
        EntityManager em = null;
        try {
            em = DataCatalogJPAUtils.getEntityManager();
