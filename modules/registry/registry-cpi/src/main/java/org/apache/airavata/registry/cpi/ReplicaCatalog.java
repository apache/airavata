...
public interface ReplicaCatalog {
    ...
    String publishResource(DataResourceModel resource) throws ReplicaCatalogException;

    boolean removeResource(String resourceId) throws ReplicaCatalogException;

    boolean updateResource(DataResourceModel resource) throws ReplicaCatalogException;
