...
ALTER TABLE COMPUTE_RESOURCE_RESERVATION ADD CONSTRAINT FK_COMPUTE_RESOURCE_RESERVATION
...
(
        ...
        QUALITY_OF_SERVICE VARCHAR(255) DEFAULT NULL,
        RESERVATION VARCHAR(255) DEFAULT NULL,
        RESERVATION_START_TIME TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
        RESERVATION_END_TIME TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
        ...
        FOREIGN KEY (AGENT_EXECUTION_AGENT_EXECUTION_ID) REFERENCES AGENT_EXECUTION(AGENT_EXECUTION_ID) ON DELETE CASCADE
);
