...
CREATE TABLE EXPERIMENT (
        ...
        CLEANUP_STRATEGY VARCHAR(255) DEFAULT 'NONE',
...
(
        ...
        INPUT_ORDER INT,
        IS_REQUIRED tinyINT,
        REQUIRED_TO_ADDED_TO_CMD tinyINT,
        DATA_STAGED tinyINT,
...
CREATE TABLE EXPERIMENT_STATUS (
        ...
        EXPERIMENT_ID varchar(255) NOT NULL,
        STATE varchar(255),
        TIME_OF_STATE_CHANGE TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP (6),
        REASON LONGTEXT,
...
CREATE TABLE USER_CONFIGURATION_DATA (
        ...
        SHARE_EXPERIMENT_PUBLICALLY tinyINT,
        THROTTLE_RESOURCES tinyINT,
        USER_DN varchar(255),
