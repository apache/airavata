...
SERVICE_NAME="Parser Workflow Manager"
...
case $1 in
    start)
        ...
        if [ ! -f $PID_PATH_NAME ]; then
            ...
            org.apache.airavata.helix.impl.workflow.ParserWorkflowManager ${AIRAVATA_COMMAND} $* > $LOG_FILE 2>&1 &
            echo $! > $PID_PATH_NAME
    ...
    ;;
    -h)
        echo "Usage: parser-wm-daemon.sh"
