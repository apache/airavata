...
public class AppCatalogJPAUtils {
    ...
    public static EntityManager getEntityManager() throws ApplicationSettingsException {
        if (factory == null) {
            ...
            properties.put("openjpa.DataCache","" + readServerProperties(CACHE_ENABLED) + "(CacheSize=" + Integer.valueOf(readServerProperties(JPA_CACHE_SIZE)) + ", SoftReferenceSize=0)");
            properties.put("openjpa.QueryCache","" + readServerProperties(CACHE_ENABLED) + "(CacheSize=" + Integer.valueOf(readServerProperties(JPA_CACHE_SIZE)) + ", SoftReferenceSize=0)");
...
//                }
    ...
    private static Resource createComputeResource(ComputeResource o) {
        ...
        if (o != null) {
            ...
            computeResourceResource.setActive(o.getActive());
            if (o.getUpdateTime() != null){
