...
public class ProjectHandler {
    ...
    public boolean deleteProject(String projectId) {
        ...
        if (optionalProject.isEmpty() || StateEnum.DELETED.equals(optionalProject.get().getState())) {
        ...
        if (!project.getOwnerId().equalsIgnoreCase(userId)) {
            throw new RuntimeException(String.format("User %s is not authorized to delete project with id: %s", userId, projectId));
        }
