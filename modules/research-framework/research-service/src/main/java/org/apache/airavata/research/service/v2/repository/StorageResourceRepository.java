...
public interface StorageResourceRepository extends JpaRepository<StorageResource, String> {
    ...
    List<StorageResource> findByNameContainingIgnoreCaseAndPrivacyAndState(String name, PrivacyEnum privacy, StateEnum state);
    
    // Find by storage type
    List<StorageResource> findByStorageTypeAndPrivacyAndState(String storageType, PrivacyEnum privacy, StateEnum state);
    
    // Find all public and active resources with pagination
    Page<StorageResource> findByPrivacyAndState(PrivacyEnum privacy, StateEnum state, Pageable pageable);
    ...
    List<StorageResource> findAllByPrivacyAndState(PrivacyEnum privacy, StateEnum state);
}