...
public class AdminController {
    ...
    @Operation(summary = "Verify a resource")
    public ResponseEntity<Resource> rejectResource(@PathVariable(value = "id") String id, @RequestBody String rejectionMessage) {
        Resource resource = resourceHandler.getResourceById(id);
    ...
    public ResponseEntity<List<Resource>> getPendingResources() {
        return ResponseEntity.ok(resourceHandler.getAllResourcesWithStatus(
                List.of(StatusEnum.PENDING)
        ));
    }
