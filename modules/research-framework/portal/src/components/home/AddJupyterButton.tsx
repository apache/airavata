            ...
            <Dialog.RootProvider value={dialog} size="lg">
                ...
                <Portal>
                    ...
                    <Dialog.Positioner>
                        <Dialog.Content>
                            <Dialog.Body p="4">
                                <Dialog.Title>Add Jupyter Instance</Dialog.Title>
                                <Dialog.Description mt="2">
                                    Select configuration options for the new Jupyter instance.
                                </Dialog.Description>
