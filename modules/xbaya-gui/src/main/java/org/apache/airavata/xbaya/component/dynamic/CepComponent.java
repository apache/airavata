...
public class CepComponent extends Component {

    public static final String NAME = "CEP_Node";

    /**
     * The list of output component ports.
     */
    protected List<CepComponentPort> inputs;
    ...
    public CepComponent() {
        super();
        setName(NAME);
        this.inputs = new ArrayList<CepComponentPort>();
        this.inputs.add(new CepComponentPort(this));
        this.outputs = new ArrayList<CepComponentPort>();
        this.outputs.add(new CepComponentPort(this));
    }

    public CepComponent(String nameStr) {
        super();
        setName(nameStr);
        this.inputs = new ArrayList<CepComponentPort>();
        this.inputs.add(new CepComponentPort(this));
    ...
    public void addInputPort(CepComponentPort port) {
        this.inputs.add(port);
    }

    public void removeInputPort(CepComponentPort port) {
        this.inputs.remove(port);
    }

    public void addOutputPort(CepComponentPort port) {
        this.outputs.add(port);
    }

    public void removeOutputPort(CepComponentPort port) {
    ...
    // *
    // * @param implJarLocation The implJarLocation to set.
    // */
