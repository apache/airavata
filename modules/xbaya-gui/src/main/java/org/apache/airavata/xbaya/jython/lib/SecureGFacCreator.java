...
public class SecureGFacCreator {
    ...
    /**
     * 
     * Constructs a SecureGFacCreator.
     * 
     * @param wsdlURL
     * @param secureiInvoker
     * @throws URISyntaxException
     * @throws XBayaException
     */
    public SecureGFacCreator(String wsdlURL, PuretlsInvoker secureiInvoker) throws URISyntaxException, XBayaException {
        this(new URI(wsdlURL), secureiInvoker);
    }
     ...
     * @throws XBayaException
     */
    public SecureGFacCreator(URI wsdlURI, PuretlsInvoker secureiInvoker) throws XBayaException {
        try {
            ...
            WsdlDefinitions definitions = wsdlResolver.loadWsdl(wsdlURI);
