...
public class WSDLDialog extends JDialog {
		...
		while(true){
			...
			if (newWSDLUrl!=null) {
				...
				try {
					...
					getEngine().getErrorWindow().error("Error in the specified URL "+newWSDLUrl+" : "+e.getLocalizedMessage(), e);
				}
			}else{
				break;
			}
		...
		while(true){
			...
			if (c.showOpenDialog(this)==JFileChooser.APPROVE_OPTION) {
				...
				try {
					...
					getEngine().getErrorWindow().error("Error in the specified File "+previousFile.toString()+" : "+e.getLocalizedMessage(), e);
				}
			}else{
				break;
			}
	...
	private void setupWSDLFromURL(URL url) {
		try {
			...
			getEngine().getErrorWindow().error("Error occured while trying to retrieve data from URL "+url.toString()+" : "+e.getLocalizedMessage(), e);
		}
	}
