...
public class XBayaUtil {
    ...
    public static Object getInputsForForEachNode(final ForEachNode forEachNode, final LinkedList<String> listOfValues,
        ...
        if (forEachInputNode instanceof InputNode) {
            ...
            if (workflowInvoker != null) {
                if (workflowInvoker instanceof GenericInvoker) {
                    ...
                    String outputName = forEachInputNode.getOutputPort(0).getName();
                    returnValForProvenance = workflowInvoker.getOutput(outputName);
                    XmlElement msgElmt = XmlConstants.BUILDER.parseFragmentFromString("<temp>" + returnValForProvenance
                            + "</temp>");
    ...
    public static Object findInputFromPort(DataPort inputPort, Map<Node, Invoker> invokerMap) throws XBayaException {
        ...
        if (fromNode instanceof InputNode) {
            ...
            XmlElement msgElmt = XmlConstants.BUILDER.parseFragmentFromString("<temp>"
