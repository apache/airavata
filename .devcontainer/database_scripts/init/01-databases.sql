...
--
-- Host: localhost    Database: airavata
-- ------------------------------------------------------
...
--
-- Current Database: `airavata`
--

CREATE DATABASE IF NOT EXISTS `airavata` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE `APPLICATION_DEPLOYMENT` (
  ...
  `EDITABLE_BY_USER` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `APPLICATION_INPUT` (
  ...
  `STANDARD_INPUT` BOOLEAN DEFAULT NULL,
  `USER_FRIENDLY_DESC` varchar(255) DEFAULT NULL,
  `INPUT_ORDER` int(11) DEFAULT NULL,
  `IS_REQUIRED` BOOLEAN DEFAULT NULL,
  `REQUIRED_TO_COMMANDLINE` BOOLEAN DEFAULT NULL,
  `DATA_STAGED` BOOLEAN DEFAULT NULL,
  `IS_READ_ONLY` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `APPLICATION_INTERFACE` (
  ...
  `GATEWAY_ID` varchar(255) NOT NULL,
  `ARCHIVE_WORKING_DIRECTORY` BOOLEAN DEFAULT NULL,
  `HAS_OPTIONAL_FILE_INPUTS` BOOLEAN DEFAULT NULL,
  `CREATION_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `UPDATE_TIME` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `APPLICATION_OUTPUT` (
  ...
  `IS_REQUIRED` BOOLEAN DEFAULT NULL,
  `REQUIRED_TO_COMMANDLINE` BOOLEAN DEFAULT NULL,
  `DATA_MOVEMENT` BOOLEAN DEFAULT NULL,
  `DATA_NAME_LOCATION` varchar(255) DEFAULT NULL,
  `SEARCH_QUERY` varchar(255) DEFAULT NULL,
  `APP_ARGUMENT` varchar(255) DEFAULT NULL,
  `OUTPUT_STREAMING` BOOLEAN DEFAULT NULL,
  `METADATA` varchar(4096) DEFAULT NULL,
...
CREATE TABLE `BATCH_QUEUE` (
  ...
  `IS_DEFAULT_QUEUE` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `COMPUTE_RESOURCE` (
  ...
  `GATEWAY_USAGE_REPORTING` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `COMPUTE_RESOURCE_PREFERENCE` (
  `GATEWAY_ID` varchar(255) NOT NULL,
  `RESOURCE_ID` varchar(255) NOT NULL,
  `OVERRIDE_BY_AIRAVATA` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `PARSER_INPUT` (
  ...
  `PARSER_INPUT_REQUIRED` BOOLEAN NOT NULL,
  `PARSER_ID` varchar(255) NOT NULL,
...
CREATE TABLE `PARSER_OUTPUT` (
  ...
  `PARSER_OUTPUT_REQUIRED` BOOLEAN NOT NULL,
  `PARSER_ID` varchar(255) NOT NULL,
...
CREATE TABLE `EXPERIMENT` (
  ...
  `ENABLE_EMAIL_NOTIFICATION` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `EXPERIMENT_ERROR` (
  ...
  `TRANSIENT_OR_PERSISTENT` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `EXPERIMENT_INPUT` (
  ...
  `INPUT_ORDER` int(11) DEFAULT NULL,
  `IS_REQUIRED` BOOLEAN DEFAULT NULL,
  `REQUIRED_TO_ADDED_TO_CMD` BOOLEAN DEFAULT NULL,
  `DATA_STAGED` BOOLEAN DEFAULT NULL,
...
CREATE TABLE `USER_CONFIGURATION_DATA` (
  `EXPERIMENT_ID` varchar(255) NOT NULL,
  `AIRAVATA_AUTO_SCHEDULE` BOOLEAN DEFAULT NULL,
  `OVERRIDE_MANUAL_SCHEDULED_PARAMS` BOOLEAN DEFAULT NULL,
  `SHARE_EXPERIMENT_PUBLICALLY` BOOLEAN DEFAULT NULL,
  `THROTTLE_RESOURCES` BOOLEAN DEFAULT NULL,
  `USER_DN` varchar(255) DEFAULT NULL,
  `GENERATE_CERT` BOOLEAN DEFAULT NULL,
  `RESOURCE_HOST_ID` varchar(255) DEFAULT NULL,
  `TOTAL_CPU_COUNT` int(11) DEFAULT NULL,
  ...
  `EXPERIMENT_DATA_DIR` varchar(512) DEFAULT NULL,
  `GROUP_RESOURCE_PROFILE_ID` varchar(255) DEFAULT NULL,
  `IS_USE_USER_CR_PREF` BOOLEAN DEFAULT NULL,
  PRIMARY KEY (`EXPERIMENT_ID`),
...
('registry.version','0.16'),
('user_profile_catalog_version','0.17'),
('data_catalog_version','0.16'),
('sharing_reg_version','0.17');
