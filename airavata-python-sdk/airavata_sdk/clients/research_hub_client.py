...
from airavata_sdk.transport.utils import create_research_hub_service_stub
...
class ResearchHubClient:
    """Client for the Research Hub Service (gRPC).

    Provides methods for starting and resuming project sessions.
    """
    ...
    def start_project_session(self, project_id: str, session_name: str = ""):
        ...
        return self._stub.StartProjectSession(
    ...
    def resume_session(self, session_id: str):
        from airavata_sdk.generated.services import research_service_pb2 as pb2
        return self._stub.ResumeSession(
