...
class AccessFlags(_message.Message):
    __slots__ = ("is_owner", "user_has_write_access")
    IS_OWNER_FIELD_NUMBER: _ClassVar[int]
    USER_HAS_WRITE_ACCESS_FIELD_NUMBER: _ClassVar[int]
    is_owner: bool
    user_has_write_access: bool
    def __init__(self, is_owner: bool = ..., user_has_write_access: bool = ...) -> None: ...
