...
class StoredCredential(_message.Message):
    __slots__ = ("ssh_credential", "password_credential", "certificate_credential")
    SSH_CREDENTIAL_FIELD_NUMBER: _ClassVar[int]
    PASSWORD_CREDENTIAL_FIELD_NUMBER: _ClassVar[int]
    CERTIFICATE_CREDENTIAL_FIELD_NUMBER: _ClassVar[int]
    ssh_credential: SSHCredential
    password_credential: PasswordCredential
    certificate_credential: CertificateCredential
    def __init__(self, ssh_credential: _Optional[_Union[SSHCredential, _Mapping]] = ..., password_credential: _Optional[_Union[PasswordCredential, _Mapping]] = ..., certificate_credential: _Optional[_Union[CertificateCredential, _Mapping]] = ...) -> None: ...
