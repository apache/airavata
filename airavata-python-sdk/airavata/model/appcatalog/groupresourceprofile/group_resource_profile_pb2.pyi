...
class GroupComputeResourcePreference(_message.Message):
    __slots__ = ("compute_resource_id", "group_resource_profile_id", "override_by_airavata", "login_user_name", "scratch_location", "resource_specific_credential_store_token", "resource_type", "specific_preferences")
