...
class ComputeResourcePreference(_message.Message):
    __slots__ = ("compute_resource_id", "override_by_airavata", "login_user_name", "preferred_batch_queue", "scratch_location", "allocation_project_number", "resource_specific_credential_store_token", "usage_reporting_gateway_id", "quality_of_service", "reservation", "reservation_start_time", "reservation_end_time", "ssh_account_provisioner", "ssh_account_provisioner_config", "ssh_account_provisioner_additional_info")
