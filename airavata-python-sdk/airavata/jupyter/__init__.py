...
from airavata.experiments.plan import Plan
...
def submit_agent_job(
    ...
    if plan_file is not None:
        ...
        with open(Path(plan_file), "r") as f:
            from airavata.experiments.base import Plan
...
ipython = get_ipython()
if ipython is None:
    raise RuntimeError("airavata.jupyter requires an ipython session")
assert ipython is not None
...
print(rf"""
Loaded airavata.jupyter ({version}) 
