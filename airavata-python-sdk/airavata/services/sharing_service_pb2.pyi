...
from airavata.model.sharing import sharing_pb2 as _sharing_pb2
from airavata.model.user import user_profile_pb2 as _user_profile_pb2
from airavata.services import group_manager_service_pb2 as _group_manager_service_pb2
...
class UserPermission(_message.Message):
    __slots__ = ("user", "permission_type")
    USER_FIELD_NUMBER: _ClassVar[int]
    PERMISSION_TYPE_FIELD_NUMBER: _ClassVar[int]
    user: _user_profile_pb2.UserProfile
    permission_type: str
    def __init__(self, user: _Optional[_Union[_user_profile_pb2.UserProfile, _Mapping]] = ..., permission_type: _Optional[str] = ...) -> None: ...

class GroupPermission(_message.Message):
    __slots__ = ("group", "permission_type")
    GROUP_FIELD_NUMBER: _ClassVar[int]
    PERMISSION_TYPE_FIELD_NUMBER: _ClassVar[int]
    group: _group_manager_service_pb2.GroupWithAccess
    permission_type: str
    def __init__(self, group: _Optional[_Union[_group_manager_service_pb2.GroupWithAccess, _Mapping]] = ..., permission_type: _Optional[str] = ...) -> None: ...

class SharedEntity(_message.Message):
    __slots__ = ("entity_id", "owner", "user_permissions", "group_permissions", "is_owner", "has_sharing_permission")
    ENTITY_ID_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    USER_PERMISSIONS_FIELD_NUMBER: _ClassVar[int]
    GROUP_PERMISSIONS_FIELD_NUMBER: _ClassVar[int]
    IS_OWNER_FIELD_NUMBER: _ClassVar[int]
    HAS_SHARING_PERMISSION_FIELD_NUMBER: _ClassVar[int]
    entity_id: str
    owner: _user_profile_pb2.UserProfile
    user_permissions: _containers.RepeatedCompositeFieldContainer[UserPermission]
    group_permissions: _containers.RepeatedCompositeFieldContainer[GroupPermission]
    is_owner: bool
    has_sharing_permission: bool
    def __init__(self, entity_id: _Optional[str] = ..., owner: _Optional[_Union[_user_profile_pb2.UserProfile, _Mapping]] = ..., user_permissions: _Optional[_Iterable[_Union[UserPermission, _Mapping]]] = ..., group_permissions: _Optional[_Iterable[_Union[GroupPermission, _Mapping]]] = ..., is_owner: bool = ..., has_sharing_permission: bool = ...) -> None: ...

class GetSharedEntityRequest(_message.Message):
    __slots__ = ("entity_id",)
    ENTITY_ID_FIELD_NUMBER: _ClassVar[int]
    entity_id: str
    def __init__(self, entity_id: _Optional[str] = ...) -> None: ...

class SetEntitySharingRequest(_message.Message):
    __slots__ = ("resource_id", "user_permissions", "group_permissions")
    class UserPermissionsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    user_permissions: _containers.ScalarMap[str, str]
    group_permissions: _containers.ScalarMap[str, str]
    def __init__(self, resource_id: _Optional[str] = ..., user_permissions: _Optional[_Mapping[str, str]] = ..., group_permissions: _Optional[_Mapping[str, str]] = ...) -> None: ...
