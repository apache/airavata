...
from airavata.model.credential.store import credential_store_pb2 as _credential_store_pb2
...
class CredentialSummaryWithAccess(_message.Message):
    __slots__ = ("credential_summary", "access")
    CREDENTIAL_SUMMARY_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    credential_summary: _credential_store_pb2.CredentialSummary
    access: _commons_pb2.AccessFlags
    def __init__(self, credential_summary: _Optional[_Union[_credential_store_pb2.CredentialSummary, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...
