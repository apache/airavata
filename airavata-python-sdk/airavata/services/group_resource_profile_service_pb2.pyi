...
from airavata.model.appcatalog.groupresourceprofile import group_resource_profile_pb2 as _group_resource_profile_pb2
from airavata.model.appcatalog.gatewaygroups import gateway_groups_pb2 as _gateway_groups_pb2
...
class GroupResourceProfileWithAccess(_message.Message):
    __slots__ = ("group_resource_profile", "access")
    GROUP_RESOURCE_PROFILE_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    group_resource_profile: _group_resource_profile_pb2.GroupResourceProfile
    access: _commons_pb2.AccessFlags
    def __init__(self, group_resource_profile: _Optional[_Union[_group_resource_profile_pb2.GroupResourceProfile, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...
...
class GetGroupResourceListWithAccessResponse(_message.Message):
    __slots__ = ("profiles",)
    PROFILES_FIELD_NUMBER: _ClassVar[int]
    profiles: _containers.RepeatedCompositeFieldContainer[GroupResourceProfileWithAccess]
    def __init__(self, profiles: _Optional[_Iterable[_Union[GroupResourceProfileWithAccess, _Mapping]]] = ...) -> None: ...
