...
from airavata.services import user_profile_service_pb2 as services_dot_user__profile__service__pb2
...
class UserProfileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserPreferences = channel.unary_unary(
                '/org.apache.airavata.api.iam.userprofile.UserProfileService/GetUserPreferences',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=services_dot_user__profile__service__pb2.UserPreferences.FromString,
                _registered_method=True)
        self.UpdateUserPreferences = channel.unary_unary(
                '/org.apache.airavata.api.iam.userprofile.UserProfileService/UpdateUserPreferences',
                request_serializer=services_dot_user__profile__service__pb2.UserPreferences.SerializeToString,
                response_deserializer=services_dot_user__profile__service__pb2.UserPreferences.FromString,
                _registered_method=True)
...
class UserProfileServiceServicer(object):
    ...
    def GetUserPreferences(self, request, context):
        """Per-user workspace preferences, scoped to the authenticated caller
        (gateway + user from the request context, not the request body).
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserProfileServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserPreferences': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=services_dot_user__profile__service__pb2.UserPreferences.SerializeToString,
            ),
            'UpdateUserPreferences': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateUserPreferences,
                    request_deserializer=services_dot_user__profile__service__pb2.UserPreferences.FromString,
                    response_serializer=services_dot_user__profile__service__pb2.UserPreferences.SerializeToString,
            ),
    }
...
class UserProfileService(object):
    ...
    def GetUserPreferences(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            services_dot_user__profile__service__pb2.UserPreferences.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateUserPreferences(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/org.apache.airavata.api.iam.userprofile.UserProfileService/UpdateUserPreferences',
            services_dot_user__profile__service__pb2.UserPreferences.SerializeToString,
            services_dot_user__profile__service__pb2.UserPreferences.FromString,
            options,
            channel_credentials,
            insecure,
