...
class NotificationWithAccess(_message.Message):
    __slots__ = ("notification", "access")
    NOTIFICATION_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    notification: _workspace_pb2.Notification
    access: _commons_pb2.AccessFlags
    def __init__(self, notification: _Optional[_Union[_workspace_pb2.Notification, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...

class GetAllNotificationsWithAccessResponse(_message.Message):
    __slots__ = ("notifications",)
    NOTIFICATIONS_FIELD_NUMBER: _ClassVar[int]
    notifications: _containers.RepeatedCompositeFieldContainer[NotificationWithAccess]
    def __init__(self, notifications: _Optional[_Iterable[_Union[NotificationWithAccess, _Mapping]]] = ...) -> None: ...
