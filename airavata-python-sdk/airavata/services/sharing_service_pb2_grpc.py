...
from airavata.services import sharing_service_pb2 as services_dot_sharing__service__pb2
...
class SharingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UserHasAccess = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetSharedEntity = channel.unary_unary(
                '/org.apache.airavata.api.iam.sharing.SharingService/GetSharedEntity',
                request_serializer=services_dot_sharing__service__pb2.GetSharedEntityRequest.SerializeToString,
                response_deserializer=services_dot_sharing__service__pb2.SharedEntity.FromString,
                _registered_method=True)
        self.GetAllSharedEntity = channel.unary_unary(
                '/org.apache.airavata.api.iam.sharing.SharingService/GetAllSharedEntity',
                request_serializer=services_dot_sharing__service__pb2.GetSharedEntityRequest.SerializeToString,
                response_deserializer=services_dot_sharing__service__pb2.SharedEntity.FromString,
                _registered_method=True)
        self.SetEntitySharing = channel.unary_unary(
                '/org.apache.airavata.api.iam.sharing.SharingService/SetEntitySharing',
                request_serializer=services_dot_sharing__service__pb2.SetEntitySharingRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
...
class SharingServiceServicer(object):
    ...
    def GetSharedEntity(self, request, context):
        """Additive: the composed sharing view of an entity (owner + per-user UserProfile and per-group
        GroupWithAccess permissions, with is_owner / has_sharing_permission), assembled server-side so
        a client does not fan out per-permission accessor RPCs + profile/group lookups. DIRECT-only:
        only directly granted permissions (the ones the portal UI can edit).
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def GetAllSharedEntity(self, request, context):
        """Additive: the accessible-including-inherited analogue of GetSharedEntity (direct + inherited
        sharing settings).
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
    ...
    def SetEntitySharing(self, request, context):
        """Additive: declaratively set an entity's direct sharing. The client sends the DESIRED end-state
        (which users/groups should hold which permission); the server reads the current DIRECT grants,
        computes the grant/revoke diff (READ implies READ; WRITE implies READ+WRITE; MANAGE_SHARING
        implies READ+WRITE+MANAGE_SHARING), and applies it. Replaces the Python SDK's client-side diff
        (sharing_resources.apply_sharing_update). Map values are permission member NAME strings
        (READ / WRITE / MANAGE_SHARING); OWNER is not settable here.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SharingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSharedEntity': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSharedEntity,
                    request_deserializer=services_dot_sharing__service__pb2.GetSharedEntityRequest.FromString,
                    response_serializer=services_dot_sharing__service__pb2.SharedEntity.SerializeToString,
            ),
            'GetAllSharedEntity': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAllSharedEntity,
                    request_deserializer=services_dot_sharing__service__pb2.GetSharedEntityRequest.FromString,
                    response_serializer=services_dot_sharing__service__pb2.SharedEntity.SerializeToString,
            ),
            'SetEntitySharing': grpc.unary_unary_rpc_method_handler(
                    servicer.SetEntitySharing,
                    request_deserializer=services_dot_sharing__service__pb2.SetEntitySharingRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class SharingService(object):
    ...
    def GetSharedEntity(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/org.apache.airavata.api.iam.sharing.SharingService/GetSharedEntity',
            services_dot_sharing__service__pb2.GetSharedEntityRequest.SerializeToString,
            services_dot_sharing__service__pb2.SharedEntity.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def GetAllSharedEntity(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    def SetEntitySharing(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/org.apache.airavata.api.iam.sharing.SharingService/SetEntitySharing',
            services_dot_sharing__service__pb2.SetEntitySharingRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
