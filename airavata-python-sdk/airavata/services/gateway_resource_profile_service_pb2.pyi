...
from airavata.model.appcatalog.gatewayprofile import gateway_profile_pb2 as _gateway_profile_pb2
from airavata.model.appcatalog.accountprovisioning import account_provisioning_pb2 as _account_provisioning_pb2
...
class GatewayResourceProfileWithAccess(_message.Message):
    __slots__ = ("gateway_resource_profile", "access")
    GATEWAY_RESOURCE_PROFILE_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    gateway_resource_profile: _gateway_profile_pb2.GatewayResourceProfile
    access: _commons_pb2.AccessFlags
    def __init__(self, gateway_resource_profile: _Optional[_Union[_gateway_profile_pb2.GatewayResourceProfile, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...
