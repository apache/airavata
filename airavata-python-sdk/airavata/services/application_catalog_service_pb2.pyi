...
class ApplicationModuleWithAccess(_message.Message):
    __slots__ = ("application_module", "access")
    APPLICATION_MODULE_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    application_module: _app_deployment_pb2.ApplicationModule
    access: _commons_pb2.AccessFlags
    def __init__(self, application_module: _Optional[_Union[_app_deployment_pb2.ApplicationModule, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...

class GetAllApplicationModulesWithAccessResponse(_message.Message):
    __slots__ = ("modules",)
    MODULES_FIELD_NUMBER: _ClassVar[int]
    modules: _containers.RepeatedCompositeFieldContainer[ApplicationModuleWithAccess]
    def __init__(self, modules: _Optional[_Iterable[_Union[ApplicationModuleWithAccess, _Mapping]]] = ...) -> None: ...

class GetAccessibleApplicationModulesWithAccessResponse(_message.Message):
    __slots__ = ("modules",)
    MODULES_FIELD_NUMBER: _ClassVar[int]
    modules: _containers.RepeatedCompositeFieldContainer[ApplicationModuleWithAccess]
    def __init__(self, modules: _Optional[_Iterable[_Union[ApplicationModuleWithAccess, _Mapping]]] = ...) -> None: ...
...
class ApplicationDeploymentWithAccess(_message.Message):
    __slots__ = ("application_deployment", "access")
    APPLICATION_DEPLOYMENT_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    application_deployment: _app_deployment_pb2.ApplicationDeploymentDescription
    access: _commons_pb2.AccessFlags
    def __init__(self, application_deployment: _Optional[_Union[_app_deployment_pb2.ApplicationDeploymentDescription, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...

class GetApplicationDeploymentQueuesResponse(_message.Message):
    __slots__ = ("queues",)
    QUEUES_FIELD_NUMBER: _ClassVar[int]
    queues: _containers.RepeatedCompositeFieldContainer[_compute_resource_pb2.BatchQueue]
    def __init__(self, queues: _Optional[_Iterable[_Union[_compute_resource_pb2.BatchQueue, _Mapping]]] = ...) -> None: ...
...
class GetAllApplicationDeploymentsWithAccessResponse(_message.Message):
    __slots__ = ("deployments",)
    DEPLOYMENTS_FIELD_NUMBER: _ClassVar[int]
    deployments: _containers.RepeatedCompositeFieldContainer[ApplicationDeploymentWithAccess]
    def __init__(self, deployments: _Optional[_Iterable[_Union[ApplicationDeploymentWithAccess, _Mapping]]] = ...) -> None: ...
...
class GetAccessibleApplicationDeploymentsWithAccessResponse(_message.Message):
    __slots__ = ("deployments",)
    DEPLOYMENTS_FIELD_NUMBER: _ClassVar[int]
    deployments: _containers.RepeatedCompositeFieldContainer[ApplicationDeploymentWithAccess]
    def __init__(self, deployments: _Optional[_Iterable[_Union[ApplicationDeploymentWithAccess, _Mapping]]] = ...) -> None: ...
...
class ApplicationInterfaceWithAccess(_message.Message):
    __slots__ = ("application_interface", "access")
    APPLICATION_INTERFACE_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    application_interface: _app_interface_pb2.ApplicationInterfaceDescription
    access: _commons_pb2.AccessFlags
    def __init__(self, application_interface: _Optional[_Union[_app_interface_pb2.ApplicationInterfaceDescription, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...

class GetAllApplicationInterfacesWithAccessResponse(_message.Message):
    __slots__ = ("interfaces",)
    INTERFACES_FIELD_NUMBER: _ClassVar[int]
    interfaces: _containers.RepeatedCompositeFieldContainer[ApplicationInterfaceWithAccess]
    def __init__(self, interfaces: _Optional[_Iterable[_Union[ApplicationInterfaceWithAccess, _Mapping]]] = ...) -> None: ...
