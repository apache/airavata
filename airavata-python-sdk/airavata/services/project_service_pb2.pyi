...
class ProjectWithAccess(_message.Message):
    __slots__ = ("project", "access")
    PROJECT_FIELD_NUMBER: _ClassVar[int]
    ACCESS_FIELD_NUMBER: _ClassVar[int]
    project: _workspace_pb2.Project
    access: _commons_pb2.AccessFlags
    def __init__(self, project: _Optional[_Union[_workspace_pb2.Project, _Mapping]] = ..., access: _Optional[_Union[_commons_pb2.AccessFlags, _Mapping]] = ...) -> None: ...
...
class GetUserProjectsWithAccessResponse(_message.Message):
    __slots__ = ("projects",)
    PROJECTS_FIELD_NUMBER: _ClassVar[int]
    projects: _containers.RepeatedCompositeFieldContainer[ProjectWithAccess]
    def __init__(self, projects: _Optional[_Iterable[_Union[ProjectWithAccess, _Mapping]]] = ...) -> None: ...
