<template>
  <div class="new_app">
    <div class="new_app_header">
      ...
      <button v-on="this.$emit('new_application')">New Application <span>+</span></button>
    </div>
...
<script>
  ...
  const routes=[
    {path:'/vue/admin/main',component:ExperimentsDashboard},
    {path:'/vue/admin/application',component:NewApplication}
  ]
  export default {
    data:function () {
      return {
