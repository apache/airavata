    ...
    <div class="row">
      <div class="col">
        ...
        <b-form-group label="Application Name" label-for="application-name">
          <b-form-input id="application-name" type="text" v-model="appModule.appModuleName" required @input="emitChanged"></b-form-input>
        </b-form-group>
        <b-form-group label="Application Version" label-for="application-version">
          <b-form-input id="application-version" type="text" v-model="appModule.appModuleVersion" @input="emitChanged"></b-form-input>
        </b-form-group>
        <b-form-group label="Application Description" label-for="application-description">
          <b-form-textarea id="application-description" v-model="appModule.appModuleDescription" :rows="3" @input="emitChanged"></b-form-textarea>
        </b-form-group>
      </div>
    </div>
    <div class="row">
