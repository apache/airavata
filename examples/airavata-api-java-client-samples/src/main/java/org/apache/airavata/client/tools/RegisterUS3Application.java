...
public class RegisterUS3Application {
    ...
    public static void registerXSEDEHosts() {
        try {
            ...
            // Register Lonestar
            lonestarResourceId = registerComputeHost(
                    ...
                    SecurityProtocol.GSI,
                    22,
                    "/sge_common/default/pe_scripts/ibrun");
    ...
    public static void updateXSEDEHosts() {
        try {
            ...
            // Register Lonestar
            lonestarResourceId = updateComputeHost(
                    lonestarResourceId,
                    "lonestar.tacc.teragrid.org",
                    "TACC Lonestar Cluster",
                    ResourceJobManagerType.UGE,
            ...
            // Register Alamo
            alamoResourceId = updateComputeHost(
                    alamoResourceId,
                    "alamo.uthscsa.edu",
                    "Alamo Cluster",
                    ResourceJobManagerType.PBS,
    ...
    public static void registerUltrascanInterface() {
        try {
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "input", null, DataType.URI, null, 1, true, true, false, "input tar file", null);

            List<InputDataObjectType> applicationInputs = new ArrayList<InputDataObjectType>();
            applicationInputs.add(input1);

            OutputDataObjectType output1 =
                    RegisterSampleApplicationsUtils.createAppOutput("output", "", DataType.URI, true, false, null);
        ...
        try {
            ...
            String ultascanStamplede = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ultrascanModuleId,
                            stampedeResourceId,
                            "/home1/01623/us3/bin/us_mpi_analysis",
            ...
            String ultascanTrestles = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ultrascanModuleId,
                            trestlesResourceId,
                            "/home/us3/trestles/bin/us_mpi_analysis",
                            ApplicationParallelismType.MPI,
                            "ultrascan application",
                            null,
                            null,
            ...
            String ultascanLonestar = airavataClient.registerApplicationDeployment(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ultrascanModuleId,
            ...
            String ultascanAlamo = airavataClient.registerApplicationDeployment(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ultrascanModuleId,
                            alamoResourceId,
                            "/home/us3/bin/us_mpi_analysis.sh",
                            ApplicationParallelismType.MPI,
                            "ultrascan application",
                            null,
                            null,
        ...
        try {
            ...
            ComputeResourcePreference stampedeResourcePreferences =
                    RegisterSampleApplicationsUtils.createComputeResourcePreference(
                            stampedeResourceId, "TG-MCB070039N", false, null, null, null, "/scratch/01623/us3/jobs/");
            ...
            ComputeResourcePreference lonestarResourcePreferences =
                    RegisterSampleApplicationsUtils.createComputeResourcePreference(
                            lonestarResourceId, "ULTRASCAN", false, null, null, null, "/scratch/01623/us3/airavata/");

            ComputeResourcePreference alamoResourcePreferences =
                    RegisterSampleApplicationsUtils.createComputeResourcePreference(
                            alamoResourceId, null, false, null, null, null, "/mnt/glusterfs/work/");
    ...
    public static String registerComputeHost(
            String hostName,
            String hostDesc,
    ...
    public static String updateComputeHost(
            String computeResourceId,
            String hostName,
            String hostDesc,
            ResourceJobManagerType resourceJobManagerType,
        ...
        airavataClient.addSSHJobSubmissionDetails(new AuthzToken(""), computeResourceId, 1, sshJobSubmission);
        ComputeResourceDescription computeResourceDescription =
                airavataClient.getComputeResource(new AuthzToken(""), computeResourceId);
