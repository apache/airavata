...
public class SecureClient {
    ...
    public static Airavata.Client createAiravataClient(String serverHost, int serverPort)
        ...
        Airavata.Client client = AiravataClientFactory.createAiravataSecureClient(
                serverHost, serverPort, Properties.TRUST_STORE_PATH, Properties.TRUST_STORE_PASSWORD, 10000);
        return client;
    }
}
