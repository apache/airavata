...
public class RegisterSampleApplications {
    ...
    private static final String espressoDescription =
    ...
    public void registerXSEDEHosts() {
        try {
            ...
            bigredResourceId = registerComputeHost(
                    "bigred2.uits.iu.edu",
                    ...
                    "aprun -n",
                    br2Queues);
            logger.info("BigredII Resource Id is {}", bigredResourceId);

            fsdResourceId = registerUnicoreEndpoint(
                    "fsd-cloud15.zam.kfa-juelich.de",
                    "interop host",
                    JobSubmissionProtocol.UNICORE,
                    SecurityProtocol.GSI);
            logger.info("FSd Resource Id: {}", fsdResourceId);
    ...
    public void registerNonXSEDEHosts() {
        try {
            ...
            lsfResourceId = registerComputeHost(
                    ...
                    "push",
                    "source /etc/bashrc;/lsf/9.1/linux2.6-glibc2.3-x86_64/bin",
                    SecurityProtocol.SSH_KEYS,
                    22,
                    "mpiexec",
                    lsfQueues);
            logger.info("LSF Resource Id is {}", lsfResourceId);
    ...
    public void registerAppModules() {
        try {
            ...
            echoModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(echoName, "1.0", echoDescription));
            logger.info("Echo Module Id {}", echoModuleId);

            mpiModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(mpiName, "1.0", mpiDescription));
            logger.info("MPI Module Id {}", mpiModuleId);

            // Register Amber
            amberModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(amberName, "12.0", amberDescription));
            logger.info("Amber Module Id {}", amberModuleId);

            // Register AutoDock
            autoDockModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(autoDockName, "4.2", autoDockDescription));
            logger.info("AutoDock Module Id {}", autoDockModuleId);
            ...
            logger.info("ESPRESSO Module Id {}", espressoModuleId);

            // Register GROMACS
            gromacsModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(gromacsName, "4.6.5", gromacsDescription));
            logger.info("GROMACS Module Id {}", gromacsModuleId);

            // Register LAMMPS
            lammpsModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(lammpsName, "20Mar14", lammpsDescription));

            lammpsModuleId1 = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(
                            lammpsName, "28Jun14-base", lammpsDescription));

            logger.info("LAMMPS Module Id {}", lammpsModuleId);

            logger.info("LAMMPS Module Id for LSF {}", lammpsModuleId1);

            // Register NWChem
            nwChemModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(nwChemName, "6.3", nwChemDescription));
            logger.info("NWChem Module Id {}", nwChemModuleId);
            ...
            logger.info("Trinity Module Id {}", trinityModuleId);

            // Register WRF
            wrfModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(wrfName, "3.5.1", wrfDescription));
            logger.info("WRF Module Id {}", wrfModuleId);

            // Register PHASTA
            phastaModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(phastaName, "1.0", phastaDescription));
            logger.info("phasta Module Id {}", phastaModuleId);

            monteXModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(monteXName, "1.0", monteXDescription));
            logger.info("Tinker Monte Module Id {}", monteXModuleId);

            gaussianModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(gaussianName, "1.0", gaussianDescription));
            // Register GAMESS
            gamessModuleId = airavataClient.registerApplicationModule(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationModule(gamessName, "17May13", gamessDescription));
            logger.info("Gamess Module Id {}", gamessModuleId);
            // Register Ultrascan
    ...
    public void registerGamessInterface() {
        try {
            logger.info("#### Registering Gamess Interface #### \n");

            List<String> appModules = new ArrayList<String>();
            appModules.add(gamessModuleId);

            List<InputDataObjectType> applicationInputs = new ArrayList<InputDataObjectType>();
            applicationInputs.add(RegisterSampleApplicationsUtils.createAppInput(
                    "gams_input", "", DataType.URI, null, 1, true, false, false, "Gamess Input file", null));
            //            applicationInputs.add(RegisterSampleApplicationsUtils.createAppInput("EXT_FILE", "",
            //                    DataType.URI, null, 2, ValidityType.OPTIONAL, CommandLineType.EXCLUSIVE, false,
            // "Gamess EXT file", null));

            List<OutputDataObjectType> applicationOutputs = new ArrayList<OutputDataObjectType>();
            applicationOutputs.add(RegisterSampleApplicationsUtils.createAppOutput(
                    "gams_output", "", DataType.URI, true, false, null));
            applicationOutputs.add(
                    RegisterSampleApplicationsUtils.createAppOutput("dat_file", "", DataType.URI, true, true, null));
            applicationOutputs.add(
                    RegisterSampleApplicationsUtils.createAppOutput("trj_file", "", DataType.URI, false, true, null));
            applicationOutputs.add(
                    RegisterSampleApplicationsUtils.createAppOutput("rst_file", "", DataType.URI, false, true, null));
            applicationOutputs.add(
                    RegisterSampleApplicationsUtils.createAppOutput("f10_file", "", DataType.URI, false, true, null));
            applicationOutputs.add(
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", "", DataType.STDOUT, false, true, null));
            applicationOutputs.add(
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", "", DataType.STDERR, false, true, null));
            ...
            gamessInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            "gamess", "gamess", appModules, applicationInputs, applicationOutputs));

            logger.info("GAMESS Application Interface Id {}", gamessModuleId);
    ...
    public void registerLocalEchoInterface() {
        try {
            ...
            OutputDataObjectType output1 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", "", DataType.STDOUT, false, false, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", "", DataType.STDERR, false, false, null);
            ...
            echoLocalInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            echoName, echoDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("Local Echo Application Interface Id {}", echoLocalInterfaceId);
    ...
    public void registerEchoInterface() {
        try {
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "Input_to_Echo", "", DataType.STRING, null, 1, false, true, false, "A test string to Echo", null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Echoed_Output", "", DataType.STDOUT, true, false, null);

            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Echoed_Error", "", DataType.STDERR, true, false, null);
    ...
    public void registerMPIInterface() {
        try {
            logger.info("#### Registering MPI Interface #### \n");
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    false,
                    false,
                    "An optional MPI source file",
                    null);

            InputDataObjectType input11 = RegisterSampleApplicationsUtils.createAppInput(
                    "US3INPUT", "", DataType.URI, null, 1, true, false, false, "Input US3 file", null);

            InputDataObjectType input12 = RegisterSampleApplicationsUtils.createAppInput(
                    "US3INPUTARG", "", DataType.STRING, null, 1, true, false, false, "Input US3 Arg", null);

            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    "NumberOfProcesses",
                    "",
                    DataType.INTEGER,
                    null,
            ...
            InputDataObjectType input3 = RegisterSampleApplicationsUtils.createAppInput(
                    "ProcessesPerHost", "", DataType.INTEGER, null, 3, false, true, false, "Processes per host", null);
            ...
            OutputDataObjectType output1 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOutput", "", DataType.STDOUT, true, true, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDErr", "", DataType.STDERR, true, true, null);

            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("US3OUT", "", DataType.STRING, true, false, null);
            ...
            mpiInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            mpiName, mpiDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("MPI Application Interface Id {}", mpiInterfaceId);
    ...
    public void registerAmberInterface() {
        try {
            logger.info("#### Registering Amber Interface #### \n");
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "Heating up the system equilibration stage - 02_Heat.rst",
                    null);

            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    "Production_Control_File",
                    null,
                    DataType.URI,
                    "-i ",
                    2,
                    ...
                    true,
                    false,
                    "Constant pressure and temperature for production stage - 03_Prod.in",
                    null);

            InputDataObjectType input3 = RegisterSampleApplicationsUtils.createAppInput(
                    "Parameter_Topology_File",
                    null,
                    DataType.URI,
                    "-p",
                    3,
                    ...
                    true,
                    false,
                    "Parameter and Topology coordinates - prmtop",
                    null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "AMBER_Execution_Summary", "03_Prod.info", DataType.URI, true, true, "-inf");
            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "AMBER_Execution_log", "03_Prod.out", DataType.URI, true, true, "-o");
            OutputDataObjectType output3 = RegisterSampleApplicationsUtils.createAppOutput(
                    "AMBER_Trajectory_file", "03_Prod.mdcrd", DataType.URI, true, true, "-x");
            OutputDataObjectType output4 = RegisterSampleApplicationsUtils.createAppOutput(
                    "AMBER_Restart_file", "03_Prod.rst", DataType.URI, true, true, " -r");
            OutputDataObjectType output5 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, false, null);
            OutputDataObjectType output6 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, false, null);
            List<OutputDataObjectType> applicationOutputs = new ArrayList<OutputDataObjectType>();
            applicationOutputs.add(output1);
            applicationOutputs.add(output2);
            applicationOutputs.add(output3);
            ...
            amberInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            amberName, amberDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("Amber Application Interface Id {}", amberInterfaceId);
    ...
    public void registerAutoDockInterface() {
        try {
            logger.info("#### Registering AutoDock Interface #### \n");
            ...
            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "Constant pressure and temperature for production stage",
                    null);
            ...
            InputDataObjectType input3 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "Parameter and Topology coordinates",
                    null);
            ...
            OutputDataObjectType output1 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            autoDockInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            autoDockName, autoDockDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("AutoDock Application Interface Id {}", autoDockInterfaceId);
    ...
    public void registerEspressoInterface() {
        try {
            logger.info("#### Registering Espresso Interface #### \n");
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "AI_Metal_Input_File - Al.sample.in",
                    null);

            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    "AI_Pseudopotential_File",
                    null,
                    DataType.URI,
                    null,
                    2,
                    ...
                    true,
                    false,
                    "Constant pressure and temperature for production stage - Al.pz-vbc.UPF",
                    null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "ESPRESSO_Execution_Log", null, DataType.URI, true, true, null);
            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "ESPRESSO_WFC_Binary_file", null, DataType.URI, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            ...
            espressoInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            espressoName, espressoDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("Espresso Application Interface Id {}", espressoInterfaceId);
    ...
    public void registerGromacsInterface() {
        try {
            logger.info("#### Registering Gromacs Interface #### \n");

            List<String> appModules = new ArrayList<String>();
            appModules.add(gromacsModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "Portable_Input_Binary_File",
                    null,
                    DataType.URI,
                    null,
                    1,
                    ...
                    true,
                    false,
                    "Coordinates velocities, molecular topology and simulation parameters - pdb1y6l-EM-vacuum.tpr",
                    null);

            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    "GROMOS_Coordinate_File",
                    null,
                    DataType.URI,
                    null,
                    2,
                    ...
                    true,
                    false,
                    "Trajectory Coordinates Molecular Structure in Gromos87 format - pdb1y6l-EM-vacuum.gro",
                    null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "GROMACS_Execution_Log", null, DataType.URI, true, true, null);
            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Full_Precision_Trajectory_file", null, DataType.URI, true, true, null);
            OutputDataObjectType output3 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Portable_Energy_file", null, DataType.URI, true, true, null);
            OutputDataObjectType output4 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output5 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            gromacsInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            gromacsName, gromacsDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("Gromacs Application Interface Id {}", gromacsInterfaceId);
    ...
    public void registerLammpsInterface() {
        try {
            logger.info("#### Registering LAMMPS Interface #### \n");
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "Friction Simulation Input - in.friction",
                    null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "LAMMPS_Simulation_Log", null, DataType.URI, true, true, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            lammpsInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            lammpsName, lammpsDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("LAMMPS Application Interface Id {}", lammpsInterfaceId);
    ...
    public void registerNWChemInterface() {
        try {
            logger.info("#### Registering NWChem Interface #### \n");

            List<String> appModules = new ArrayList<String>();
            appModules.add(nwChemModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "Water_Molecule_Input",
                    null,
                    DataType.URI,
                    null,
                    1,
                    ...
                    true,
                    false,
                    "Water Molecule Input File - water.nw",
                    null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "NWChem_Execution_Log", null, DataType.URI, true, false, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            nwChemInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            nwChemName, nwChemDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("NWChem Application Interface Id {}", nwChemInterfaceId);
    ...
    public void registerTrinityInterface() {
        try {
            logger.info("#### Registering Trinity Interface #### \n");
            ...
            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "RNA-Seq Left Library - reads.left.fq",
                    null);
            ...
            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "RNA-Seq Right Library - reads.right.fq",
                    null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Trinity_Execution_Log", null, DataType.URI, true, true, null);
            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Trinity_FASTA_File", null, DataType.URI, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output4 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            trinityInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            trinityName, trinityDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("Trinity Application Interface Id {}", trinityInterfaceId);
    ...
    public void registerWRFInterface() {
        try {
            logger.info("#### Registering WRF Interface #### \n");

            List<String> appModules = new ArrayList<String>();
            appModules.add(wrfModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "Config_Namelist_File",
                    null,
                    DataType.URI,
                    null,
                    1,
                    ...
                    true,
                    false,
                    "Namelist Configuration File - namelist.input",
                    null);

            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    "WRF_Initial_Conditions",
                    null,
                    DataType.URI,
                    null,
                    2,
                    ...
                    true,
                    false,
                    "Initial Conditions File - wrfinput_d01",
                    null);
            ...
            InputDataObjectType input3 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "Boundary Conditions File - wrfbdy_d01",
                    null);
            ...
            OutputDataObjectType output1 =
                    RegisterSampleApplicationsUtils.createAppOutput("WRF_Output", "", DataType.URI, true, true, null);

            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "WRF_Execution_Log", "", DataType.URI, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output4 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            wrfInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            wrfName, wrfDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("WRF Application Interface Id {}", wrfInterfaceId);
    ...
    public void registerPhastaInterface() {
        try {
            logger.info("#### Registering PHASTA Interface #### \n");

            List<String> appModules = new ArrayList<String>();
            appModules.add(phastaModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "Parasolid_Geometric_Model",
                    null,
                    DataType.URI,
                    null,
                    1,
                    ...
                    true,
                    false,
                    "Parasolid geometric model - geom.xmt_txt",
                    null);
            ...
            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    ...
                    true,
                    false,
                    "problem definition - geom.smd",
                    null);

            InputDataObjectType input3 = RegisterSampleApplicationsUtils.createAppInput(
                    "Mesh_Description_File",
                    null,
                    DataType.URI,
                    null,
                    3,
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "PHASTA_Execution_Log", null, DataType.URI, true, true, null);
            OutputDataObjectType output2 = RegisterSampleApplicationsUtils.createAppOutput(
                    "PHASTA_Output_tar", null, DataType.URI, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output4 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            phastaInterfaceId = airavataClient.registerApplicationInterface(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            phastaName, phastaDescription, appModules, applicationInputs, applicationOutputs));
            logger.info("phasta Application Interface Id {}", phastaInterfaceId);
    ...
    public void registerLocalApps() {
        try {
            ...
            logger.info("Echo on localhost Id {}", echoAppDeployId);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void registerGaussianInterface() {
        try {
            logger.info("#### Registering Gaussian Application Interface ####");

            List<String> appModules = new ArrayList<String>();
            appModules.add(gaussianModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "MainInputFile", null, DataType.URI, null, 1, true, true, false, "Gaussian main input file", null);

            List<InputDataObjectType> applicationInputs = new ArrayList<InputDataObjectType>();
            applicationInputs.add(input1);

            OutputDataObjectType output1 =
                    RegisterSampleApplicationsUtils.createAppOutput("gaussian.out", "", DataType.URI, true, true, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            String addApplicationInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            "Gaussian", "Gaussian application", appModules, applicationInputs, applicationOutputs));
            logger.info("Gaussian Application Interface Id {}", addApplicationInterfaceId);
    ...
    private void registerTinkerMonteInterface() {
        try {
            logger.info("#### Registering Tinker Monte Application Interface ####");

            List<String> appModules = new ArrayList<String>();
            appModules.add(monteXModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "xyzf", "O16.xyz", DataType.URI, null, 1, true, true, false, "Tinker monte input_1", null);
            InputDataObjectType input2 = RegisterSampleApplicationsUtils.createAppInput(
                    "keyf", "O16.key", DataType.URI, "-k", 2, true, true, false, "Tinker monte input_2", null);
            InputDataObjectType input3 = RegisterSampleApplicationsUtils.createAppInput(
                    "stps", "20000", DataType.STRING, null, 3, true, true, false, "Tinker monte input_3", null);
            InputDataObjectType input4 = RegisterSampleApplicationsUtils.createAppInput(
                    "Ctc", "C", DataType.STRING, null, 4, true, true, false, "Tinker monte input_4", null);
            InputDataObjectType input5 = RegisterSampleApplicationsUtils.createAppInput(
                    "stpsZ", "3.0", DataType.STRING, null, 5, true, true, false, "Tinker monte input_5", null);
            InputDataObjectType input6 = RegisterSampleApplicationsUtils.createAppInput(
                    "temp", "298", DataType.STRING, null, 6, true, true, false, "Tinker monte input_6", null);
            InputDataObjectType input7 = RegisterSampleApplicationsUtils.createAppInput(
                    "Rconv", "0.01", DataType.STRING, null, 7, true, true, false, "Tinker monte input_7", null);
            ...
            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "Diskoutputfile_with_dir", "", DataType.URI, false, false, null);
            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", null, DataType.STDOUT, true, true, null);
            OutputDataObjectType output3 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDERR", null, DataType.STDERR, true, true, null);
            ...
            String addApplicationInterfaceId = airavataClient.registerApplicationInterface(
                    ...
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            "Tinker_Monte", "Monte application", appModules, applicationInputs, applicationOutputs));
            logger.info("Monte Application Interface Id {}", addApplicationInterfaceId);
        ...
        try {
            ...
            String echoAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Echo on stampede deployment Id {}", echoAppDeployId);
            ...
            ApplicationDeploymentDescription amberStampedeDeployment =
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            amberModuleId,
                            stampedeResourceId,
            ...
            String amberAppDeployId = airavataClient.registerApplicationDeployment(
                    new AuthzToken(""), DEFAULT_GATEWAY, amberStampedeDeployment);
            logger.info("Amber on stampede deployment Id {}", amberAppDeployId);
            ...
            String espressoAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("ESPRESSO on stampede deployment Id {}", espressoAppDeployId);
            ...
            String gromacsAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("GROMACS on stampede deployment Id {}", gromacsAppDeployId);
            ...
            String lammpsAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            preJobCommands,
                            null));
            logger.info("LAMMPS on stampede deployment Id {}", lammpsAppDeployId);
            ...
            String nwChemAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("NWChem on stampede deployment Id {}", nwChemAppDeployId);
            ...
            String trinityAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Trinity on stampede deployment Id {}", trinityAppDeployId);
            ...
            String wrfAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("WRF on stampede deployment Id {}", wrfAppDeployId);
            ...
            String monteXAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Tinker Monte on trestles deployment Id {}", monteXAppDeployId);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void registerTrestlesApps() {
        try {
            logger.info("#### Registering Application Deployments on Trestles #### \n");
            ...
            String echoAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Echo on trestles deployment Id {}", echoAppDeployId);
            ...
            String amberAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            amberModuleId,
                            trestlesResourceId,
                            "/opt/amber/bin/sander.MPI -O",
                            ApplicationParallelismType.MPI,
                            amberDescription,
                            moduleLoadCMDs,
                            null,
                            null));
            logger.info("Amber on trestles deployment Id {}", amberAppDeployId);
            ...
            String gromacsAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("GROMACS on trestles deployment Id {}", gromacsAppDeployId);
            ...
            String lammpsAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("LAMMPS on trestles deployment Id {}", lammpsAppDeployId);
            ...
            String gamessAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Gamess on trestles deployment Id {}", gamessAppDeployId);
            ...
            String gaussianAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Gaussian on trestles deployment Id {}", gaussianAppDeployId);
        ...
        try {
            ...
            String echoAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            echoModuleId,
                            lsfResourceId,
                            "/home/lg11w/executables/echo.sh",
                            ApplicationParallelismType.SERIAL,
                            echoDescription,
                            null,
                            null,
            ...
            String lammpsDeployId = airavataClient.registerApplicationDeployment(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            lammpsModuleId,
                            ...
                            null,
                            null));
            logger.info("Echo on LSF deployment Id {}", echoAppDeployId);
            logger.info("LAMMPS on LSF deployment Id {}", lammpsDeployId);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void registerBigRedApps() {
        try {
            logger.info("#### Registering Application Deployments on BigRed II #### \n");
            ...
            String echoAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Echo on bigredII deployment Id {}", echoAppDeployId);
            ...
            String amberAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            ApplicationParallelismType.MPI,
                            amberDescription,
                            amberModuleLoadCMDsBr2,
                            null,
                            null));

            logger.info("Amber on bigredII deployment Id {}", amberAppDeployId);
            ...
            String autoDockDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("AutoDock on bigredII deployment Id {}", autoDockDeployId);

            //            //Register GROMACS
            //            String gromacsAppDeployId = airavataClient.registerApplicationDeployment(
            //                    RegisterSampleApplicationsUtils.createApplicationDeployment(gromacsModuleId,
            // bigredResourceId,
            //                            "/N/u/cgateway/BigRed2/production/app_wrappers/gromacs_wrapper.sh",
            // ApplicationParallelismType.MPI,
            //                            gromacsDescription));
            //            logger.info("GROMACS on bigredII deployment Id {}", gromacsAppDeployId);
            //
            //            //Register LAMMPS
            //            String lammpsAppDeployId = airavataClient.registerApplicationDeployment(
            //                    RegisterSampleApplicationsUtils.createApplicationDeployment(lammpsModuleId,
            // bigredResourceId,
            //                            "/N/u/cgateway/BigRed2/production/app_wrappers/lammps_wrapper.sh",
            // ApplicationParallelismType.MPI,
            //                            lammpsDescription));
            //            logger.info("LAMMPS on bigredII deployment Id {}", lammpsAppDeployId);
    ...
    public void registerFSDApps() {
        try {
            logger.info("#### Registering Application Deployments on FSD #### \n");
            ...
            String echoAppDeployId = airavataClient.registerApplicationDeployment(
                    ...
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ...
                            null,
                            null));
            logger.info("Echo on FSD deployment Id: {}", echoAppDeployId);
            ...
            logger.info("MPI on FSD deployment Id: {}", mpiAppDeployId);
    ...
    public BatchQueue createBatchQueue(
            String queuename,
            String queueDesc,
            int maxRunTime,
            int maxNodes,
    ...
    public String registerComputeHost(
            String hostName,
            String hostDesc,
        ...
        String computeResourceId =
                airavataClient.registerComputeResource(new AuthzToken(""), computeResourceDescription);

        if (computeResourceId.isEmpty()) throw new AiravataClientException();

        ResourceJobManager resourceJobManager = RegisterSampleApplicationsUtils.createResourceJobManager(
                resourceJobManagerType, monitoringEndPoint, jobMangerBinPath, null);
        ...
        airavataClient.addSCPDataMovementDetails(
                new AuthzToken(""), computeResourceId, DMType.COMPUTE_RESOURCE, 1, scpDataMovement);
    ...
    public void registerGatewayResourceProfile() {
        ...
        try {
            ...
            ComputeResourcePreference lsfResourcePreferences =
                    RegisterSampleApplicationsUtils.createComputeResourcePreference(
                            lsfResourceId, "airavata", false, null, null, null, "/home/lg11w/mywork");
            ...
            ComputeResourcePreference alamoResourcePreferences =
                    RegisterSampleApplicationsUtils.createComputeResourcePreference(
                            ...
                            JobSubmissionProtocol.SSH,
                            DataMovementProtocol.SCP,
                            "/home/us3/work/uslims3_cauma3-03896");
    ...
    public void writeIdPropertyFile() {
        try {
            ...
            File file = new File(
                    "airavata-api/airavata-client-sdks/airavata-php-sdk/src/main/resources/conf/app-catalog-identifiers.ini");
    ...
    public void registerAlamoApps() {
        try {
            logger.info("#### Registering Application Deployments on Alamo #### \n");
            ...
            String ultrascanAppDeployId = airavataClient.registerApplicationDeployment(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationDeployment(
                            ultrascanModuleId,
                            alamoResourceId,
                            "/home/us3/bin/us_mpi_analysis",
                            ApplicationParallelismType.OPENMP,
                            ultrascanDescription,
                            ultrascanMouldes,
                            null,
                            null));
            logger.info("Ultrascan on alamo deployment Id {}", ultrascanAppDeployId);
    ...
    private void registerUltrascanInterface() {
        try {
            logger.info("#### Registering Ultrascan Application Interface ####");

            List<String> appModules = new ArrayList<String>();
            appModules.add(ultrascanModuleId);

            InputDataObjectType input1 = RegisterSampleApplicationsUtils.createAppInput(
                    "input", null, DataType.URI, null, 1, true, true, false, "input file", null);

            List<InputDataObjectType> applicationInputs = new ArrayList<InputDataObjectType>();
            applicationInputs.add(input1);

            OutputDataObjectType output1 = RegisterSampleApplicationsUtils.createAppOutput(
                    "output/analysis-results.tar", "", DataType.URI, true, true, null);

            OutputDataObjectType output2 =
                    RegisterSampleApplicationsUtils.createAppOutput("STDOUT", "", DataType.STDOUT, true, true, null);
            ...
            String ultrascanInterfaceId = airavataClient.registerApplicationInterface(
                    new AuthzToken(""),
                    DEFAULT_GATEWAY,
                    RegisterSampleApplicationsUtils.createApplicationInterfaceDescription(
                            "Ultrascan", "Ultrascan application", appModules, applicationInputs, applicationOutputs));
            logger.info("Ultrascan Application Interface Id {}", ultrascanInterfaceId);
