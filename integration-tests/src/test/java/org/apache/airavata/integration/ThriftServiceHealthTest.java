...
class ThriftServiceHealthTest {
    ...
    private static final String HOST =
            System.getProperty("airavata.thrift.host", "localhost");
    private static final int PORT =
            Integer.parseInt(System.getProperty("airavata.thrift.port", "8930"));
    ...
    private String callGetAPIVersion(String serviceName, TProtocol protocol) throws Exception {
        return assertDoesNotThrow(() -> switch (serviceName) {
