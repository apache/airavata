...
class KafkaHealthTest {
    ...
    private static final String BOOTSTRAP_SERVERS =
            System.getProperty("airavata.kafka.bootstrap.servers", "localhost:9092");

    @Test
    void kafkaClusterShouldHaveAtLeastOneBroker() throws ExecutionException, InterruptedException {
        ...
        try (AdminClient adminClient = AdminClient.create(config)) {
            ...
            assertFalse(nodes.isEmpty(), "Kafka cluster reported no broker nodes");
        }
    }
}
