...
public class TempInvoker implements WorkflowInvoker {
     ...
     */
    public TempInvoker(WsdlDefinitions definitions, LeadContextHeader leadContext) throws ComponentException {
     ...
     * @throws ComponentException
     */
    public TempInvoker(WsdlDefinitions definitions, LeadContextHeader leadContext, URI messageBoxURL)
            throws ComponentException {
