...
pytest -m redis         # Redis role tests
...
├── fixtures/
│   ├── __init__.py
│   ├── containers.py          # Container fixtures (Ubuntu, Rocky, CentOS)
│   └── ansible.py             # Ansible execution fixtures
├── utils/
│   ├── __init__.py
│   ├── container_setup.py     # Container setup utilities
│   └── inventory.py           # Inventory generation utilities
├── test_base_role.py          # Base role tests
├── test_database_role.py      # Database role tests
├── test_redis_role.py         # Redis role tests
├── test_apiserver_role.py     # API server role tests
├── test_keycloak_role.py      # Keycloak role tests
├── test_full_deployment.py    # Integration tests
...
- `@pytest.mark.redis` - Redis role tests
