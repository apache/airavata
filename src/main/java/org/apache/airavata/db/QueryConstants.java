...
public interface QueryConstants {
        ...
        // Entity names as string literals to avoid compile-time dependency on service
        // modules
        ...
        // Orchestration entity names (string literals to avoid compile-time dependency
        // on orchestration-service)
        ...
        String FIND_APPLICATION_DEPLOYMENTS_FOR_APPLICATION_MODULE_ID = "SELECT AD FROM "
                        + APPLICATION_DEPLOYMENT_ENTITY
                        + " AD " + "WHERE AD.appModuleId LIKE :"
                        + DBConstants.ApplicationDeployment.APPLICATION_MODULE_ID;
        String FIND_APPLICATION_DEPLOYMENTS_FOR_COMPUTE_HOST_ID = "SELECT AD FROM " + APPLICATION_DEPLOYMENT_ENTITY
                        + " AD "
        ...
        String FIND_ACCESSIBLE_APPLICATION_DEPLOYMENTS = "SELECT AD FROM " + APPLICATION_DEPLOYMENT_ENTITY + " AD "
                        + "WHERE AD.gatewayId LIKE :"
        ...
        String FIND_ACCESSIBLE_APPLICATION_DEPLOYMENTS_FOR_APP_MODULE = "SELECT AD FROM "
                        + APPLICATION_DEPLOYMENT_ENTITY + " AD " + "WHERE AD.gatewayId LIKE :"
                        + DBConstants.ApplicationDeployment.GATEWAY_ID + " AND AD.appDeploymentId IN :"
                        + DBConstants.ApplicationDeployment.ACCESSIBLE_APPLICATION_DEPLOYMENT_IDS
                        + " AND AD.computeHostId IN :" + DBConstants.ApplicationDeployment.ACCESSIBLE_COMPUTE_HOST_IDS
        ...
        String FIND_APPLICATION_MODULES_FOR_APPLICATION_MODULE_NAME = "SELECT AM FROM " + APPLICATION_MODULE_ENTITY
                        + " AM "
        ...
        String FIND_APPLICATION_INTERFACES_FOR_APPLICATION_NAME = "SELECT AI FROM " + APPLICATION_INTERFACE_ENTITY
                        + " AI "
        ...
        String GET_JOB_MANAGER_COMMAND = "SELECT DISTINCT JM FROM " + JOB_MANAGER_COMMAND_ENTITY + " JM "
                        + "WHERE JM.resourceJobManagerId LIKE :"
        ...
        String FIND_ACCESSIBLE_GROUP_RESOURCE_PROFILES = "SELECT G FROM " + GROUP_RESOURCE_PROFILE_ENTITY + " G "
        ...
        String GET_GATEWAY_FROM_GATEWAY_NAME = "SELECT G FROM " + GATEWAY_ENTITY + " G " + "WHERE G.gatewayName LIKE :"
                        + DBConstants.Gateway.GATEWAY_NAME;
        ...
        String GET_ALL_GATEWAY_NOTIFICATIONS = "SELECT N FROM " + NOTIFICATION_ENTITY + " N "
                        + "WHERE N.gatewayId LIKE :"
                        + DBConstants.Notification.GATEWAY_ID;

        String GET_ALL_PROJECTS_FOR_OWNER = "SELECT P FROM " + PROJECT_ENTITY + " P " + "WHERE P.owner LIKE :"
                        + DBConstants.Project.OWNER;
        ...
        String GET_EXPERIMENTS_FOR_PROJECT_ID = "SELECT E FROM " + EXPERIMENT_ENTITY + " E "
                        + "WHERE E.projectId LIKE :"
                        + DBConstants.Experiment.PROJECT_ID + " AND E.gatewayId = :"
                        + DBConstants.Experiment.GATEWAY_ID;
        String GET_EXPERIMENTS_FOR_GATEWAY_ID = "SELECT E FROM " + EXPERIMENT_ENTITY + " E "
                        + "WHERE E.gatewayId LIKE :"
                        + DBConstants.Experiment.GATEWAY_ID;

        String GET_PROCESS_FOR_EXPERIMENT_ID = "SELECT P FROM " + PROCESS_ENTITY + " P " + "WHERE P.experimentId = :"
                        + DBConstants.Process.EXPERIMENT_ID;

        String GET_TASK_FOR_PARENT_PROCESS_ID = "SELECT T FROM " + TASK_ENTITY + " T "
                        + "WHERE T.parentProcessId LIKE :"
                        + DBConstants.Task.PARENT_PROCESS_ID;

        String GET_JOB_FOR_PROCESS_ID = "SELECT J FROM " + JOB_ENTITY + " J " + "WHERE J.processId LIKE :"
                        + DBConstants.Job.PROCESS_ID;

        String GET_JOB_FOR_TASK_ID = "SELECT J FROM " + JOB_ENTITY + " J " + "WHERE J.taskId LIKE :"
                        + DBConstants.Job.TASK_ID;

        String GET_JOB_FOR_JOB_ID = "SELECT J FROM " + JOB_ENTITY + " J " + "WHERE J.jobId LIKE :"
        ...
        String GET_ALL_USER_STORAGE_PREFERENCE = "SELECT USP FROM " + "UserStoragePreferenceEntity" + " USP "
        ...
        String FIND_ALL_AVAILABLE_STORAGE_RESOURCES = "SELECT SR FROM " + "StorageResourceEntity" + " SR "
                        + "WHERE SR.enabled = TRUE";

        String FIND_PARSING_TEMPLATES_FOR_APPLICATION_INTERFACE_ID = "SELECT PT FROM " + PARSING_TEMPLATE_ENTITY
                        + " PT "
        ...
        String FIND_ALL_PARSERS_FOR_GATEWAY_ID = "SELECT P FROM " + PARSER_ENTITY + " P " + "WHERE P.gatewayId = :"
                        + DBConstants.Parser.GATEWAY_ID;
        ...
        String FIND_JOB_COUNT_NATIVE_QUERY = "SELECT DISTINCT JS.ENTITY_ID FROM EXEC_STATUS JS WHERE JS.ENTITY_TYPE = 'JOB' AND JS.ENTITY_ID IN "
        ...
        String FIND_AVG_TIME_SUBMISSION_NATIVE_QUERY = "SELECT AVG(difference) FROM(SELECT es.TIME_OF_STATE_CHANGE AS esTime1, ps.TIME_OF_STATE_CHANGE as psTime1, "
                        + " TIMESTAMPDIFF(MICROSECOND, es.TIME_OF_STATE_CHANGE, ps.TIME_OF_STATE_CHANGE) AS difference from EXPERIMENT_STATUS es, "
