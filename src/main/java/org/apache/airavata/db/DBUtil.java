...
public class DBUtil {
    ...
    /**
     * Initializes and load driver. Must be called this before calling anyother
     * method.
     *
     ...
     *                                If security does not allow users to
     ...
     * @throws Exception
     *                   If an error occurred while reading configurations or while
     *                   creating database object.
     */
    public static DBUtil getCredentialStoreDBUtil() throws Exception {
