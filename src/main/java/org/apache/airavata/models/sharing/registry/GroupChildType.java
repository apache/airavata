 ...
 * {@code org.apache.airavata.sharing.registry.models.proto.GroupChildType}.
 */
public enum GroupChildType {
    ...
    public static GroupChildType forNumber(int number) {
        for (GroupChildType value : values()) {
