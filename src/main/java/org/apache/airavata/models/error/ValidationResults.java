...
/**
 * Plain-POJO replacement for the generated {@code org.apache.airavata.model.error.proto.ValidationResults}.
 *
 * <p>Distinct from {@link org.apache.airavata.models.commons.ValidationResults}, which has the
 * same shape but belongs to the {@code commons} namespace, matching the two separate generated
 * proto types.
 */
