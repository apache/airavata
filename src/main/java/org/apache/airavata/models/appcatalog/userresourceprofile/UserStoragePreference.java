 ...
 * {@code org.apache.airavata.model.appcatalog.userresourceprofile.proto.UserStoragePreference}.
 */
public record UserStoragePreference(
    ...
    public static final class Builder {
        ...
        private Builder(UserStoragePreference source) {
        ...
        public UserStoragePreference build() {
            return new UserStoragePreference(
                    storageResourceId, loginUserName, fileSystemRootLocation,
