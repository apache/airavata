...
public class QueueStatusRepository extends AbstractRepository<QueueStatusModel, QueueStatusEntity, String> {
    ...
    public boolean createQueueStatuses(List<QueueStatusModel> queueStatusModels) throws Exception {
    ...
    public Optional<QueueStatusModel> getQueueStatus(String hostName, String queueName) throws Exception {
