...
public class GrpComputePrefRepository
    ...
    public GroupComputeResourcePreference get(GroupComputeResourcePrefPK groupComputeResourcePrefPK) {
        ...
        if (ent instanceof SlurmGroupComputeResourcePrefEntity sl) {
            ...
            if (sl.getGroupSSHAccountProvisionerConfigs() != null) {
                for (Map<String, Object> cfg : sl.getGroupSSHAccountProvisionerConfigs()) {
                    GroupAccountSSHProvisionerConfig.Builder cfgBuilder = GroupAccountSSHProvisionerConfig.newBuilder();
                    if (cfg.get("resourceId") != null) cfgBuilder.setResourceId((String) cfg.get("resourceId"));
                    if (cfg.get("groupResourceProfileId") != null)
                        cfgBuilder.setGroupResourceProfileId((String) cfg.get("groupResourceProfileId"));
                    if (cfg.get("configName") != null) cfgBuilder.setConfigName((String) cfg.get("configName"));
                    if (cfg.get("configValue") != null) cfgBuilder.setConfigValue((String) cfg.get("configValue"));
                    scrpBuilder.addGroupSshAccountProvisionerConfigs(cfgBuilder.build());
                }
            }
