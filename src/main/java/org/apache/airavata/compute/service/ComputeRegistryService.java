...
@Service
@Primary
public class ComputeRegistryService {
    ...
    public ComputeResourceDescription getComputeResource(String computeResourceId) throws Exception {
        try {
            ComputeResourceDescription computeResource = new ComputeResourceRepository()
            ...
            throw new Exception("Error while retrieving compute resource. More info : " + e.getMessage());
        }
    }
    ...
    public boolean deleteComputeResource(String computeResourceId) throws Exception {
        try {
            ...
            throw new Exception("Error while deleting compute resource. More info : " + e.getMessage());
        }
    }
    ...
    public boolean updateComputeResource(
        ...
        try {
            ...
            throw new Exception("Error while updaing compute resource. More info : " + e.getMessage());
        }
    }
    ...
    public String registerComputeResource(ComputeResourceDescription computeResourceDescription) throws Exception {
        try {
            ...
            throw new Exception("Error while saving compute resource. More info : " + e.getMessage());
        }
    }
    ...
    public ResourceJobManager getResourceJobManager(String resourceJobManagerId) throws Exception {
        try {
            ...
            throw new Exception("Error while retrieving resource job manager. More info : " + e.getMessage());
        }
    }
    ...
    public boolean deleteResourceJobManager(String resourceJobManagerId) throws Exception {
        try {
            ...
            throw new Exception("Error while deleting resource job manager. More info : " + e.getMessage());
        }
    }
    ...
    public boolean deleteBatchQueue(String computeResourceId, String queueName) throws Exception {
        try {
            ...
            throw new Exception("Error while deleting batch queue. More info : " + e.getMessage());
        }
    }
    ...
    public boolean updateResourceJobManager(String resourceJobManagerId, ResourceJobManager updatedResourceJobManager)
        ...
        try {
            ...
            throw new Exception("Error while updating resource job manager. More info : " + e.getMessage());
        }
    }
    ...
    public String registerResourceJobManager(ResourceJobManager resourceJobManager) throws Exception {
        try {
            ...
            throw new Exception("Error while adding resource job manager. More info : " + e.getMessage());
        }
    }
}
