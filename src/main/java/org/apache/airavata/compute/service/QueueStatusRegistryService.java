...
@Component
@Primary
public class QueueStatusRegistryService {
    private static final Logger logger = LoggerFactory.getLogger(QueueStatusRegistryService.class);
    ...
    public QueueStatusModel getQueueStatus(String hostName, String queueName) throws Exception {
        try {
            Optional<QueueStatusModel> optionalQueueStatusModel = queueStatusRepository.getQueueStatus(hostName,
                    queueName);
            ...
            throw new Exception("Error while retrieving queue status models.... : " + e.getMessage());
        }
    }
    ...
    public void registerQueueStatuses(List<QueueStatusModel> queueStatuses) throws Exception {
        try {
            ...
            throw new Exception("Error while storing queue status models.... : " + e.getMessage());
        }
    }
    ...
    public List<QueueStatusModel> getLatestQueueStatuses() throws Exception {
        try {
            ...
            throw new Exception("Error while reading queue status models.... : " + e.getMessage());
        }
    }
}
