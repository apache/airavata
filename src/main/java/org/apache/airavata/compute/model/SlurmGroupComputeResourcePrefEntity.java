...
/**
 * The persistent class for the slurm_group_compute_resource_preference database
 * table.
 */
@Entity
...
public class SlurmGroupComputeResourcePrefEntity extends GroupComputeResourcePrefEntity {
    ...
    @Lob
    @Column(name = "SSH_PROVISIONER_CONFIG_JSON")
    @Convert(converter = JsonListConverter.class)
    private List<Map<String, Object>> groupSSHAccountProvisionerConfigs;
    ...
    public List<Map<String, Object>> getGroupSSHAccountProvisionerConfigs() {
        return groupSSHAccountProvisionerConfigs;
    }

    public void setGroupSSHAccountProvisionerConfigs(List<Map<String, Object>> groupSSHAccountProvisionerConfigs) {
