...
public class ComputeResourceEntity implements Serializable {
    ...
    @Lob
    @Column(name = "FILE_SYSTEMS_JSON")
    @Convert(converter = JsonListConverter.class)
    private List<Map<String, Object>> fileSystems;

    @OneToMany(targetEntity = BatchQueueEntity.class, cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "computeResource", fetch = FetchType.EAGER)
    ...
    public void setFileSystems(List<Map<String, Object>> fileSystems) {
