...
public class JobEntity implements Serializable {
    ...
    @JoinColumn(name = "ENTITY_ID", referencedColumnName = "JOB_ID", foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
    ...
    public List<ExecStatusEntity> getJobStatuses() {
        return jobStatuses;
    }

    public void setJobStatuses(List<ExecStatusEntity> jobStatuses) {
