...
public class TaskEntity implements Serializable {
    ...
    @JoinColumn(name = "ENTITY_ID", referencedColumnName = "TASK_ID", foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
    ...
    public List<ExecStatusEntity> getTaskStatuses() {
        return taskStatuses;
    }

    public void setTaskStatuses(List<ExecStatusEntity> taskStatuses) {
        this.taskStatuses = taskStatuses;
    }

    public List<ExecErrorEntity> getTaskErrors() {
        return taskErrors;
    }

    public void setTaskErrors(List<ExecErrorEntity> taskErrors) {
