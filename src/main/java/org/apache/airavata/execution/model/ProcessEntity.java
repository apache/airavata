...
public class ProcessEntity implements Serializable {
    ...
    @OneToMany(targetEntity = ExecStatusEntity.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER, orphanRemoval = true)
    @JoinColumn(name = "ENTITY_ID", referencedColumnName = "PROCESS_ID", foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
    ...
    @OneToMany(targetEntity = ExecErrorEntity.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER, orphanRemoval = true)
    @JoinColumn(name = "ENTITY_ID", referencedColumnName = "PROCESS_ID", foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
    @org.hibernate.annotations.SQLRestriction("ENTITY_TYPE = 'PROCESS'")
    private List<ExecErrorEntity> processErrors;

    @OneToMany(targetEntity = ExecIoParamEntity.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER, orphanRemoval = true)
    @JoinColumn(name = "ENTITY_ID", referencedColumnName = "PROCESS_ID", foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
    ...
    @OneToOne(targetEntity = ProcessResourceScheduleEntity.class, cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    ...
    @OneToMany(targetEntity = TaskEntity.class, cascade = CascadeType.ALL, mappedBy = "process", fetch = FetchType.EAGER)
    ...
    public List<ExecStatusEntity> getProcessStatuses() {
        return processStatuses;
    }

    public void setProcessStatuses(List<ExecStatusEntity> processStatuses) {
        this.processStatuses = processStatuses;
    }

    public List<ExecErrorEntity> getProcessErrors() {
        return processErrors;
    }

    public void setProcessErrors(List<ExecErrorEntity> processErrors) {
        this.processErrors = processErrors;
    }

    public List<ExecIoParamEntity> getProcessInputs() {
        return processInputs;
    }

    public void setProcessInputs(List<ExecIoParamEntity> processInputs) {
        this.processInputs = processInputs;
    }

    public List<ExecIoParamEntity> getProcessOutputs() {
        return processOutputs;
    }

    public void setProcessOutputs(List<ExecIoParamEntity> processOutputs) {
