...
public class ProcessInputRepository {
    ...
    private final ExecIoParamRepository delegate;

    public ProcessInputRepository(ExecIoParamRepository execIoParamRepository) {
        this.delegate = execIoParamRepository;
    }

    public String addProcessInputs(List<InputDataObjectType> processInputs, String processId) throws Exception {
