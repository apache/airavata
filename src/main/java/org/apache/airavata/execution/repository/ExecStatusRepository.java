...
public class ExecStatusRepository extends AbstractRepository<ExecStatusEntity, ExecStatusEntity, String> {
    ...
    public ExecStatusRepository(JobRepository jobRepository) {
    ...
    private void addToProcess(ExecStatusEntity entity, String processId) throws Exception {
        execute(em -> {
    ...
    private void mergeInProcess(ExecStatusEntity entity, String processId) throws Exception {
        execute(em -> {
            ProcessEntity processEntity = em.find(ProcessEntity.class, processId);
            if (processEntity != null) {
                if (processEntity.getProcessStatuses() == null) {
