...
public class TaskRepository extends AbstractRepository<TaskModel, TaskEntity, String> {
    ...
    protected String saveTaskModelData(TaskModel taskModel) throws Exception {
    ...
    protected TaskEntity saveTask(TaskModel taskModel) throws Exception {
        ...
        return execute(entityManager -> {
            ...
            if (taskEntity.getProcess() == null && taskEntity.getParentProcessId() != null) {
                ProcessEntity processRef = entityManager.getReference(ProcessEntity.class,
                        taskEntity.getParentProcessId());
    ...
    public String addTask(TaskModel task, String processId) throws Exception {
        task = task.toBuilder().setParentProcessId(processId).build();
        String taskId = saveTaskModelData(task);
        return taskId;
    }

    public String updateTask(TaskModel task, String taskId) throws Exception {
        return saveTaskModelData(task);
    }

    public TaskModel getTask(String taskId) throws Exception {
        TaskRepository taskRepository = new TaskRepository();
        return taskRepository.get(taskId);
    }

    public List<TaskModel> getTaskList(String fieldName, Object value) throws Exception {
        TaskRepository taskRepository = new TaskRepository();
        ...
        if (fieldName.equals(DBConstants.Task.PARENT_PROCESS_ID)) {
            ...
            taskModelList = taskRepository.select(QueryConstants.GET_TASK_FOR_PARENT_PROCESS_ID, -1, 0,
                    queryParameters);
        } else {
    ...
    public List<String> getTaskIds(String fieldName, Object value) throws Exception {
    ...
    public boolean isTaskExist(String taskId) throws Exception {
