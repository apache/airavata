...
public class ExecIoParamRepository extends AbstractRepository<ExecIoParamEntity, ExecIoParamEntity, String> {
    ...
    public String addProcessInputs(List<InputDataObjectType> inputs, String processId) throws Exception {
        saveProcessInputs(inputs, processId);
        return processId;
    }

    public void updateProcessInputs(List<InputDataObjectType> inputs, String processId) throws Exception {
        saveProcessInputs(inputs, processId);
    }

    protected void saveProcessInputs(List<InputDataObjectType> inputs, String processId) throws Exception {
        
        ProcessEntity processEntity = execute(em -> em.find(ProcessEntity.class, processId));
    ...
    public String addProcessOutputs(List<OutputDataObjectType> outputs, String processId) throws Exception {
        saveProcessOutputs(outputs, processId);
        return processId;
    }

    public void updateProcessOutputs(List<OutputDataObjectType> outputs, String processId) throws Exception {
        saveProcessOutputs(outputs, processId);
    }

    protected void saveProcessOutputs(List<OutputDataObjectType> outputs, String processId) throws Exception {
        ProcessEntity processEntity = execute(
                em -> em.find(ProcessEntity.class, processId));
        if (processEntity == null)
            return;
