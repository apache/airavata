...
public class DataProductEntity implements Serializable {
    ...
    @Id
    @Column(name = "PRODUCT_URI", insertable = false, updatable = false)
    ...
    @OneToMany(targetEntity = DataReplicaLocationEntity.class, cascade = CascadeType.ALL, mappedBy = "dataProduct", fetch = FetchType.EAGER)
