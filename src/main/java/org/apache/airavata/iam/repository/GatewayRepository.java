...
import org.apache.airavata.interfaces.Exception;
...
public class GatewayRepository extends AbstractRepository<Gateway, GatewayEntity, String> {
    ...
    protected String saveGatewayData(Gateway gateway) throws Exception {
    ...
    public Gateway getDefaultGateway() throws Exception {
        String defaultGatewayName = ServerSettings.getDefaultUserGateway();
        return getExistingGateway(defaultGatewayName);
    }

    public Gateway getExistingGateway(String gatewayName) throws Exception {
    ...
    public Gateway getGatewayByInternalId(String airavataInternalGatewayId) throws Exception {
