...
public abstract class AbstractJDBCUserStore {
    ...
    public void configure(Node node) throws Exception {
        ...
        /**
         * <specificConfigurations> <database> <jdbcUrl></jdbcUrl>
        ...
        if (databaseURL == null || databaseUserName == null || databasePassword == null) {
            // If database configurations are not specified in authenticators.xml we will
            // read them from
            ...
            try {
                ...
                throw new Exception("Error reading default user store DB configurations.", e);
            }
