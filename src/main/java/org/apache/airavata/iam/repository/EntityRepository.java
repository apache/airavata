...
@Component
public class EntityRepository extends AbstractSharingRepository<EntityEntity, EntityPK> {

    public EntityRepository() {
        super(EntityEntity.class);
    }

    public List<EntityEntity> getChildEntities(String domainId, String parentId) throws SharingRegistryException {
    ...
    public List<EntityEntity> searchEntities(
        ...
        List<Object[]> temp = execute(entityManager -> entityManager
                .createNativeQuery(nativeQuery)
                .setFirstResult(offset)
                .setMaxResults(newLimit)
                .getResultList());
        List<EntityEntity> resultSet = new ArrayList<>();
