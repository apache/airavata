...
public class PasswordDigester {
     ...
     */
    public PasswordDigester(String method) throws Exception {
        hashMethod = method;
     ...
     */
    public String getPasswordHashValue(String password) throws Exception {
        ...
        if (hashMethod.equals(SecurityUtil.PASSWORD_HASH_METHOD_PLAINTEXT)) {
            ...
            try {
                ...
                throw new Exception("Error creating message digest with hash algorithm - " + hashMethod, e);
            }
            try {
                return new String(messageDigest.digest(password.getBytes("UTF-8")));
            } catch (UnsupportedEncodingException e) {
                throw new Exception("Unable to create password digest", e);
            }
        }
    }

    private void validateHashAlgorithm() throws Exception {
