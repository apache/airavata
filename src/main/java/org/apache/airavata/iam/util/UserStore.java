...
public interface UserStore {
     ...
     */
    default boolean authenticate(String userName, Object credentials) throws Exception {
        throw new UnsupportedOperationException("Username/password authentication is not supported by this user store");
    }
     ...
     * @throws UserStoreException if a system wide error occurred while authenticating the user.
     */
    default boolean authenticate(Object credentials) throws Exception {
        throw new UnsupportedOperationException("Token-based authentication is not supported by this user store");
    }

    /**
     * This method will do necessary configurations of the user store.
     * @param node An XML configuration node.
     * @throws Exception If an error occurred while configuring the authenticator.
     */
