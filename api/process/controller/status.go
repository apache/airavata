...
func (h *StatusController) Register(mux *http.ServeMux) {
	mux.HandleFunc("GET /api/v1/batch-job-processes/{processId}/statuses", h.list)
	mux.HandleFunc("GET /api/v1/batch-job-processes/{processId}/statuses/{statusId}", h.get)
}
