...
* under the License.
*/
package org.apache.airavata.helix.task.aws.utils;
...
public class ExponentialBackoffWaiter {
    ...
    public ExponentialBackoffWaiter(
            String taskDescription, int maxRetries, long initialDelay, long maxDelay, TimeUnit unit) {
    ...
    public <T> T waitUntil(Callable<T> operation) throws Exception {
        ...
        while (attempt < maxRetries) {
            try {
                ...
                LOGGER.warn(
                        "Task '{}' attempt {} failed with error: {}. Retrying...",
                        taskDescription,
                        attempt + 1,
                        e.getMessage());
            }
