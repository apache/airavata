...
public class HTCondorJobConfiguration implements JobManagerConfiguration {
    ...
    public RawCommandInfo getMonitorCommand(String jobID) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.JOB_MONITORING).trim() + " " + jobID + " -nobatch");
    }
    ...
    public RawCommandInfo getUserBasedMonitorCommand(String userName) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.JOB_MONITORING).trim() + " -submitter " + userName);
    }

    @Override
    public RawCommandInfo getJobIdMonitorCommand(String jobName, String userName) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.JOB_MONITORING).trim() + " " + jobName + " -submitter " + userName);
    }
