...
public class ProcessScannerImpl implements ProcessScanner {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        try {
            ...
            List<ProcessModel> processModelList = registry.getProcessListInState(state);
            ...
            List<ProcessModel> reQueuedProcessModels = registry.getProcessListInState(ReQueuedState);
