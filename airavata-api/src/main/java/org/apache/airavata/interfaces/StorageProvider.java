...
public interface StorageProvider {
     ...
     *
     * @param dataProductModel the updated data product
     * @return true if the update was successful
     * @throws Exception if a data access error occurs
     */
    boolean updateDataProduct(DataProductModel dataProductModel) throws Exception;

    /**
     * Remove a data product by its product URI.
     *
     * @param productUri the product URI
     * @return true if the removal was successful
     * @throws Exception if a data access error occurs
     */
    boolean removeDataProduct(String productUri) throws Exception;

    /**
     * Retrieve a replica location by its replica id.
     *
     * @param replicaId the replica id
     * @return the replica location model
     * @throws Exception if not found or a data access error occurs
     */
    DataReplicaLocationModel getReplicaLocation(String replicaId) throws Exception;

    /**
     * Update an existing replica location.
     *
     * @param replicaLocationModel the updated replica location
     * @return true if the update was successful
     * @throws Exception if a data access error occurs
     */
    boolean updateReplicaLocation(DataReplicaLocationModel replicaLocationModel) throws Exception;

    /**
     * Remove a replica location by its replica id.
     *
     * @param replicaId the replica id
     * @return true if the removal was successful
     * @throws Exception if a data access error occurs
