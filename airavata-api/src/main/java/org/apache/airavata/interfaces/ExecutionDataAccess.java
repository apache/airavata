...
public interface ExecutionDataAccess {
    ...
    // --- Workflow ---
    String registerWorkflow(AiravataWorkflow workflow, String experimentId) throws RegistryException;

    void updateWorkflow(String workflowId, AiravataWorkflow workflow) throws RegistryException;

    AiravataWorkflow getWorkflow(String workflowId) throws RegistryException;

    void deleteWorkflow(String workflowId) throws RegistryException;

    String getWorkflowId(String experimentId) throws RegistryException;
}
