...
/**
 * SPI for gateway groups initialization, decoupling core from iam-service.
 * Implementations are discovered at runtime via Spring dependency injection.
 */
public interface GatewayGroupsProvider {
    GatewayGroups initializeGatewayGroups(String gatewayId) throws Exception;
}
