...
/**
 * SPI contract for remote agent operations (command execution, file transfer).
 *
 * <p>Implementations are provided by the compute module (e.g. SSHJAgentAdaptor).
 * Execution components depend only on this interface.
 */
