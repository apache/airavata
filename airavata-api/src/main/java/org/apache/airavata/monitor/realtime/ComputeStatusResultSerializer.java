...
public class ComputeStatusResultSerializer implements Serializer<JobStatusResult> {
    ...
    public byte[] serialize(String s, JobStatusResult jobStatusResult) {
        String serializedData = jobStatusResult.getJobId() + "," + jobStatusResult.getJobName()
