...
//         if (gatewayName == null) {
//             JSPUtil.handleException(
//                     new RuntimeException("Please specify a gateway name."),
//                     request,
//                     response,
...
//             JSPUtil.handleException(
//                     new RuntimeException("Please specify a portal user name."),
//                     request,
//                     response,
//                     configurationReader.getErrorUrl());
//             return;
...
//             JSPUtil.handleException(
//                     new RuntimeException("Please specify a contact email address for community" + " user account."),
//                     request,
//                     response,
//                     configurationReader.getErrorUrl());
//             return;
...
//         String modifiedCallbackUri =
//                 decorateURI(getOA4MPService().getEnvironment().getCallback(), queryParameters);
...
//             return;
//         }
//         log.info("1.b. Got response. Creating page with redirect for "
//                 + gtwResp.getRedirect().getHost());
