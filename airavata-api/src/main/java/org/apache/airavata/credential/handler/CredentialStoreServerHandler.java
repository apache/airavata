...
public class CredentialStoreServerHandler implements CredentialStoreService.Iface {
    ...
    public String addPasswordCredential(PasswordCredential passwordCredential)
        ...
        try {
            ...
            throw new org.apache.airavata.credential.store.exception.CredentialStoreException(
                    "Error occurred while registering PWD Credentials..");
        }
    }
        ...
        try {
            ...
            if (type.equals(SummaryType.SSH)) {
                return credentials.stream()
                        ...
                        .map(cred -> (org.apache.airavata.credential.model.SSHCredential) cred)
    ...
    private boolean isSSHCredential(Credential cred) {
        return cred instanceof org.apache.airavata.credential.model.SSHCredential
                && !(cred instanceof org.apache.airavata.credential.model.PasswordCredential);
    }

    private boolean isCertificateCredential(Credential cred) {
        return cred instanceof org.apache.airavata.credential.model.CertificateCredential;
    }
