...
public interface QueryConstants {
    ...
    String PROCESS_STATUS_ENTITY = "ProcessStatusEntity";
    ...
    String FIND_ALL_GRID_FTP_ENDPOINTS_BY_DATA_MOVEMENT = "SELECT GFE FROM " + "GridftpEndpointEntity"
    ...
    String FIND_PROCESS_WITH_STATUS =
            "SELECT P FROM " + PROCESS_STATUS_ENTITY + " P " + " where P.state = :" + DBConstants.ProcessStatus.STATE;
