...
public class SharingServiceDBEventHandler implements MessageHandler {
    ...
    SharingServiceDBEventHandler() {
        sharingRegistry = AiravataServiceFactory.getSharingRegistry();
    }
                ...
                switch (dBEventMessageContext
                    ...
                    case USER_PROFILE:
                        ...
                        switch (dBEventMessageContext
                            ...
                            case CREATE:
                            case UPDATE:
                                if (!sharingRegistry.isUserExists(user.getDomainId(), user.getUserId())) {
                                    ...
                                    sharingRegistry.updatedUser(user);
                            ...
                            case DELETE:
                                ...
                                sharingRegistry.deleteUser(user.getDomainId(), user.getUserId());
                    ...
                    case TENANT:
                        ...
                        switch (dBEventMessageContext
                            ...
                            case UPDATE:
                                ...
                                if (sharingRegistry.isDomainExists(gateway.getGatewayId())) {
                                    break;
                                }
                                /*
                    ...
                    case PROJECT:
                        ...
                        switch (dBEventMessageContext
                            ...
                            case UPDATE:
                                ...
                                if (!sharingRegistry.isEntityExists(domainId, entityId)) {
                            ...
                            case DELETE:
                                ...
                                sharingRegistry.deleteEntity(domainId, entityId);
