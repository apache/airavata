...
/**
 * Domain model: JobStatusChangeRequestEvent
 */
public class JobStatusChangeRequestEvent extends MessagingEvent {
    ...
    public boolean equals(Object o) {
        ...
        JobStatusChangeRequestEvent that = (JobStatusChangeRequestEvent) o;
    ...
    public String toString() {
        return "JobStatusChangeRequestEvent{" + "state=" + state + ", jobIdentity=" + jobIdentity + "}";
    }
}
