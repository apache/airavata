...
import org.apache.airavata.execution.scheduler.SchedulerConstants;
import org.quartz.*;
    ...
    public void run() {
        ...
        try {
            ...
            for (int i = 0; i < parallelJobs; i++) {
                String name = SchedulerConstants.PROCESS_SCANNER_TRIGGER + "_" + i;
                Trigger trigger = TriggerBuilder.newTrigger()
                        .withIdentity(name, SchedulerConstants.PROCESS_SCANNER_GROUP)
                        .startNow()
                ...
                String jobName = SchedulerConstants.PROCESS_SCANNER_JOB + "_" + i;

                JobDetail jobC = JobBuilder.newJob(ProcessScannerImpl.class)
                        .withIdentity(jobName, SchedulerConstants.PROCESS_SCANNER_JOB)
                        .build();
