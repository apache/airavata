...
* under the License.
*/
package org.apache.airavata.execution.util.cpi;
...
public interface ExperimentCatalog {
     ...
     *                             org.apache.airavata.execution.util.cpi.CompositeIdentifier type if it is a child element
     *                             with multiple identifiers
     * @return return the identifier to identify the object
     */
    public Object add(ExpCatChildDataType dataType, Object newObjectToAdd, Object dependentIdentifiers)
     ...
     */
    public void update(ExperimentCatalogModelType dataType, Object newObjectToUpdate, Object identifier)
            throws RegistryException;
     ...
     *              org.apache.airavata.execution.util.cpi.Constants
     ...
     */
    public void update(ExperimentCatalogModelType dataType, Object identifier, String fieldName, Object value)
            throws RegistryException;
     ...
     */
    public List<Object> get(ExperimentCatalogModelType dataType, String fieldName, Object value)
            throws RegistryException;
    ...
    public List<Object> get(
            ExperimentCatalogModelType dataType,
            String fieldName,
            Object value,
            int limit,
            int offset,
     ...
     * @return List of objects according to the given criteria
     */
    public List<Object> searchAllAccessible(
            ExperimentCatalogModelType dataType,
     ...
     *         given
     */
    public Object getValue(ExperimentCatalogModelType dataType, Object identifier, String field)
            throws RegistryException;
     ...
     */
    public List<String> getIds(ExperimentCatalogModelType dataType, String fieldName, Object value)
            throws RegistryException;
