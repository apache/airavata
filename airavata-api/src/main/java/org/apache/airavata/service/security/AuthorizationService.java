...
public interface AuthorizationService {
     ...
     */
    void validateExperimentReadAccess(
     ...
     */
    void validateExperimentWriteAccess(
            AuthzToken authzToken, String experimentId, String experimentOwner, String experimentGatewayId)
            throws AuthorizationException;
     ...
     */
    void validateProjectReadAccess(
     ...
     */
    void validateProjectWriteAccess(
            AuthzToken authzToken, String projectId, String projectOwner, String projectGatewayId)
            throws AuthorizationException;
     ...
     */
    void validateLaunchExperimentAccess(AuthzToken authzToken, String gatewayId, ExperimentModel experiment)
