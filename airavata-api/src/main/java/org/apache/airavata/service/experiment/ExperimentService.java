...
public class ExperimentService {
    ...
    public List<ExperimentSummaryModel> searchExperiments(
        ...
        try {
            ...
            sharingHandler
                    .searchEntities(gatewayId, userName + "@" + gatewayId, sharingFilters, searchOffset, searchLimit)
        ...
        try {
            ...
            if (!experiment.getUserConfigurationData().isSetGroupResourceProfileId()) {
                ...
                if (!accessibleGroupResourceProfiles.isEmpty()) {
                    ...
                    registryHandler.updateExperimentConfiguration(experimentId, experiment.getUserConfigurationData());
                } else {
            ...
            org.apache.airavata.model.appcatalog.appinterface.ApplicationInterfaceDescription
                    applicationInterfaceDescription = registryHandler.getApplicationInterface(appInterfaceId);
