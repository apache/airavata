...
public class SharingManagerImpl implements SharingManager {
    ...
    private void shareEntityWithAdminGatewayGroups(Entity entity)
    ...
    private void createManageSharingPermissionTypeIfMissing(String domainId) {
        try {
            ...
            try {
                ...
                var permissionType = new org.apache.airavata.sharing.model.PermissionType();
        ...
        } catch (SharingRegistryException | org.apache.airavata.sharing.model.DuplicateEntryException e) {
