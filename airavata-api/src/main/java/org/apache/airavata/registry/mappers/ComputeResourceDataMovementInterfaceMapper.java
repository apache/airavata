...
/**
 * MapStruct mapper for converting between DataMovementInterfaceEntity (for ComputeResource) and DataMovementInterface.
 */
@Mapper(componentModel = "spring", config = EntityMapperConfig.class)
public interface ComputeResourceDataMovementInterfaceMapper {
