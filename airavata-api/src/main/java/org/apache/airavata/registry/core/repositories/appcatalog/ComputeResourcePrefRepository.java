...
public class ComputeResourcePrefRepository
    ...
    public Map<String, String> getsshAccountProvisionerConfig(String gatewayId, String hostId) {
        ...
        if (computeResourcePreferenceEntity.getSshAccountProvisionerConfigurations() != null
                && !computeResourcePreferenceEntity
                        .getSshAccountProvisionerConfigurations()
                        .isEmpty()) {
            Map<String, String> sshAccountProvisionerConfigurations = new HashMap<>();
            for (SSHAccountProvisionerConfiguration config :
                    computeResourcePreferenceEntity.getSshAccountProvisionerConfigurations()) {
