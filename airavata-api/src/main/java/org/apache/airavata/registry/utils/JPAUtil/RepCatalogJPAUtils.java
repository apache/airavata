...
* under the License.
*/
package org.apache.airavata.registry.utils.JPAUtil;
...
public class RepCatalogJPAUtils {
    ...
    // TODO: we can rename this back to replicacatalog_data once we completely replace the other replicacatalog_data
    // persistence context in airavata-registry-core
    ...
    public static EntityManager getEntityManager() {
        if (instance == null || instance.factory == null) {
            throw new IllegalStateException("RepCatalogJPAUtils not initialized. Make sure it's a Spring bean.");
        }
