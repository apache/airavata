...
@Repository
public interface GroupResourceProfileRepository extends JpaRepository<GroupResourceProfileEntity, String> {

    @Query(
            "SELECT g FROM GroupResourceProfileEntity g WHERE g.gatewayId LIKE :gatewayId AND g.groupResourceProfileId IN :accessibleGroupResourceIds")
