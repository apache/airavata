...
public class WorkflowRepository extends WorkflowCatAbstractRepository<AiravataWorkflow, AiravataWorkflowEntity, String>
    ...
    protected AiravataWorkflowEntity saveWorkflow(AiravataWorkflow workflowModel, String experimentId)
        ...
        if (workflowEntity.getConnections() != null) {
            ...
            workflowEntity.getConnections().forEach(connectionEntity -> {
                if (connectionEntity.getId() == null
                        || connectionEntity.getId().equals(airavata_commonsConstants.DEFAULT_ID)) {
    ...
    @Override
    public String registerWorkflow(AiravataWorkflow workflowModel, String experimentId)
            throws WorkflowCatalogException {
        return saveWorkflowModelData(workflowModel, experimentId);
    }

    @Override
    public void updateWorkflow(String workflowId, AiravataWorkflow updatedWorkflowModel)
            throws WorkflowCatalogException {
