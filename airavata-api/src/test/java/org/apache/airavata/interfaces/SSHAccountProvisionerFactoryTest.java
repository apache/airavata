...
public class SSHAccountProvisionerFactoryTest {
    ...
    private SSHAccountProvisionerFactory factory;

    @BeforeEach
    void setUp() {
        factory = new SSHAccountProvisionerFactory(List.of(new TestSSHAccountProvisionerProvider()));
    }
    ...
    public void testGetSSHAccountProvisionerImplementationNames() {
        ...
        List<SSHAccountProvisionerProvider> sshAccountProvisionerProviders =
                factory.getSSHAccountProvisionerProviders();
    ...
    public void testGetSSHAccountProvisionerConfigParams() {
        ...
        List<ConfigParam> configParams = factory.getSSHAccountProvisionerConfigParams("TestSSHAccountProvisioner");
    ...
    public void testCreateSSHAccountProvisioner() {
        ...
        TestSSHAccountProvisioner sshAccountProvisioner =
                (TestSSHAccountProvisioner) factory.createSSHAccountProvisioner("TestSSHAccountProvisioner", config);
