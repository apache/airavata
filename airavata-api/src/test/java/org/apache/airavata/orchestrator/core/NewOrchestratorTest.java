...
public class NewOrchestratorTest extends BaseOrchestratorTest {
    ...
    //                ExperimentModelUtil.createSimpleExperiment("default", "admin", "echoExperiment", "SimpleEcho0",
    // "SimpleEcho0", exInputs);
    //        simpleExperiment.setExperimentOutputs(exOut);
    //
    //        WorkflowNodeDetails test = ExperimentModelUtil.createWorkflowNode("test", null);
    //        ComputationalResourceScheduling scheduling =
    // ExperimentModelUtil.createComputationResourceScheduling("localhost", 1, 1, 1, "normal", 0, 0, 1, "sds128");
