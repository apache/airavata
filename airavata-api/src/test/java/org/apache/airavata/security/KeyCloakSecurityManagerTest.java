...
public class KeyCloakSecurityManagerTest {
        ...
        new Expectations() {
            {
                ...
                result = true;
                mockServerSettings.getApiServerHost();
                result = "localhost";
                minTimes = 0;
                mockServerSettings.getApiServerPort();
                result = "8970";
                minTimes = 0;
                mockServerSettings.getApiServerHost();
                result = "localhost";
    ...
    public void testDisallowedGatewayUserMethod(
            ...
            throws AiravataSecurityException, ApplicationSettingsException, IOException, TException {
    ...
    private void runGatewayUserMethodTest(
            ...
            throws IOException, ApplicationSettingsException, AiravataSecurityException, TException {
    ...
    private void createExpectationsForGatewayGroupsMembership(boolean isInAdminsGroup, boolean isInReadOnlyAdminsGroup)
            throws TException {

        new Expectations() {
            {
                mockRegistryServiceClient.isGatewayGroupsExists(TEST_GATEWAY);
                result = true;
                mockRegistryServiceClient.getGatewayGroups(TEST_GATEWAY);
                result = new GatewayGroups(
                        TEST_GATEWAY, "admins-group-id", "read-only-admins-group-id", "default-gateway-users-group-id");
                ...
                mockSharingRegistryServiceClient.getAllMemberGroupsForUser(
