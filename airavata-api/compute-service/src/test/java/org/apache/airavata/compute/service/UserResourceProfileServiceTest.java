...
class UserResourceProfileServiceTest {
    ...
    void registerUserResourceProfile_returnsId() throws Exception {
        UserResourceProfile profile =
                UserResourceProfile.newBuilder().setUserId("testUser").build();
    ...
    void addUserComputeResourcePreference_delegatesToRegistry() throws Exception {
        UserComputeResourcePreference pref = UserComputeResourcePreference.getDefaultInstance();
    ...
    void getAllUserComputeResourcePreferences_delegatesToRegistry() throws Exception {
        List<UserComputeResourcePreference> prefs = List.of(UserComputeResourcePreference.getDefaultInstance());
    ...
    void getAllUserResourceProfiles_delegatesToRegistry() throws Exception {
        List<UserResourceProfile> profiles = List.of(UserResourceProfile.getDefaultInstance());
    ...
    void getLatestQueueStatuses_delegatesToRegistry() throws Exception {
        List<QueueStatusModel> statuses = List.of(QueueStatusModel.getDefaultInstance());
    ...
    void addUserStoragePreference_delegatesToRegistry() throws Exception {
        UserStoragePreference pref = UserStoragePreference.getDefaultInstance();
