...
public class SlurmJobConfiguration implements JobManagerConfiguration {
    private final Map<Integer, String> jMCommands;
    ...
    public RawCommandInfo getCancelCommand(String jobID) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.DELETION.getNumber()).trim() + " " + jobID);
    }
    ...
    public RawCommandInfo getMonitorCommand(String jobID) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.JOB_MONITORING.getNumber()).trim() + " -j " + jobID);
    }
    ...
    public RawCommandInfo getSubmitCommand(String workingDirectory, String pbsFilePath) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.SUBMISSION.getNumber()).trim() + " " + workingDirectory
                + File.separator
    ...
    public RawCommandInfo getUserBasedMonitorCommand(String userName) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.JOB_MONITORING.getNumber()).trim() + " -u " + userName);
    }

    @Override
    public RawCommandInfo getJobIdMonitorCommand(String jobName, String userName) {
        return new RawCommandInfo(this.installedPath
                + jMCommands.get(JobManagerCommand.JOB_MONITORING.getNumber()).trim() + " -n " + jobName + " -u "
                + userName);
    }

    @Override
    public String getBaseCancelCommand() {
        return jMCommands.get(JobManagerCommand.DELETION.getNumber()).trim();
    }

    @Override
    public String getBaseMonitorCommand() {
        return jMCommands.get(JobManagerCommand.JOB_MONITORING.getNumber()).trim();
    }

    @Override
    public String getBaseSubmitCommand() {
        return jMCommands.get(JobManagerCommand.SUBMISSION.getNumber()).trim();
    }

    @Override
    public String getLivenessCheckCommand(String queueName, String projectNumber) {
        String command =
                jMCommands.get(JobManagerCommand.SHOW_CLUSTER_INFO.getNumber()).trim() + " --account"
