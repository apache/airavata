...
public class AWSProcessContextManager {
    ...
    private final RegistryHandler registryClient;
    ...
    public void saveInstanceId(String instanceId) throws Exception, IOException {
    ...
    public void saveSecurityGroupId(String securityGroupId) throws Exception, IOException {
    ...
    public void saveKeyPairName(String keyPairName) throws Exception, IOException {
    ...
    public void saveSSHCredentialToken(String credentialToken) throws Exception, IOException {
    ...
    public void savePublicIp(String publicIp) throws Exception, IOException {
    ...
    public void saveJobId(String jobId) throws Exception, IOException {
        updateContext(AWS_JOB_ID, jobId);
    }

    public void cleanup() throws Exception, IOException {
    ...
    private void updateContext(String key, String value) throws Exception, IOException {
        Map<String, String> contextMap = getContextMap();
        contextMap.put(key, value);
        ProcessModel processModel = taskContext.getProcessModel().toBuilder()
                .setProcessDetail(MAPPER.writeValueAsString(contextMap))
                .build();
