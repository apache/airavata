...
public class ComputeResourcePreferenceEntity implements Serializable {
    ...
    private List<Map<String, Object>> sshAccountProvisionerConfigurations;
    ...
    public List<Map<String, Object>> getSshAccountProvisionerConfigurations() {
        return sshAccountProvisionerConfigurations;
    }

    public void setSshAccountProvisionerConfigurations(List<Map<String, Object>> sshAccountProvisionerConfigurations) {
