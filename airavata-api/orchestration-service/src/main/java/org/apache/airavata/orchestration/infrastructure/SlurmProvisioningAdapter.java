...
public class SlurmProvisioningAdapter implements ProvisioningAdapter {

    private static final Logger LOGGER = LoggerFactory.getLogger(SlurmProvisioningAdapter.class);
