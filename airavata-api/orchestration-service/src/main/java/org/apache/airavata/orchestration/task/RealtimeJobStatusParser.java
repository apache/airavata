...
public class RealtimeJobStatusParser {
    ...
    private String getJobIdIdByJobNameWithRetry(String jobName, String taskId, RegistryHandler registryClient)
            throws Exception {
        for (int i = 0; i < 3; i++) {
    ...
    public JobStatusResult parse(String rawMessage, String publisherId, RegistryHandler registryClient) {

        try {
            Map<String, String> asMap = MAPPER.readValue(rawMessage, new TypeReference<Map<String, String>>() {});
                    ...
                    try {
                        ...
                        JobState jobState =
                                switch (status) {
                                    ...
                                    case "UNKNOWN" -> JobState.JOB_STATE_UNKNOWN;
