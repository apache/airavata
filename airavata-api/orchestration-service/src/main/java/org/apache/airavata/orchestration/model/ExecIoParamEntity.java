...
/**
 * Consolidated I/O parameter entity for process INPUT and OUTPUT params.
 */
@Entity
@Table(name = "EXEC_IO_PARAM")
public class ExecIoParamEntity implements Serializable {
    ...
    // Input-specific fields (null/default for outputs)
    ...
    // Output-specific fields (default for inputs)
