...
public class DataParsingTask extends AbstractTask {
    ...
    public TaskResult onRun(TaskHelper helper) {
        ...
        try {
            ...
            for (ParserInput parserInput : parser.getInputFilesList()) {
                ...
                if (filteredInputOptional.isPresent()) {
                    ...
                    if ("PROPERTY".equals(parsingTaskInput.getType())) {
                        ...
                        List<DataReplicaLocationModel> replicaLocations = inputDataProduct.getReplicaLocationsList();
            ...
            for (ParserOutput parserOutput : parser.getOutputFilesList()) {
    ...
    private StorageResourceAdaptor getStorageResourceAdaptor(String storageResourceId, AdaptorSupport adaptorSupport)
            throws TaskOnFailException, Exception, AgentException {
    ...
    private void uploadFileToStorageResource(
        ...
        try {
            ...
            DataReplicaLocationModel replicaLocationModel = DataReplicaLocationModel.newBuilder()
                    .setStorageResourceId(parsingTaskOutput.getStorageResourceId())
                    .setReplicaName("Parsing task output " + parsingTaskOutput.getId())
                    ...
                    .setFilePath(destinationURI.toString())
                    .build();

            DataProductModel dataProductModel = DataProductModel.newBuilder()
                    .setGatewayId(getGatewayId())
                    .setOwnerName("ParserTask")
                    .setProductName(parsingTaskOutput.getId())
                    .setDataProductType(DataProductType.FILE)
                    .addReplicaLocations(replicaLocationModel)
                    .build();
    ...
    private static RegistryHandler getRegistryServiceClient() {
