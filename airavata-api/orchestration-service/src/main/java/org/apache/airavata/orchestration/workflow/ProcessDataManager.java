...
import org.apache.airavata.compute.task.AWSProcessContextManager;
...
public class ProcessDataManager extends OutputDataStagingTask {
    ...
    public ProcessDataManager(RegistryServerHandler registryClient, String processId, AdaptorSupport adaptorSupport)
            throws Exception {

        this.adaptorSupport = adaptorSupport;
        try {
            process = registryClient.getProcess(processId);
            experiment = registryClient.getExperiment(process.getExperimentId());
