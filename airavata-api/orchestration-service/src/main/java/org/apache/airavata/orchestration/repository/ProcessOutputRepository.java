...
import org.apache.airavata.orchestration.model.ProcessOutputEntity;
import org.apache.airavata.orchestration.model.ProcessOutputPK;
...
public class ProcessOutputRepository
        extends AbstractRepository<OutputDataObjectType, ProcessOutputEntity, ProcessOutputPK> {
    private static final Logger logger = LoggerFactory.getLogger(ProcessOutputRepository.class);
    ...
    public void updateProcessOutputs(List<OutputDataObjectType> updatedProcessOutputs, String processId)
            throws RegistryException {
    ...
    public List<OutputDataObjectType> getProcessOutputs(String processId) throws RegistryException {
        ...
        return processModel.getProcessOutputsList();
    }
}
