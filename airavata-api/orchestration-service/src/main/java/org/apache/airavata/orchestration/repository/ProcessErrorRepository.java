...
import org.apache.airavata.orchestration.model.ProcessErrorEntity;
import org.apache.airavata.orchestration.model.ProcessErrorPK;
...
public class ProcessErrorRepository extends AbstractRepository<ErrorModel, ProcessErrorEntity, ProcessErrorPK> {
    ...
    public List<ErrorModel> getProcessError(String processId) throws RegistryException {
        ...
        return processModel.getProcessErrorsList();
    }
}
