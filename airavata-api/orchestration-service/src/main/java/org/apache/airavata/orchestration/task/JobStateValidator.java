...
import static org.apache.airavata.model.status.proto.JobState.JOB_STATE_UNKNOWN;
import static org.apache.airavata.model.status.proto.JobState.NON_CRITICAL_FAIL;
...
public class JobStateValidator {
    ...
    public static boolean isValid(JobState previousState, JobState newState) {
        if (previousState == null && newState != null) {
            ...
            return jobStateMachine[previousState.getNumber()][newState.getNumber()];
        } else {
            return false;
        }
    }
