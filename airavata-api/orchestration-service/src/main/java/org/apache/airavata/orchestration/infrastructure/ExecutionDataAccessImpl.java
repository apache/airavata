...
import org.apache.airavata.orchestration.model.ComputationalResourceSchedulingEntity;
...
public class ExecutionDataAccessImpl implements ExecutionDataAccess {
    ...
    private final ProcessOutputRepository processOutputRepository = new ProcessOutputRepository();
    private final ProcessStatusRepository processStatusRepository = new ProcessStatusRepository();
    private final ProcessErrorRepository processErrorRepository = new ProcessErrorRepository();
    private final ProcessWorkflowRepository processWorkflowRepository = new ProcessWorkflowRepository();
    private final JobRepository jobRepository = new JobRepository();
    private final JobStatusRepository jobStatusRepository = new JobStatusRepository();
    private final TaskRepository taskRepository = new TaskRepository();
    private final TaskStatusRepository taskStatusRepository = new TaskStatusRepository();
    private final TaskErrorRepository taskErrorRepository = new TaskErrorRepository();
    ...
    public List<ProcessStatus> getProcessStatusList(ProcessState processState, int offset, int limit)
            throws RegistryException {
        return processStatusRepository.getProcessStatusList(processState, offset, limit);
    }
    ...
    public void addProcessError(ErrorModel processError, String processId) throws RegistryException {
        processErrorRepository.addProcessError(processError, processId);
    }
    ...
    public void addProcessOutputs(List<OutputDataObjectType> outputs, String processId) throws RegistryException {
        processOutputRepository.addProcessOutputs(outputs, processId);
    }
    ...
    public void addTaskError(ErrorModel taskError, String taskId) throws RegistryException {
        taskErrorRepository.addTaskError(taskError, taskId);
    }
    ...
    public List<JobStatus> getDistinctListofJobStatus(String gatewayId, String status, double time) {
        return jobStatusRepository.getDistinctListofJobStatus(gatewayId, status, time);
    }
    ...
    @Override
    public String registerWorkflow(AiravataWorkflow workflow, String experimentId) throws RegistryException {
        return workflowRepository.registerWorkflow(workflow, experimentId);
    }

    @Override
    public void updateWorkflow(String workflowId, AiravataWorkflow workflow) throws RegistryException {
