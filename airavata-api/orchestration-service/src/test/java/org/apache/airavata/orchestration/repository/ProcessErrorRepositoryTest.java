...
import org.apache.airavata.orchestration.util.ExperimentTestHelper;
import org.apache.airavata.orchestration.util.ProjectTestHelper;
...
public class ProcessErrorRepositoryTest extends TestBase {
    ...
    public void ProcessErrorRepositoryTest() throws RegistryException {
        ...
        assertTrue(
                processRepository.getProcess(processId).getProcessErrorsList().size() == 1);
