...
class Airavata_getJobDetails_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "79AB5674F5BE03F7F45DC53B2929CCF6";
  static const uint8_t binary_fingerprint[16]; // = {0x79,0xAB,0x56,0x74,0xF5,0xBE,0x03,0xF7,0xF4,0x5D,0xC5,0x3B,0x29,0x29,0xCC,0xF6};
