...
const char* DataResourceModel::ascii_fingerprint = "D5DA3E73B8DC95CEEC001FBC59F3A6B6";
const uint8_t DataResourceModel::binary_fingerprint[16] = {0xD5,0xDA,0x3E,0x73,0xB8,0xDC,0x95,0xCE,0xEC,0x00,0x1F,0xBC,0x59,0xF3,0xA6,0xB6};
...
const char* DataReplicaLocationModel::ascii_fingerprint = "8A58EB7AD049771F47F731755ACCBE98";
const uint8_t DataReplicaLocationModel::binary_fingerprint[16] = {0x8A,0x58,0xEB,0x7A,0xD0,0x49,0x77,0x1F,0x47,0xF7,0x31,0x75,0x5A,0xCC,0xBE,0x98};
...
std::ostream& operator<<(std::ostream& out, const DataReplicaLocationModel& obj) {
  ...
  out << ", " << "storageResourceHostName="; (obj.__isset.storageResourceHostName ? (out << to_string(obj.storageResourceHostName)) : (out << "<null>"));
  out << ", " << "dataMovementProtocol="; (obj.__isset.dataMovementProtocol ? (out << to_string(obj.dataMovementProtocol)) : (out << "<null>"));
  out << ", " << "hostPort="; (obj.__isset.hostPort ? (out << to_string(obj.hostPort)) : (out << "<null>"));
  out << ", " << "filePath="; (obj.__isset.filePath ? (out << to_string(obj.filePath)) : (out << "<null>"));
  out << ", " << "replicaUrl="; (obj.__isset.replicaUrl ? (out << to_string(obj.replicaUrl)) : (out << "<null>"));
