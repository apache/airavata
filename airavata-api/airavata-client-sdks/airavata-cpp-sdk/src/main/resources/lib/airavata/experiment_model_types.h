...
class ExperimentModel {
 public:
  ...
  static const char* ascii_fingerprint; // = "24797EBC0AAED86B273BC8D2768E5A7B";
  static const uint8_t binary_fingerprint[16]; // = {0x24,0x79,0x7E,0xBC,0x0A,0xAE,0xD8,0x6B,0x27,0x3B,0xC8,0xD2,0x76,0x8E,0x5A,0x7B};
