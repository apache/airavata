...
uint32_t Airavata_getJobDetails_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector< ::apache::airavata::model::workspace::experiment::JobDetails> ::const_iterator _iter142;
...
uint32_t Airavata_getDataTransferDetails_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector< ::apache::airavata::model::workspace::experiment::DataTransferDetails> ::const_iterator _iter153;
...
uint32_t Airavata_getLocalJobSubmission_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("jobSubmissionId", ::apache::thrift::protocol::T_STRING, 1);
...
uint32_t Airavata_getLocalDataMovement_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("dataMovementId", ::apache::thrift::protocol::T_STRING, 1);
...
void AiravataClient::recv_searchExperimentsByStatus(std::vector< ::apache::airavata::model::workspace::experiment::ExperimentSummary> & _return)
{
  ...
  if (fname.compare("searchExperimentsByStatus") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Airavata_searchExperimentsByStatus_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void AiravataClient::getJobDetails(std::vector< ::apache::airavata::model::workspace::experiment::JobDetails> & _return, const std::string& airavataExperimentId)
{
  send_getJobDetails(airavataExperimentId);
  recv_getJobDetails(_return);
}

void AiravataClient::send_getJobDetails(const std::string& airavataExperimentId)
{
  int32_t cseqid = 0;
...
void AiravataClient::recv_getJobDetails(std::vector< ::apache::airavata::model::workspace::experiment::JobDetails> & _return)
{
...
void AiravataClient::getDataTransferDetails(std::vector< ::apache::airavata::model::workspace::experiment::DataTransferDetails> & _return, const std::string& airavataExperimentId)
{
  send_getDataTransferDetails(airavataExperimentId);
  recv_getDataTransferDetails(_return);
}

void AiravataClient::send_getDataTransferDetails(const std::string& airavataExperimentId)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("getDataTransferDetails", ::apache::thrift::protocol::T_CALL, cseqid);

  Airavata_getDataTransferDetails_pargs args;
  args.airavataExperimentId = &airavataExperimentId;
  args.write(oprot_);
...
void AiravataClient::recv_getDataTransferDetails(std::vector< ::apache::airavata::model::workspace::experiment::DataTransferDetails> & _return)
{
  ...
  if (fname.compare("getDataTransferDetails") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Airavata_getDataTransferDetails_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "getDataTransferDetails failed: unknown result");
}
...
void AiravataClient::getLocalJobSubmission( ::apache::airavata::model::appcatalog::computeresource::LOCALSubmission& _return, const std::string& jobSubmissionId)
{
  send_getLocalJobSubmission(jobSubmissionId);
  recv_getLocalJobSubmission(_return);
}

void AiravataClient::send_getLocalJobSubmission(const std::string& jobSubmissionId)
{
  int32_t cseqid = 0;
...
void AiravataClient::getSSHJobSubmission( ::apache::airavata::model::appcatalog::computeresource::SSHJobSubmission& _return, const std::string& jobSubmissionId)
{
  send_getSSHJobSubmission(jobSubmissionId);
  recv_getSSHJobSubmission(_return);
}

void AiravataClient::send_getSSHJobSubmission(const std::string& jobSubmissionId)
{
  int32_t cseqid = 0;
...
void AiravataClient::getUnicoreJobSubmission( ::apache::airavata::model::appcatalog::computeresource::UnicoreJobSubmission& _return, const std::string& jobSubmissionId)
{
  send_getUnicoreJobSubmission(jobSubmissionId);
  recv_getUnicoreJobSubmission(_return);
}

void AiravataClient::send_getUnicoreJobSubmission(const std::string& jobSubmissionId)
{
  int32_t cseqid = 0;
...
void AiravataClient::getCloudJobSubmission( ::apache::airavata::model::appcatalog::computeresource::CloudJobSubmission& _return, const std::string& jobSubmissionId)
{
  send_getCloudJobSubmission(jobSubmissionId);
  recv_getCloudJobSubmission(_return);
}

void AiravataClient::send_getCloudJobSubmission(const std::string& jobSubmissionId)
{
  int32_t cseqid = 0;
...
void AiravataClient::getLocalDataMovement( ::apache::airavata::model::appcatalog::computeresource::LOCALDataMovement& _return, const std::string& dataMovementId)
{
  send_getLocalDataMovement(dataMovementId);
  recv_getLocalDataMovement(_return);
}

void AiravataClient::send_getLocalDataMovement(const std::string& dataMovementId)
{
  int32_t cseqid = 0;
...
void AiravataClient::getSCPDataMovement( ::apache::airavata::model::appcatalog::computeresource::SCPDataMovement& _return, const std::string& dataMovementId)
{
  send_getSCPDataMovement(dataMovementId);
  recv_getSCPDataMovement(_return);
}

void AiravataClient::send_getSCPDataMovement(const std::string& dataMovementId)
{
  int32_t cseqid = 0;
...
void AiravataClient::getGridFTPDataMovement( ::apache::airavata::model::appcatalog::computeresource::GridFTPDataMovement& _return, const std::string& dataMovementId)
{
  send_getGridFTPDataMovement(dataMovementId);
  recv_getGridFTPDataMovement(_return);
}

void AiravataClient::send_getGridFTPDataMovement(const std::string& dataMovementId)
{
  int32_t cseqid = 0;
...
void AiravataProcessor::process_searchExperimentsByStatus(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Airavata.searchExperimentsByStatus", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Airavata.searchExperimentsByStatus");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Airavata.searchExperimentsByStatus");
  }

  Airavata_searchExperimentsByStatus_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Airavata.searchExperimentsByStatus", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Airavata.searchExperimentsByStatus");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("searchExperimentsByStatus", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Airavata.searchExperimentsByStatus");
  }

  oprot->writeMessageBegin("searchExperimentsByStatus", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Airavata.searchExperimentsByStatus", bytes);
  }
}
...
void AiravataProcessor::process_getJobDetails(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getJobDetails(result.success, args.airavataExperimentId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getDataTransferDetails(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Airavata.getDataTransferDetails", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Airavata.getDataTransferDetails");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Airavata.getDataTransferDetails");
  }

  Airavata_getDataTransferDetails_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Airavata.getDataTransferDetails", bytes);
  }

  Airavata_getDataTransferDetails_result result;
  try {
    iface_->getDataTransferDetails(result.success, args.airavataExperimentId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Airavata.getDataTransferDetails");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("getDataTransferDetails", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Airavata.getDataTransferDetails");
  }

  oprot->writeMessageBegin("getDataTransferDetails", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Airavata.getDataTransferDetails", bytes);
  }
}
...
void AiravataProcessor::process_getLocalJobSubmission(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getLocalJobSubmission(result.success, args.jobSubmissionId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getSSHJobSubmission(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getSSHJobSubmission(result.success, args.jobSubmissionId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getUnicoreJobSubmission(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getUnicoreJobSubmission(result.success, args.jobSubmissionId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getCloudJobSubmission(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getCloudJobSubmission(result.success, args.jobSubmissionId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getLocalDataMovement(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getLocalDataMovement(result.success, args.dataMovementId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getSCPDataMovement(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getSCPDataMovement(result.success, args.dataMovementId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
...
void AiravataProcessor::process_getGridFTPDataMovement(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getGridFTPDataMovement(result.success, args.dataMovementId);
    result.__isset.success = true;
  } catch ( ::apache::airavata::api::error::InvalidRequestException &ire) {
    result.ire = ire;
    result.__isset.ire = true;
