...
typedef struct _DataResourceModel__isset {
  _DataResourceModel__isset() : resourceId(false), gatewayId(false), resourceName(false), resourceDescription(false), ownerName(false), resourceSize(false), creationTime(false), lastModifiedTime(false), resourceMetadata(false), dataReplicaLocations(false) {}
  bool resourceId :1;
  bool gatewayId :1;
  bool resourceName :1;
...
class DataResourceModel {
 public:
  ...
  static const char* ascii_fingerprint; // = "B62C7AC0978F39C377296FFA824B5766";
  static const uint8_t binary_fingerprint[16]; // = {0xB6,0x2C,0x7A,0xC0,0x97,0x8F,0x39,0xC3,0x77,0x29,0x6F,0xFA,0x82,0x4B,0x57,0x66};

  DataResourceModel(const DataResourceModel&);
  DataResourceModel& operator=(const DataResourceModel&);
  DataResourceModel() : resourceId(), gatewayId(), resourceName(), resourceDescription(), ownerName(), resourceSize(0), creationTime(0), lastModifiedTime(0) {
  }
