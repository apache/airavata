...
def register_application_module(airavataClient,authz_token,gatewayID,appModuleObj):
    appModuleId = airavataClient.registerApplicationModule(authz_token,gatewayID,appModuleObj)
    return appModuleId

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description ="Register application module")
    parser.add_argument('appModuleName',type=str, help= "Application Module name")
    ...
    appModuleObj.appModuleName = args.appModuleName
   
    appModuleId = register_application_module(airavataClient,authz_token,gatewayID,appModuleObj)

    
    print 'Application modules registered , ID: ', appModuleId
