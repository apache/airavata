...
class ExperimentStatusChangeEvent(object):
    ...
    def __init__(self, state: airavata.model.status.ttypes.ExperimentState = None, experimentId: str = None, gatewayId: str = None,):
        self.state: airavata.model.status.ttypes.ExperimentState = state
        self.experimentId: str = experimentId
        self.gatewayId: str = gatewayId

    def __setattr__(self, name, value):
        if name == "state":
            super().__setattr__(name, value if hasattr(value, 'value') else airavata.model.status.ttypes.ExperimentState.__members__.get(value))
            return
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I32:
                    self.state = airavata.model.status.ttypes.ExperimentState(iprot.readI32())
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class ProcessIdentifier(object):
    ...
    def __init__(self, processId: str = None, experimentId: str = None, gatewayId: str = None,):
...
class TaskIdentifier(object):
    ...
    def __init__(self, taskId: str = None, processId: str = None, experimentId: str = None, gatewayId: str = None,):
...
class TaskStatusChangeEvent(object):
    ...
    def __init__(self, state: airavata.model.status.ttypes.TaskState = None, taskIdentity: TaskIdentifier = None,):
        self.state: airavata.model.status.ttypes.TaskState = state
        self.taskIdentity: TaskIdentifier = taskIdentity

    def __setattr__(self, name, value):
        if name == "state":
            super().__setattr__(name, value if hasattr(value, 'value') else airavata.model.status.ttypes.TaskState.__members__.get(value))
            return
        super().__setattr__(name, value)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I32:
                    self.state = airavata.model.status.ttypes.TaskState(iprot.readI32())
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class ProcessStatusChangeEvent(object):
    ...
    def __init__(self, state: airavata.model.status.ttypes.ProcessState = None, processIdentity: ProcessIdentifier = None,):
        self.state: airavata.model.status.ttypes.ProcessState = state
        self.processIdentity: ProcessIdentifier = processIdentity

    def __setattr__(self, name, value):
        if name == "state":
            super().__setattr__(name, value if hasattr(value, 'value') else airavata.model.status.ttypes.ProcessState.__members__.get(value))
            return
        super().__setattr__(name, value)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I32:
                    self.state = airavata.model.status.ttypes.ProcessState(iprot.readI32())
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
...
class TaskOutputChangeEvent(object):
    ...
    def __init__(self, output: list[airavata.model.application.io.ttypes.OutputDataObjectType] = None, taskIdentity: TaskIdentifier = None,):
        self.output: list[airavata.model.application.io.ttypes.OutputDataObjectType] = output
        self.taskIdentity: TaskIdentifier = taskIdentity
...
class JobIdentifier(object):
    ...
    def __init__(self, jobId: str = None, taskId: str = None, processId: str = None, experimentId: str = None, gatewayId: str = None,):
...
class ExperimentSubmitEvent(object):
    ...
    def __init__(self, experimentId: str = None, gatewayId: str = None,):
        self.experimentId: str = experimentId
        self.gatewayId: str = gatewayId
...
class ProcessSubmitEvent(object):
    ...
    def __init__(self, processId: str = None, gatewayId: str = None, experimentId: str = None, tokenId: str = None,):
        self.processId: str = processId
        self.gatewayId: str = gatewayId
        self.experimentId: str = experimentId
...
class ProcessTerminateEvent(object):
    ...
    def __init__(self, processId: str = None, gatewayId: str = None, tokenId: str = None,):
        self.processId: str = processId
        self.gatewayId: str = gatewayId
        self.tokenId: str = tokenId
...
class JobStatusChangeEvent(object):
    ...
    def __init__(self, state: airavata.model.status.ttypes.JobState = None, jobIdentity: JobIdentifier = None,):
        self.state: airavata.model.status.ttypes.JobState = state
        self.jobIdentity: JobIdentifier = jobIdentity

    def __setattr__(self, name, value):
        if name == "state":
            super().__setattr__(name, value if hasattr(value, 'value') else airavata.model.status.ttypes.JobState.__members__.get(value))
            return
        super().__setattr__(name, value)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I32:
                    self.state = airavata.model.status.ttypes.JobState(iprot.readI32())
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
...
class ExperimentIntermediateOutputsEvent(object):
    ...
    def __init__(self, experimentId: str = None, gatewayId: str = None, outputNames: list[str] = None,):
        self.experimentId: str = experimentId
        self.gatewayId: str = gatewayId
...
class Message(object):
    ...
    def __init__(self, event: bytes = None, messageId: str = "DO_NOT_SET_AT_CLIENTS", messageType: MessageType = None, updatedTime: typing.Optional[int] = None, messageLevel: typing.Optional[MessageLevel] = None,):
        ...
        self.messageLevel: typing.Optional[MessageLevel] = messageLevel

    def __setattr__(self, name, value):
        if name == "messageType":
            super().__setattr__(name, value if hasattr(value, 'value') else MessageType.__members__.get(value))
            return
        if name == "messageLevel":
            super().__setattr__(name, value if hasattr(value, 'value') else MessageLevel.__members__.get(value))
            return
        super().__setattr__(name, value)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.messageType = MessageType(iprot.readI32())
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I64:
                ...
                if ftype == TType.I32:
                    self.messageLevel = MessageLevel(iprot.readI32())
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.messageType is not None:
            ...
            oprot.writeI32(self.messageType.value)
            oprot.writeFieldEnd()
        ...
        if self.messageLevel is not None:
            ...
            oprot.writeI32(self.messageLevel.value)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
