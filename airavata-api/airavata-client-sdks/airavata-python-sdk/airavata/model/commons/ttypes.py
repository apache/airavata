...
class ErrorModel(object):
    ...
    def __init__(self, errorId: str = "DO_NOT_SET_AT_CLIENTS", creationTime: typing.Optional[int] = None, actualErrorMessage: typing.Optional[str] = None, userFriendlyMessage: typing.Optional[str] = None, transientOrPersistent: typing.Optional[bool] = False, rootCauseErrorIdList: typing.Optional[list[str]] = None,):
        self.errorId: str = errorId
        self.creationTime: typing.Optional[int] = creationTime
        self.actualErrorMessage: typing.Optional[str] = actualErrorMessage
        self.userFriendlyMessage: typing.Optional[str] = userFriendlyMessage
        self.transientOrPersistent: typing.Optional[bool] = transientOrPersistent
        self.rootCauseErrorIdList: typing.Optional[list[str]] = rootCauseErrorIdList
