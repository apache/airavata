...
class ParserInput(object):
    ...
    def __init__(self, id: str = None, name: str = None, requiredInput: bool = None, parserId: str = None, type: IOType = None,):
        self.id: str = id
        self.name: str = name
        self.requiredInput: bool = requiredInput
        self.parserId: str = parserId
        self.type: IOType = type

    def __setattr__(self, name, value):
        if name == "type":
            super().__setattr__(name, value if hasattr(value, 'value') else IOType.__members__.get(value))
            return
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.type = IOType(iprot.readI32())
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class ParserOutput(object):
    ...
    def __init__(self, id: str = None, name: str = None, requiredOutput: bool = None, parserId: str = None, type: IOType = None,):
        self.id: str = id
        self.name: str = name
        self.requiredOutput: bool = requiredOutput
        self.parserId: str = parserId
        self.type: IOType = type
...
class Parser(object):
    ...
    def __init__(self, id: str = None, imageName: str = None, outputDirPath: str = None, inputDirPath: str = None, executionCommand: str = None, inputFiles: list[ParserInput] = None, outputFiles: list[ParserOutput] = None, gatewayId: str = None,):
        self.id: str = id
        self.imageName: str = imageName
        self.outputDirPath: str = outputDirPath
        self.inputDirPath: str = inputDirPath
        self.executionCommand: str = executionCommand
        self.inputFiles: list[ParserInput] = inputFiles
        self.outputFiles: list[ParserOutput] = outputFiles
...
class ParserConnectorInput(object):
    ...
    def __init__(self, id: str = None, inputId: str = None, parentOutputId: typing.Optional[str] = None, value: typing.Optional[str] = None, parserConnectorId: str = None,):
        self.id: str = id
        self.inputId: str = inputId
        self.parentOutputId: typing.Optional[str] = parentOutputId
        self.value: typing.Optional[str] = value
        self.parserConnectorId: str = parserConnectorId
...
class ParserConnector(object):
    ...
    def __init__(self, id: str = None, parentParserId: str = None, childParserId: str = None, connectorInputs: list[ParserConnectorInput] = None, parsingTemplateId: str = None,):
        self.id: str = id
        self.parentParserId: str = parentParserId
        self.childParserId: str = childParserId
        self.connectorInputs: list[ParserConnectorInput] = connectorInputs
        self.parsingTemplateId: str = parsingTemplateId
...
class ParsingTemplateInput(object):
    ...
    def __init__(self, id: str = None, targetInputId: str = None, applicationOutputName: typing.Optional[str] = None, value: typing.Optional[str] = None, parsingTemplateId: str = None,):
        self.id: str = id
        self.targetInputId: str = targetInputId
        self.applicationOutputName: typing.Optional[str] = applicationOutputName
        self.value: typing.Optional[str] = value
        self.parsingTemplateId: str = parsingTemplateId
...
class ParsingTemplate(object):
    ...
    def __init__(self, id: str = None, applicationInterface: str = None, initialInputs: list[ParsingTemplateInput] = None, parserConnections: list[ParserConnector] = None, gatewayId: str = None,):
        self.id: str = id
        self.applicationInterface: str = applicationInterface
        self.initialInputs: list[ParsingTemplateInput] = initialInputs
        self.parserConnections: list[ParserConnector] = parserConnections
        self.gatewayId: str = gatewayId
