...
class Iface(airavata.base.api.BaseAPI.Iface):
    def createGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupModel: airavata.model.group.ttypes.GroupModel) -> str:
        """
        Parameters:
         - authzToken
         - groupModel
    ...
    def updateGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupModel: airavata.model.group.ttypes.GroupModel) -> bool:
        """
        Parameters:
         - authzToken
         - groupModel
    ...
    def deleteGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, ownerId: str) -> bool:
        """
        Parameters:
         - authzToken
         - groupId
    ...
    def getGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str) -> airavata.model.group.ttypes.GroupModel:
        """
        Parameters:
         - authzToken
         - groupId
    ...
    def getGroups(self, authzToken: airavata.model.security.ttypes.AuthzToken) -> list[airavata.model.group.ttypes.GroupModel]:
        """
        Parameters:
         - authzToken
    ...
    def getAllGroupsUserBelongs(self, authzToken: airavata.model.security.ttypes.AuthzToken, userName: str) -> list[airavata.model.group.ttypes.GroupModel]:
        """
        Parameters:
         - authzToken
         - userName
    ...
    def addUsersToGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, userIds: list[str], groupId: str) -> bool:
        """
        Parameters:
         - authzToken
         - userIds
    ...
    def removeUsersFromGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, userIds: list[str], groupId: str) -> bool:
        """
        Parameters:
         - authzToken
         - userIds
    ...
    def transferGroupOwnership(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, newOwnerId: str) -> bool:
        """
        Parameters:
         - authzToken
         - groupId
    ...
    def addGroupAdmins(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, adminIds: list[str]) -> bool:
        """
        Parameters:
         - authzToken
         - groupId
    ...
    def removeGroupAdmins(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, adminIds: list[str]) -> bool:
        """
        Parameters:
         - authzToken
         - groupId
    ...
    def hasAdminAccess(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, adminId: str) -> bool:
        """
        Parameters:
         - authzToken
         - groupId
    ...
    def hasOwnerAccess(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, ownerId: str) -> bool:
        """
        Parameters:
         - authzToken
         - groupId
...
class Client(airavata.base.api.BaseAPI.Client, Iface):
    ...
    def send_createGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupModel: airavata.model.group.ttypes.GroupModel):
    ...
    def send_updateGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupModel: airavata.model.group.ttypes.GroupModel):
    ...
    def send_deleteGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, ownerId: str):
    ...
    def send_getGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str):
    ...
    def recv_getGroup(self) -> airavata.model.group.ttypes.GroupModel:
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def send_getGroups(self, authzToken: airavata.model.security.ttypes.AuthzToken):
    ...
    def recv_getGroups(self) -> list[airavata.model.group.ttypes.GroupModel]:
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def send_getAllGroupsUserBelongs(self, authzToken: airavata.model.security.ttypes.AuthzToken, userName: str):
    ...
    def recv_getAllGroupsUserBelongs(self) -> list[airavata.model.group.ttypes.GroupModel]:
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def send_addUsersToGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, userIds: list[str], groupId: str):
    ...
    def send_removeUsersFromGroup(self, authzToken: airavata.model.security.ttypes.AuthzToken, userIds: list[str], groupId: str):
    ...
    def send_transferGroupOwnership(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, newOwnerId: str):
    ...
    def send_addGroupAdmins(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, adminIds: list[str]):
    ...
    def send_removeGroupAdmins(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, adminIds: list[str]):
    ...
    def send_hasAdminAccess(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, adminId: str):
    ...
    def send_hasOwnerAccess(self, authzToken: airavata.model.security.ttypes.AuthzToken, groupId: str, ownerId: str):
...
class createGroup_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, groupModel: airavata.model.group.ttypes.GroupModel = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
        self.groupModel: airavata.model.group.ttypes.GroupModel = groupModel
...
class createGroup_result(object):
    ...
    def __init__(self, success: typing.Optional[str] = None, gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = None, ae: typing.Optional[airavata.api.error.ttypes.AuthorizationException] = None,):
        self.success: typing.Optional[str] = success
        self.gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = gse
...
class updateGroup_result(object):
    ...
    def __init__(self, success: typing.Optional[bool] = None, gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = None, ae: typing.Optional[airavata.api.error.ttypes.AuthorizationException] = None,):
...
class deleteGroup_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, groupId: str = None, ownerId: str = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
...
class getGroup_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, groupId: str = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
        self.groupId: str = groupId
...
class getGroup_result(object):
    ...
    def __init__(self, success: typing.Optional[airavata.model.group.ttypes.GroupModel] = None, gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = None, ae: typing.Optional[airavata.api.error.ttypes.AuthorizationException] = None,):
        self.success: typing.Optional[airavata.model.group.ttypes.GroupModel] = success
        self.gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = gse
        self.ae: typing.Optional[airavata.api.error.ttypes.AuthorizationException] = ae
...
class getGroups_result(object):
    ...
    def __init__(self, success: typing.Optional[list[airavata.model.group.ttypes.GroupModel]] = None, gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = None, ae: typing.Optional[airavata.api.error.ttypes.AuthorizationException] = None,):
        self.success: typing.Optional[list[airavata.model.group.ttypes.GroupModel]] = success
        self.gse: typing.Optional[airavata.service.profile.groupmanager.cpi.error.ttypes.GroupManagerServiceException] = gse
        self.ae: typing.Optional[airavata.api.error.ttypes.AuthorizationException] = ae
...
class addUsersToGroup_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, userIds: list[str] = None, groupId: str = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
...
class transferGroupOwnership_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, groupId: str = None, newOwnerId: str = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
        self.groupId: str = groupId
...
class addGroupAdmins_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, groupId: str = None, adminIds: list[str] = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
        self.groupId: str = groupId
...
class hasAdminAccess_args(object):
    ...
    def __init__(self, authzToken: airavata.model.security.ttypes.AuthzToken = None, groupId: str = None, adminId: str = None,):
        self.authzToken: airavata.model.security.ttypes.AuthzToken = authzToken
        self.groupId: str = groupId
