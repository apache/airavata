...
Integrate With Your Clients
   ...
   - [api_server_client](clients/api_server_client.py)
      ...
      - create_notification( authz_token, notification)
      ...
      - create_project( authz_token, gateway_id, project)
      ...
      - create_experiment( authz_token, gateway_id, experiment)
      ...
      - update_experiment_configuration( authz_token, airavata_experiment_id, user_configuration)
      - update_resource_scheduling( authz_token, airavata_experiment_id, resource_scheduling)
      ...
      - update_application_module( authz_token, app_module_id, application_module)
      ...
      - register_application_deployment( authz_token, gateway_id, application_deployment)
      ...
      - get_accessible_application_deployments( authz_token, gateway_id, permission_type)
      ...
      - register_application_interface( authz_token, gateway_id, application_interface)
      ...
      - register_compute_resource( authz_token, compute_resource_description)
      ...
      - register_storage_resource( authz_token, storage_resource_description)
      ...
      - add_local_submission_details( authz_token, compute_resource_id, priority_order, local_submission)
      ...
      - add_ssh_job_submission_details( authz_token, compute_resource_id, priority_order, ssh_job_submission)
      ...
      - add_cloud_job_submission_details( authz_token, compute_resource_id, priority_order, cloud_submission)
      - get_cloud_job_submission( authz_token, job_submission_id)
      - update_ssh_job_submission_details( authz_token, job_submission_interface_id, ssh_job_submission)
      - update_cloud_job_submission_details( authz_token, job_submission_interface_id, ssh_job_submission)
      - update_unicore_job_submission_details( authz_token, job_submission_interface_id, unicore_job_submission)
      ...
      - add_scp_data_movement_details( authz_token, product_uri, data_move_type, priority_order,scp_data_movement)
      ...
      - delete_job_submission_interface( authz_token, compute_resource_id, job_submission_interface_id)
      - delete_data_movement_interface( authz_token, product_uri, data_movement_interface_id, data_move_type)
      - register_resource_job_manager( authz_token, resource_job_manager)
      ...
      - update_gateway_storage_preference( authz_token, gateway_id, storage_id, storage_preference)
      ...
      - register_data_product( authz_token, data_product_model)
      - get_data_product( authz_token, data_product_uri)
      - register_replica_location( authz_token, replica_location_model)
      ...
      - user_has_access( authz_token, resource_id, permission_type)
   ...
   - [user_profile_client](clients/user_profile_client.py)
       ...
       - add_user_profile( authz_token, user_profile)
