...
public class CreateProject{	
    ...
    public static String createProject(String projName, String owner, String description) {
        ...
        Project project = ProjectModelUtil.createProject(projName, owner, description);
        String projId = "";
        try {
			projId = client.createProject(project);
    ...
    public static void main(String[] args) {
    	if(args.length!=3){
    		System.out.println("Inputs required: projectName Owner Description");
    		return;
    	}
    	readConfigFile();
    	...
    	String projId = createProject(projName, owner, description);
    	if(projId!=""){
    		System.out.println("Project with id : "+ projId + " created.");
    	}
    	else{
