<?php
namespace Airavata\Model\Replica;
...
class DataResourceModel {
  ...
  /**
   * @var \Airavata\Model\Replica\DataReplicaLocationModel[]
   */
  public $replicaLocations = null;
  /**
   * @var \Airavata\Model\Replica\DataResourceModel[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        14 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Airavata\Model\Replica\DataReplicaLocationModel',
            ),
          ),
        15 => array(
          'var' => 'childResources',
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Airavata\Model\Replica\DataResourceModel',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 14:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Airavata\Model\Replica\DataReplicaLocationModel();
        ...
        case 15:
          if ($ftype == TType::LST) {
            ...
            {
              $elem18 = null;
              $elem18 = new \Airavata\Model\Replica\DataResourceModel();
