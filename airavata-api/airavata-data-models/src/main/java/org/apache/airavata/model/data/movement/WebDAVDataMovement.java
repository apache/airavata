...
public class WebDAVDataMovement implements org.apache.thrift.TBase<WebDAVDataMovement, WebDAVDataMovement._Fields>, java.io.Serializable, Cloneable, Comparable<WebDAVDataMovement> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WebDAVDataMovement");
  ...
  private static final org.apache.thrift.protocol.TField WEB_DAV_HOST_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("webDavHostName", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new WebDAVDataMovementStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new WebDAVDataMovementTupleSchemeFactory();

  private java.lang.String dataMovementInterfaceId; // required
  private SecurityProtocol securityProtocol; // required
  private java.lang.String webDavHostName; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WEB_DAV_HOST_NAME((short)3, "webDavHostName"),
    PORT((short)4, "port");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // WEB_DAV_HOST_NAME
          return WEB_DAV_HOST_NAME;
        case 4: // PORT
          return PORT;
        default:
          return null;
  ...
  private static final _Fields optionals[] = {_Fields.WEB_DAV_HOST_NAME,_Fields.PORT};
  ...
  static {
    ...
    tmpMap.put(_Fields.WEB_DAV_HOST_NAME, new org.apache.thrift.meta_data.FieldMetaData("webDavHostName", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WebDAVDataMovement.class, metaDataMap);
  }

  public WebDAVDataMovement() {
   ...
   */
  public WebDAVDataMovement(WebDAVDataMovement other) {
    ...
    if (other.isSetWebDavHostName()) {
      this.webDavHostName = other.webDavHostName;
    }
    this.port = other.port;
  }

  public WebDAVDataMovement deepCopy() {
    return new WebDAVDataMovement(this);
  }
  ...
  public java.lang.String getWebDavHostName() {
    return this.webDavHostName;
  }

  public void setWebDavHostName(java.lang.String webDavHostName) {
    this.webDavHostName = webDavHostName;
  }

  public void unsetWebDavHostName() {
    this.webDavHostName = null;
  }

  /** Returns true if field webDavHostName is set (has been assigned a value) and false otherwise */
  public boolean isSetWebDavHostName() {
    return this.webDavHostName != null;
  }

  public void setWebDavHostNameIsSet(boolean value) {
    if (!value) {
      this.webDavHostName = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case WEB_DAV_HOST_NAME:
      if (value == null) {
        unsetWebDavHostName();
      } else {
        setWebDavHostName((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof WebDAVDataMovement)
      return this.equals((WebDAVDataMovement)that);
    return false;
  }

  public boolean equals(WebDAVDataMovement that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_webDavHostName = true && this.isSetWebDavHostName();
    boolean that_present_webDavHostName = true && that.isSetWebDavHostName();
    if (this_present_webDavHostName || that_present_webDavHostName) {
      if (!(this_present_webDavHostName && that_present_webDavHostName))
        return false;
      if (!this.webDavHostName.equals(that.webDavHostName))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetWebDavHostName()) ? 131071 : 524287);
    if (isSetWebDavHostName())
      hashCode = hashCode * 8191 + webDavHostName.hashCode();
  ...
  @Override
  public int compareTo(WebDAVDataMovement other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWebDavHostName()).compareTo(other.isSetWebDavHostName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWebDavHostName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.webDavHostName, other.webDavHostName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("WebDAVDataMovement(");
    boolean first = true;
    ...
    if (isSetWebDavHostName()) {
      if (!first) sb.append(", ");
      sb.append("webDavHostName:");
      if (this.webDavHostName == null) {
        sb.append("null");
      } else {
        sb.append(this.webDavHostName);
      }
      first = false;
    }
    if (isSetPort()) {
  ...
  private static class WebDAVDataMovementStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public WebDAVDataMovementStandardScheme getScheme() {
      return new WebDAVDataMovementStandardScheme();
    }
  }

  private static class WebDAVDataMovementStandardScheme extends org.apache.thrift.scheme.StandardScheme<WebDAVDataMovement> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WebDAVDataMovement struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // WEB_DAV_HOST_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.webDavHostName = iprot.readString();
              struct.setWebDavHostNameIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WebDAVDataMovement struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.webDavHostName != null) {
        if (struct.isSetWebDavHostName()) {
          oprot.writeFieldBegin(WEB_DAV_HOST_NAME_FIELD_DESC);
          oprot.writeString(struct.webDavHostName);
          oprot.writeFieldEnd();
        }
      }
      if (struct.isSetPort()) {
  ...
  private static class WebDAVDataMovementTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public WebDAVDataMovementTupleScheme getScheme() {
      return new WebDAVDataMovementTupleScheme();
    }
  }

  private static class WebDAVDataMovementTupleScheme extends org.apache.thrift.scheme.TupleScheme<WebDAVDataMovement> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WebDAVDataMovement struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WebDAVDataMovement struct) throws org.apache.thrift.TException {
