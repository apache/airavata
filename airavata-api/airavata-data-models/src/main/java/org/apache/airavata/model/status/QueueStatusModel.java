...
public class QueueStatusModel implements org.apache.thrift.TBase<QueueStatusModel, QueueStatusModel._Fields>, java.io.Serializable, Cloneable, Comparable<QueueStatusModel> {
  ...
  static {
    schemes.put(StandardScheme.class, new QueueStatusModelStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueueStatusModelTupleSchemeFactory());
  }
  ...
  public void unsetQueueUp() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __QUEUEUP_ISSET_ID);
  }
  ...
  public void setQueueUpIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __QUEUEUP_ISSET_ID, value);
  }
  ...
  public void unsetRunningJobs() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __RUNNINGJOBS_ISSET_ID);
  }
  ...
  public void setRunningJobsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __RUNNINGJOBS_ISSET_ID, value);
  }
  ...
  public void unsetQueuedJobs() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __QUEUEDJOBS_ISSET_ID);
  }
  ...
  public void setQueuedJobsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __QUEUEDJOBS_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_queueUp = true;
    list.add(present_queueUp);
    if (present_queueUp)
      list.add(queueUp);

    boolean present_runningJobs = true;
    list.add(present_runningJobs);
    if (present_runningJobs)
      list.add(runningJobs);

    boolean present_queuedJobs = true;
    list.add(present_queuedJobs);
    if (present_queuedJobs)
      list.add(queuedJobs);
  ...
  public int compareTo(QueueStatusModel other) {
    ...
    lastComparison = Boolean.valueOf(isSetQueueUp()).compareTo(other.isSetQueueUp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueueUp()) {
    ...
    lastComparison = Boolean.valueOf(isSetRunningJobs()).compareTo(other.isSetRunningJobs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRunningJobs()) {
    ...
    lastComparison = Boolean.valueOf(isSetQueuedJobs()).compareTo(other.isSetQueuedJobs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueuedJobs()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueueStatusModel(");
    boolean first = true;
  ...
  private static class QueueStatusModelStandardSchemeFactory implements SchemeFactory {
    public QueueStatusModelStandardScheme getScheme() {
      return new QueueStatusModelStandardScheme();
    }
  }

  private static class QueueStatusModelStandardScheme extends StandardScheme<QueueStatusModel> {
  ...
  private static class QueueStatusModelTupleSchemeFactory implements SchemeFactory {
    public QueueStatusModelTupleScheme getScheme() {
      return new QueueStatusModelTupleScheme();
    }
  }

  private static class QueueStatusModelTupleScheme extends TupleScheme<QueueStatusModel> {
