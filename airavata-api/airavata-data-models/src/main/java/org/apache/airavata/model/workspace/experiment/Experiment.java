            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                WorkflowNodeStatus _elem114;
                for (int _i115 = 0; _i115 < _list113.size; ++_i115)
                {
                  _elem114 = new WorkflowNodeStatus();
                  _elem114.read(iprot);
                  struct.stateChangeList.add(_elem114);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                WorkflowNodeDetails _elem117;
                for (int _i118 = 0; _i118 < _list116.size; ++_i118)
                {
                  _elem117 = new WorkflowNodeDetails();
                  _elem117.read(iprot);
                  struct.workflowNodeDetailsList.add(_elem117);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                ErrorDetails _elem120;
                for (int _i121 = 0; _i121 < _list119.size; ++_i121)
                {
                  _elem120 = new ErrorDetails();
                  _elem120.read(iprot);
                  struct.errors.add(_elem120);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(8)) {
        {
          ...
          for (int _i136 = 0; _i136 < _list134.size; ++_i136)
          {
            ...
            struct.emailAddresses.add(_elem135);
          }
        }
        struct.setEmailAddressesIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          org.apache.airavata.model.appcatalog.appinterface.InputDataObjectType _elem138;
          for (int _i139 = 0; _i139 < _list137.size; ++_i139)
          {
            _elem138 = new org.apache.airavata.model.appcatalog.appinterface.InputDataObjectType();
            _elem138.read(iprot);
            struct.experimentInputs.add(_elem138);
          }
        }
        struct.setExperimentInputsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          org.apache.airavata.model.appcatalog.appinterface.OutputDataObjectType _elem141;
          for (int _i142 = 0; _i142 < _list140.size; ++_i142)
          {
            _elem141 = new org.apache.airavata.model.appcatalog.appinterface.OutputDataObjectType();
            _elem141.read(iprot);
            struct.experimentOutputs.add(_elem141);
          }
        }
        struct.setExperimentOutputsIsSet(true);
      }
      ...
      if (incoming.get(14)) {
        {
          ...
          WorkflowNodeStatus _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = new WorkflowNodeStatus();
            _elem144.read(iprot);
            struct.stateChangeList.add(_elem144);
          }
        }
        struct.setStateChangeListIsSet(true);
      }
      if (incoming.get(15)) {
        {
          ...
          WorkflowNodeDetails _elem147;
          for (int _i148 = 0; _i148 < _list146.size; ++_i148)
          {
            _elem147 = new WorkflowNodeDetails();
            _elem147.read(iprot);
            struct.workflowNodeDetailsList.add(_elem147);
          }
        }
        struct.setWorkflowNodeDetailsListIsSet(true);
      }
      if (incoming.get(16)) {
        {
          ...
          ErrorDetails _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = new ErrorDetails();
            _elem150.read(iprot);
            struct.errors.add(_elem150);
          }
        }
        struct.setErrorsIsSet(true);
      }
