            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  JobManagerCommand _key2;
                  String _val3;
                  _key2 = JobManagerCommand.findByValue(iprot.readI32());
                  _val3 = iprot.readString();
                  struct.jobManagerCommands.put(_key2, _val3);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          {
            JobManagerCommand _key8;
            String _val9;
            _key8 = JobManagerCommand.findByValue(iprot.readI32());
            _val9 = iprot.readString();
            struct.jobManagerCommands.put(_key8, _val9);
          }
        }
        struct.setJobManagerCommandsIsSet(true);
      }
