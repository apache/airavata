      ...
      if (incoming.get(10)) {
        {
          ...
          {
            _elem53 = new JobDetails();
            _elem53.read(iprot);
            struct.jobDetailsList.add(_elem53);
          }
        }
        struct.setJobDetailsListIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          DataTransferDetails _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new DataTransferDetails();
            _elem56.read(iprot);
            struct.dataTransferDetailsList.add(_elem56);
          }
        }
        struct.setDataTransferDetailsListIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          ErrorDetails _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = new ErrorDetails();
            _elem59.read(iprot);
            struct.errors.add(_elem59);
          }
        }
        struct.setErrorsIsSet(true);
      }
      ...
      if (incoming.get(14)) {
        {
          ...
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            ...
            struct.emailAddresses.add(_elem62);
          }
        }
        struct.setEmailAddressesIsSet(true);
      }
