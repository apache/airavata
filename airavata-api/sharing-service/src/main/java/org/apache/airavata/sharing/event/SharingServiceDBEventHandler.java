...
public class SharingServiceDBEventHandler implements MessageHandler {
    ...
    private final SharingService sharingRegistryClient;
    ...
    SharingServiceDBEventHandler() throws ApplicationSettingsException, SharingRegistryException {
        ...
        sharingRegistryClient = new SharingService();
    }
            ...
            try {
                switch (dBEventMessageContext
                    ...
                    case USER_PROFILE:
                        ...
                        UserProfile userProfile = UserProfile.parseFrom(dBEventMessageContext
                                .getPublisher()
                                .getPublisherContext()
                                .getEntityDataModel());
                    ...
                    case TENANT:
                        ...
                        Gateway gateway = Gateway.parseFrom(dBEventMessageContext
                                .getPublisher()
                                .getPublisherContext()
                                .getEntityDataModel());
                    ...
                    case PROJECT:
                        ...
                        Project project = Project.parseFrom(dBEventMessageContext
                                .getPublisher()
                                .getPublisherContext()
                                .getEntityDataModel());
