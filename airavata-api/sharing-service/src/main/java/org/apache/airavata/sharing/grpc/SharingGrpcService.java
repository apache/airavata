...
public class SharingGrpcService extends SharingServiceGrpc.SharingServiceImplBase {
    ...
    private static org.apache.airavata.sharing.model.UserEntity toThriftUser(
        ...
        if (!proto.getFirstName().isEmpty()) t.setFirstName(proto.getFirstName());
        if (!proto.getLastName().isEmpty()) t.setLastName(proto.getLastName());
        if (!proto.getEmail().isEmpty()) t.setEmail(proto.getEmail());
        if (!proto.getIcon().isEmpty()) t.setIcon(proto.getIcon().toByteArray());
        if (proto.getCreatedTime() != 0) t.setCreatedTime(proto.getCreatedTime());
        if (proto.getUpdatedTime() != 0) t.setUpdatedTime(proto.getUpdatedTime());
        return t;
    }
    ...
    private static org.apache.airavata.sharing.registry.models.proto.User toProtoUser(
        ...
        if (t.getFirstName() != null) b.setFirstName(t.getFirstName());
        if (t.getLastName() != null) b.setLastName(t.getLastName());
        if (t.getEmail() != null) b.setEmail(t.getEmail());
        if (t.getIcon() != null) b.setIcon(ByteString.copyFrom(t.getIcon()));
        b.setCreatedTime(t.getCreatedTime());
        b.setUpdatedTime(t.getUpdatedTime());
        return b.build();
    }
