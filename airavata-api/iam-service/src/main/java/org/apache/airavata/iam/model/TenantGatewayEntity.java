...
public class TenantGatewayEntity {
    private static final Logger logger = LoggerFactory.getLogger(TenantGatewayEntity.class);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TenantGatewayEntity)) {
            return false;
        }
        TenantGatewayEntity gwy = (TenantGatewayEntity) obj;
