...
import org.apache.airavata.agent.service.AgentConnectionService;
 ...
 * </ul>
 *
 * <p><b>Endpoints:</b> All endpoints are prefixed with {@code /api/v1/agents}:
 * <ul>
 ...
 * via {@link org.apache.airavata.agent.handler.AgentConnectionHandler},
 ...
 * </ul>
 *
 * @see org.apache.airavata.agent.handler.AgentConnectionHandler
 */
@RestController
...
public class AgentController {
    ...
    public AgentController(AgentConnectionService agentConnectionService) {
    ...
    public ResponseEntity<AgentInfoResponse> getAgentInfo(@PathVariable("agentId") String agentId) {
        ...
        return ResponseEntity.accepted().body(agentConnectionService.isAgentUp(agentId));
    }

    @GetMapping("/setup/tunnel/{executionId}")
    public ResponseEntity<AgentTunnelCreateResponse> getTunnelCreateResponse(
            @PathVariable("executionId") String executionId) {
        logger.info("Received tunnel creation response for execution id {}", executionId);
        return ResponseEntity.accepted().body(agentConnectionService.getTunnelCreateResponse(executionId));
    }
    ...
    public ResponseEntity<AgentTunnelAck> runTunnelCreationOnAgent(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.runTunnelOnAgent(tunnelRequest));
    }

    @PostMapping("/terminate/tunnel")
    public ResponseEntity<AgentTunnelAck> runTunnelTerminationOnAgent(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.terminateTunnelOnAgent(terminateRequest));
    }
    ...
    public ResponseEntity<AgentEnvSetupAck> runEnvSetupOnAgent(
        ...
        if (agentConnectionService.isAgentUp(envSetupRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted().body(agentConnectionService.runEnvSetupOnAgent(envSetupRequest));
        } else {
    ...
    public ResponseEntity<AgentEnvSetupResponse> getEnvSetupResponse(@PathVariable("executionId") String executionId) {
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getEnvSetupResponse(executionId));
    }
    ...
    public ResponseEntity<AgentKernelRestartAck> runKernelRestartOnAgent(
        ...
        if (agentConnectionService.isAgentUp(kernelRestartRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted().body(agentConnectionService.runKernelRestartOnAgent(kernelRestartRequest));
        } else {
    ...
    public ResponseEntity<AgentKernelRestartResponse> getKernelRestartResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getKernelRestartResponse(executionId));
    }
    ...
    public ResponseEntity<AgentCommandExecutionAck> runCommandOnAgent(
        ...
        if (agentConnectionService.isAgentUp(commandRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted().body(agentConnectionService.runCommandOnAgent(commandRequest));
        } else {
    ...
    public ResponseEntity<AgentCommandExecutionResponse> getExecutionResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getCommandExecutionResponse(executionId));
    }
    ...
    public ResponseEntity<AgentCommandExecutionAck> runAsyncCommandOnAgent(
        ...
        if (agentConnectionService.isAgentUp(commandRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted().body(agentConnectionService.runAsyncCommandOnAgent(commandRequest));
        } else {
            logger.warn("No agent is available to run on agent {}", commandRequest.getAgentId());
            AgentCommandExecutionAck ack = new AgentCommandExecutionAck();
            ack.setError("Agent not found");
    ...
    public ResponseEntity<AgentAsyncCommandExecutionResponse> getAsyncExecutionResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getAsyncCommandExecutionResponse(executionId));
    }
    ...
    public ResponseEntity<AgentCommandExecutionAck> listAsyncCommandOnAgent(
        ...
        if (agentConnectionService.isAgentUp(commandListRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted()
                    .body(agentConnectionService.runAsyncCommandListOnAgent(commandListRequest));
        } else {
    ...
    public ResponseEntity<AgentAsyncCommandListResponse> getAsyncCommandListResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getAsyncCommandListResponse(executionId));
    }
    ...
    public ResponseEntity<AgentCommandExecutionAck> terminateAsyncCommandOnAgent(
        ...
        if (agentConnectionService
                ...
                .isAgentUp()) {
            return ResponseEntity.accepted()
                    .body(agentConnectionService.runAsyncCommandTerminateOnAgent(commandTerminateRequest));
        } else {
    ...
    public ResponseEntity<AgentAsyncCommandTerminateResponse> getAsyncCommandTerminateResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getAsyncCommandTerminateResponse(executionId));
    }
    ...
    public ResponseEntity<AgentJupyterExecutionAck> runJupyterOnAgent(
        ...
        if (agentConnectionService.isAgentUp(executionRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted().body(agentConnectionService.runJupyterOnAgent(executionRequest));
        } else {
    ...
    public ResponseEntity<AgentJupyterExecutionResponse> getJupyterResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getJupyterExecutionResponse(executionId));
    }
    ...
    public ResponseEntity<AgentPythonExecutionAck> runPythonOnAgent(
        ...
        if (agentConnectionService.isAgentUp(pythonRunRequest.getAgentId()).isAgentUp()) {
            return ResponseEntity.accepted().body(agentConnectionService.runPythonOnAgent(pythonRunRequest));
        } else {
    ...
    public ResponseEntity<AgentPythonExecutionResponse> getPythonResponse(
        ...
        return ResponseEntity.accepted().body(agentConnectionService.getPythonExecutionResponse(executionId));
    }
}
