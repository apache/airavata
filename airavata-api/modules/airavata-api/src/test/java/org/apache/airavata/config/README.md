...
```bash
mvn test -pl modules/airavata-api -Dtest="*ServiceStartup*Test"
```

Run specific test class:
```bash
mvn test -pl modules/airavata-api -Dtest="ServiceStartupCombinationTest"
```
...
Run all tests:
```bash
./scripts/test-service-startup.sh --all
```

Run specific test category:
```bash
./scripts/test-service-startup.sh --combination
./scripts/test-service-startup.sh --dependency
./scripts/test-service-startup.sh --toggle
```

Run specific test class:
```bash
./scripts/test-service-startup.sh ServiceStartupCombinationTest
```
