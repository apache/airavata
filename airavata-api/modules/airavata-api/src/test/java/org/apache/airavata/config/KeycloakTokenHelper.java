...
public class KeycloakTokenHelper {
    ...
    // Gateway realm credentials from realm-default.json and dev.env.defaults for testing.
    // These are the gateway user (NOT the Keycloak master admin which is admin/admin).
    ...
    public static AuthzToken createRealAuthzToken(
            String keycloakUrl, ServerProperties properties, String gatewayId, String username) {
