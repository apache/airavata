...
public class SlurmConnectivityIntegrationTest {
    ...
    void setUp() throws IOException {
        // Get SLURM container - fails the test if container is unavailable
        SlurmConnectionInfo slurm = TestcontainersConfig.getSlurmContainer();
        ...
        throw new RuntimeException(
                "Could not connect to SLURM container after " + maxRetries + " attempts: "
