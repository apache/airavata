...
* under the License.
*/
package org.apache.airavata.research.experiment.exception;

/**
 * Entity-not-found and duplicate-entry exceptions for experiments.
 */
public final class ExperimentExceptions {

    private ExperimentExceptions() {}

    public static class ExperimentNotFoundException extends Exception {
