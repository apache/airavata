...
public interface ResourceService {
    ...
    List<Resource> getResources(String gatewayId);
    ...
    List<ResourceBinding> getBindings(String gatewayId);

    List<ResourceBinding> getBindingsByResource(String resourceId);

    List<ResourceBinding> getBindingsByCredential(String credentialId);
