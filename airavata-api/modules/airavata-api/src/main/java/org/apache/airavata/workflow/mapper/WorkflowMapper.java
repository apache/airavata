...
* under the License.
*/
package org.apache.airavata.workflow.mapper;
...
public interface WorkflowMapper extends EntityMapper<WorkflowEntity, Workflow> {

    WorkflowRun toRunModel(WorkflowRunEntity entity);
}
