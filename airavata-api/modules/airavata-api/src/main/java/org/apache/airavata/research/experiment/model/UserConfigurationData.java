...
/**
 * Domain model: UserConfigurationData
 */
public class UserConfigurationData {
    ...
    private List<ComputationalResourceScheduling> autoScheduledCompResourceSchedulingList;
    ...
    public List<ComputationalResourceScheduling> getAutoScheduledCompResourceSchedulingList() {
        return autoScheduledCompResourceSchedulingList;
    }

    public void setAutoScheduledCompResourceSchedulingList(
            List<ComputationalResourceScheduling> autoScheduledCompResourceSchedulingList) {
    ...
    public String toString() {
        return "UserConfigurationData{" + "airavataAutoSchedule=" + airavataAutoSchedule
