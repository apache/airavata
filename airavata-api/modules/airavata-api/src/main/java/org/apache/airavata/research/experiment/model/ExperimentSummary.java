...
/**
 * Domain model: ExperimentSummary
 */
public class ExperimentSummary {
    ...
    public String toString() {
        return "ExperimentSummary{" + "experimentId=" + experimentId + ", projectId=" + projectId + ", gatewayId="
                + gatewayId + ", createdAt=" + createdAt + ", userName=" + userName + ", name=" + name
