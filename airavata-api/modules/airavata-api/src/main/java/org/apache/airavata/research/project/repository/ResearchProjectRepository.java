...
public interface ResearchProjectRepository extends JpaRepository<ResearchProjectEntity, String> {
    ...
    List<ResearchProjectEntity> findProjectsByRepositoryArtifactAndState(
            RepositoryArtifactEntity repositoryArtifact, ArtifactState state);

    List<ResearchProjectEntity> findAllByOwnerIdAndStateOrderByCreatedAtDesc(String ownerId, ArtifactState state);

    List<ResearchProjectEntity> findProjectsByDatasetArtifactsContainingAndState(
            Set<DatasetArtifactEntity> datasetArtifacts, ArtifactState state);

    Optional<ResearchProjectEntity> findByIdAndState(String id, ArtifactState state);
}
