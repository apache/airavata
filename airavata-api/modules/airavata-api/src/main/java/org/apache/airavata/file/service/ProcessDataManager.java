 ...
 * by the file service to browse and transfer files.
 */
public class ProcessDataManager {
    ...
    public AgentAdapter getAgentAdapter() throws Exception {
        ...
        Map<String, Object> schedule = process.getResourceSchedule();
        if (schedule != null) {
            loginUserName = (String) schedule.get("overrideLoginUserName");
            credentialToken = (String) schedule.get("credentialToken");
        }
        return adapterSupport.fetchSSHAdapter(
