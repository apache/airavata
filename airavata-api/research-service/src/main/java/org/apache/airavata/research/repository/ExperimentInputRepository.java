...
import org.apache.airavata.research.model.ExperimentInputEntity;
import org.apache.airavata.research.model.ExperimentInputPK;
...
public class ExperimentInputRepository
    ...
    protected InputDataObjectType toModel(ExperimentInputEntity entity) {
        return ResearchMapper.INSTANCE.experimentInputToModel(entity);
    }

    @Override
    protected ExperimentInputEntity toEntity(InputDataObjectType model) {
        return ResearchMapper.INSTANCE.experimentInputToEntity(model);
    }
    ...
    protected void saveExperimentInput(List<InputDataObjectType> experimentInputs, String experimentId)
        ...
        for (InputDataObjectType input : experimentInputs) {
            ExperimentInputEntity experimentInputEntity = ResearchMapper.INSTANCE.experimentInputToEntity(input);
    ...
    public List<InputDataObjectType> getExperimentInputs(String experimentId) throws RegistryException {
        ...
        return experimentModel.getExperimentInputsList();
    }
}
