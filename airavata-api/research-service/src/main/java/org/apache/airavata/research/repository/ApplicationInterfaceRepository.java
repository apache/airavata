...
import org.apache.airavata.interfaces.ApplicationInterface;
...
public class ApplicationInterfaceRepository
    ...
    protected ApplicationInterfaceDescription toModel(ApplicationInterfaceEntity entity) {
        return ResearchMapper.INSTANCE.appInterfaceToModel(entity);
    }

    @Override
    protected ApplicationInterfaceEntity toEntity(ApplicationInterfaceDescription model) {
        return ResearchMapper.INSTANCE.appInterfaceToEntity(model);
    }
    ...
    public List<String> getAllApplicationInterfaceIds() throws AppCatalogException {
        ...
        List<ApplicationInterfaceDescription> applicationInterfaceDescriptionList =
                select(QueryConstants.GET_ALL_APPLICATION_INTERFACES, 0);
        ...
        if (applicationInterfaceDescriptionList != null && !applicationInterfaceDescriptionList.isEmpty()) {
            ...
            for (ApplicationInterfaceDescription applicationDeploymentDescription :
                    applicationInterfaceDescriptionList) {
