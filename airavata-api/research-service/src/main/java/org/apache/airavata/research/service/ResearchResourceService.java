...
public class ResearchResourceService {
    ...
    public void transferResourceRequestFields(
        ...
        Set<org.apache.airavata.sharing.model.TagEntity> tagsSet = new HashSet<>();
        for (String tag : tags) {
            org.apache.airavata.sharing.model.TagEntity t = new org.apache.airavata.sharing.model.TagEntity();
            t.setValue(tag);
            tagsSet.add(t);
        }
