...
public class ParserEntity implements Serializable {
    ...
    @Lob
    @Column(name = "INPUT_FILES_JSON")
    @Convert(converter = JsonListConverter.class)
    private List<Map<String, Object>> inputFiles;

    @Lob
    @Column(name = "OUTPUT_FILES_JSON")
    @Convert(converter = JsonListConverter.class)
    ...
    public List<Map<String, Object>> getInputFiles() {
        return inputFiles;
    }

    public void setInputFiles(List<Map<String, Object>> inputFiles) {
