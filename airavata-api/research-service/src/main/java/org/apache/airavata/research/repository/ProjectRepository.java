...
public class ProjectRepository extends AbstractRepository<Project, ProjectEntity, String> {
    ...
    protected Project toModel(ProjectEntity entity) {
        return ResearchMapper.INSTANCE.projectToModel(entity);
    }

    @Override
    protected ProjectEntity toEntity(Project model) {
        return ResearchMapper.INSTANCE.projectToEntity(model);
    }
    ...
    protected ProjectEntity saveProject(Project project, String gatewayId) throws RegistryException {
        ...
        ProjectEntity projectEntity = ResearchMapper.INSTANCE.projectToEntity(project);
    ...
    public List<Project> getProjectList(
        ...
        if (fieldName.equals(Constants.FieldConstants.ProjectConstants.OWNER)) {
            ...
            List<Project> projectList =
                    select(QueryConstants.GET_ALL_PROJECTS_FOR_OWNER, limit, offset, queryParameters);
