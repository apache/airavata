...
public class ExperimentInputRepositoryTest extends TestBase {
    ...
    public void ExperimentInputRepositoryTest() throws RegistryException {
        ...
        InputDataObjectType inputDataObjectTypeExp =
                InputDataObjectType.newBuilder().setName("inputE").build();
        inputDataObjectTypeExp =
                inputDataObjectTypeExp.toBuilder().setType(DataType.STRING).build();

        List<InputDataObjectType> inputDataObjectTypeExpList = new ArrayList<>();
        inputDataObjectTypeExpList.add(inputDataObjectTypeExp);

        assertEquals(
                experimentId, experimentInputRepository.addExperimentInputs(inputDataObjectTypeExpList, experimentId));
        ...
        inputDataObjectTypeExp =
                inputDataObjectTypeExp.toBuilder().setValue("iValueE").build();
